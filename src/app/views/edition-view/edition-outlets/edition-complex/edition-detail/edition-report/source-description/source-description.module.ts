...
import { SourceDescriptionDetailComponent } from './source-description-detail';
...
@NgModule({
    ...
    declarations: [SourceDescriptionComponent, SourceDescriptionDetailComponent, SourceDescriptionCorrectionsComponent],
