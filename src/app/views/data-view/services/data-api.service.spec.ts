...
describe('DataApiService (DONE)', () => {
    ...
    describe('#getSearchData', () => {
        describe('request', () => {
            describe('... should not do anything if', () => {
                ...
                it(
                    '... searchParams.query is undefined',
                    waitForAsync(() => {
                        // Empty string
                ...
                it(
                    '... searchParams.query is empty string',
                    waitForAsync(() => {
                        // Empty string
                        const expectedSearchParams: SearchParams = new SearchParams();
                ...
                describe('... searchParams.query is an ExtendedSearchParams object that has', () => {
                    it(
                        '... `filterByRestype` value of undefined',
                        waitForAsync(() => {
                            // Empty string
                            const expectedSearchParams: SearchParams = new SearchParams();
                    ...
                    it(
                        '... `filterByRestype` value of empty string',
                        waitForAsync(() => {
                            // Empty string
                            const expectedSearchParams: SearchParams = new SearchParams();
                            expectedSearchParams.query = new ExtendedSearchParams();
            ...
            describe('... should perform an HTTP GET request to the API (via ApiService)', () => {
                it(
                    '... for Fulltext search with provided searchString (url includes query)',
                    waitForAsync(() => {
                        const expectedSearchParams: SearchParams = new SearchParams();
                ...
                it(
                    '... for Extended search with provided object (url does not include query)',
                    waitForAsync(() => {
            ...
            describe('... should set default query params for GET request if none is provided', () => {
                it(
                    '... for Fulltext search query (string) => 5',
                    waitForAsync(() => {
                        const expectedSearchParams: SearchParams = new SearchParams();
                        expectedSearchParams.query = 'Test';
                ...
                it(
                    '... for Extended search query (object) without properties => 6',
                    waitForAsync(() => {
                        const expectedRestype = '43'; // Opus
                        const expectedSearchParams: SearchParams = new SearchParams();
                        expectedSearchParams.query = new ExtendedSearchParams();
            ...
            describe('... should apply provided params for GET request', () => {
                it(
                    '... for Fulltext search query (string)',
                    waitForAsync(() => {
                        const expectedSearchParams: SearchParams = new SearchParams();
                        expectedSearchParams.query = 'Test';
                ...
                describe('... for Extended search query (object)', () => {
                    it(
                        '... with one propertyId and compop EXISTS (no searchval) => 8',
                        waitForAsync(() => {
                            const expectedRestype = '43'; // Opus
                    ...
                    it(
                        '... with two propertyIds and compop EXISTS (no searchval) => 8 (+2)',
                        waitForAsync(() => {
                            const expectedRestype = '43'; // Opus
                            const expectedFirstProperty = '389'; // Opus number
                    ...
                    it(
                        '... with one propertyId, compop, and searchval => 9',
                        waitForAsync(() => {
                            const expectedRestype = '43'; // Opus
                            const expectedFirstProperty = '389'; // Opus number
                    ...
                    it(
                        '... with two propertyIds, compops, and searchvals => 9 (+3)',
                        waitForAsync(() => {
                            const expectedRestype = '43'; // Opus
                            const expectedFirstProperty = '389'; // Opus number
                            const expectedSecondProperty = '1'; // Title
            ...
            describe('... should call getApiResponse (via ApiService) ', () => {
                ...
                it(
                    '... with ExtendedSearchParams object',
                    waitForAsync(() => {
                        const expectedRestype = '43'; // Opus
                        const expectedFirstProperty = '389'; // Opus number
                        const expectedSecondProperty = '1'; // Title
        ...
        describe('response', () => {
            describe('success', () => {
                it(
                    '... should return a SearchResponseJson observable (converted)',
                    waitForAsync(() => {
                        const expectedSearchParams: SearchParams = new SearchParams();
                        expectedSearchParams.query = 'Test';
    ...
    describe('#getResourceData', () => {
        describe('request', () => {
            describe('... should not do anything if ', () => {
                it(
                    ...
                    waitForAsync(() => {
                        ...
                        const expectedUrl =
                            apiUrl + expectedRoutes.resources + expectedResourceId + expectedResourceSuffix;
                ...
                it(
                    '... empty resource id string is provided',
                    waitForAsync(() => {
                        // Empty string
            ...
            describe('... should perform HTTP GET requests to the API (via ApiService)', () => {
                ...
                it(
                    '... the first request being a ResourceFullResponse request',
                    waitForAsync(() => {
                        const expectedResourceId = '11398';
                        const expectedUrl =
                            apiUrl + expectedRoutes.resources + expectedResourceId + expectedResourceSuffix;
                ...
                it(
                    '... the second request being a ResourceContextResponse request',
                    waitForAsync(() => {
                        const expectedResourceId = '11398';
                        const expectedUrl =
                            apiUrl + expectedRoutes.resources + expectedResourceId + expectedResourceSuffix;
            ...
            describe('... should call getApiResponse (via ApiService) with resource id', () => {
                ...
                it(
                    '... the first call being a ResourceFullResponse request',
                    waitForAsync(() => {
                        const expectedResourceId = '11398';
                        const expectedQueryPath =
                            expectedRoutes.resources + expectedResourceId + expectedResourceSuffix;
                ...
                it(
                    '... the second call being a ResourceContextResponse request',
                    waitForAsync(() => {
                        const expectedResourceId = '11398';
                        const expectedQueryPath =
                            expectedRoutes.resources + expectedResourceId + expectedResourceSuffix;
        ...
        describe('response', () => {
            describe('success', () => {
                describe('... should return a ResourceData observable', () => {
                    it(
                        '... with resource data when both API responses succeed',
                        waitForAsync(() => {
                            const expectedResourceId = '11398';
                            ...
                            dataApiService
                                ...
                                .subscribe((resourceData: ResourceData) => {
                                    expect(getApiResponseSpy.calls.all().length)
                                        .withContext('should be 2 calls')
                                        .toBe(2);
    ...
    describe('#getResourceTypes', () => {
        describe('request', () => {
            it(
                '... should perform an HTTP GET request to the API (via ApiService)',
                waitForAsync(() => {
            ...
            it(
                '... should set default query params for GET request',
                waitForAsync(() => {
                    const expectedUrl = apiUrl + expectedRoutes.resourcetypes;
            ...
            it(
                '... should call getApiResponse (via ApiService) ',
                waitForAsync(() => {
        ...
        describe('response', () => {
            describe('success', () => {
                it(
                    '... should return a ResourceTypesInVocabularyResponseJson observable',
                    waitForAsync(() => {
                        getApiResponseSpy.and.returnValue(observableOf(expectedResourceTypesInVocabularyResponseJson));

                        dataApiService
                            .getResourceTypes()
                            .subscribe((restypes: ResourceTypesInVocabularyResponseJson) => {
                                expect(restypes).toBeTruthy();
                                expect(restypes)
    ...
    describe('#getPropertyListsByResourceType', () => {
        ...
        describe('response', () => {
            describe('success', () => {
                it(
                    '... should return a PropertyTypesInResourceClassResponseJson observable',
                    waitForAsync(() => {
                        const expectedRestype = '43'; // Opus

                        getApiResponseSpy.and.returnValue(
                            observableOf(expectedPropertyTypesInResourceClassResponseJson)
                        );
    ...
    describe('#_getResourceDataResponseFromApi', () => {
        describe('request', () => {
            describe('... should not do anything if ', () => {
                ...
                it(
                    'response type is not a known switch case',
                    waitForAsync(() => {
                        // Call service function
