      ...
      (function() {
        ...
        !(function(e) {
          ...
          function v(t) {
            0 === P &&
              0 === p.length &&
              (o || (e[l] && (o = e[l].resolve(0))), o ? o[f](d) : e[s](d, 0)),
              t && p.push(t);
          }
          function d() {
            if (!h) {
        ...
        Zone.__load_patch("ZoneAwarePromise", function(e, t, n) {
          ...
          function j(e, r, i) {
            ...
            if (e[d] === b) {
              ...
              if (
                ...
                if (
                  ((e[g] = i),
                  e[y] === y && r === T && ((e[d] = e[m]), (e[g] = e[_])),
                  r === w && i instanceof Error)
                ) {
                  var f =
                    t.currentTask &&
                    t.currentTask.data &&
                    t.currentTask.data[s];
                  f &&
                    o(i, D, {
                      configurable: !0,
                      enumerable: !1,
            ...
            return (
              ...
              (e.prototype.then = function(e, n) {
                var r = new this.constructor(null),
                  o = t.current;
                return (
                  this[d] == b ? this[g].push(o, r, e, n) : z(this, o, r, e, n),
                  r
                );
              }),
              ...
              (e.prototype.finally = function(e) {
                ...
                var r = t.current;
                return (
                  this[d] == b ? this[g].push(r, n, e, e) : z(this, r, n, e, e),
                  n
                );
              }),
              e
          ...
          (I && !I.configurable) ||
            ...
            (I.set = function(t) {
              t === M
                ? (e[R] = t)
                : ((e[c] = t), t.prototype[u] || q(t), n.setNativePromise(t));
            }),
            o(e, "Promise", I)),
            (e.Promise = M);
          var F,
            ...
            s || (s = O[u] = v("ON_PROPERTY" + u)),
              (i.set = function(e) {
                ...
                (t || n !== y || (t = y), t) &&
                  ...
                  c && c.apply(t, m),
                  "function" == typeof e
                    ? ((t[s] = e), t.addEventListener(u, S, !1))
                    : (t[s] = null));
              }),
              (i.get = function() {
                var e = this;
        ...
        function N(e, t, r) {
          ...
          function b(t, r) {
                    ...
                    if (!a || a(t, h, p, arguments)) {
                      ...
                      if (z)
                        for (var m = 0; m < z.length; m++)
                          if (g === z[m]) return t.apply(this, arguments);
                      var k = !1;
                      void 0 === y
                        ? (d = !1)
                        : !0 === y
                      ...
                      if (D) {
                        if (((j = !0), _))
                          for (m = 0; m < D.length; m++) if (Z(D[m], h)) return;
                      } else D = p[b] = [];
            ...
            return (
              ...
              (T[u] = function() {
                for (
                  var t = [], n = W(this || e, arguments[0]), r = 0;
                  r < n.length;
                  r++
                ) {
                  var o = n[r],
                    i = o.originalDelegate ? o.originalDelegate : o.callback;
                  t.push(i);
                }
                return t;
              }),
              (T[p] = function() {
                ...
                if (n) {
                  ...
                  if (r) {
                    ...
                    if (a) {
                      ...
                      for (g = 0; g < f.length; g++) {
                        var h = (v = f[g]).originalDelegate
                          ? v.originalDelegate
                          : v.callback;
                        this[c].call(this, n, h, v.options);
                      }
                    }
                    if (u)
                      for (f = u.slice(), g = 0; g < f.length; g++) {
                        var v;
                        h = (v = f[g]).originalDelegate
                          ? v.originalDelegate
                          : v.callback;
                        this[c].call(this, n, h, v.options);
                      }
                  ...
                  for (var d = Object.keys(t), g = 0; g < d.length; g++) {
                    var y = d[g],
                      _ = A.exec(y),
                      m = _ && _[1];
                    m && "removeListener" !== m && this[p].call(this, m);
                  }
                ...
                "number" == typeof i ? (o = a[i]) : (o = i && i[X]) || (o = i),
                  o && "string" == typeof o.type
                    ? "notScheduled" !== o.state &&
                      ...
                      ("number" == typeof i ? delete a[i] : i && (i[X] = null),
                      o.zone.cancelTask(o))
                    : t.apply(e, r);
              };
            }));
        ...
        var U = (Object[v("defineProperty")] = Object.defineProperty),
          B = (Object[v("getOwnPropertyDescriptor")] =
        ...
        function pe(e, t) {
          !(function(e, t) {
            ...
            n &&
              n.prototype &&
              t.patchMethod(n.prototype, "stopImmediatePropagation", function(
                e
              ) {
                return function(t, n) {
                  (t[H] = !0), e && e.apply(t, n);
            ...
            e[r] && (t[r] = e[r]),
              ...
              (function(e, t) {
                ...
                for (v = 0; v < n.length; v++)
                  for (var _ = a[v], m = (q[_] = {}), k = 0; k < ue.length; k++)
                    m[(d = ue[k])] = _ + ".addEventListener:" + d;
                var b = [];
              ...
              var m = z(t, "open", function() {
                ...
                k = z(t, "send", function() {
                  return function(e, t) {
                    ...
                    return h("XMLHttpRequest.send", y, n, g, _);
                  };
                }),
                b = z(t, "abort", function() {
                  return function(e) {
                    var t = e[n];
    ...
    "4LiD": function(e, t, n) {
      ...
      e.exports = function(e, t, n, d, g, y) {
        ...
        if (
          ...
          (m = d.getConstructor(t, e, g, k)), a(m.prototype, n), (c.NEED = !0);
        return (
          h(m, e),
          (T[e] = m),
          o(o.G + o.W + o.F * (m != _), T),
