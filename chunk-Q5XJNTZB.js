import{B as U,D as l,Fb as A,H as p,Ja as G,La as P,M as c,Na as y,Pb as H,Qb as V,R as F,Rb as L,S as s,Tb as W,U as n,V as g,X as f,a as E,b as R,h as N,i as k,j as i,l as O,n as D,o as T,pb as j,q as B,qc as z,s as q,x as M,y as x,z as $}from"./chunk-RQHFO7XN.js";var Y=`@if (introBlockContent) {
...
`;var X="";var b=class{static{this.propDecorators={editionComplex:[{type:n}],editionLabel:[{type:n}],editionRoute:[{type:n}],seriesRoute:[{type:n}],sectionRoute:[{type:n}],introRoute:[{type:n}]}}};b=i([s({selector:"awg-edition-intro-partial-disclaimer",template:Q,styles:[X]})],b);var tt=`<div class="awg-edition-intro-placeholder">
...
`;var et="";var v=class{static{this.propDecorators={editionComplex:[{type:n}],editionLabel:[{type:n}]}}};v=i([s({selector:"awg-edition-intro-placeholder",template:tt,changeDetection:p.OnPush,styles:[et]})],v);var ot=`<!-- content: intro -->
<div>
    <!-- modal -->
