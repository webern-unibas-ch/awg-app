import{D as b,H as n,M as a,Qb as k,S as l,U as t,V as r,X as u,a as h,b as f,j as o,pb as g,qc as y}from"./chunk-RQHFO7XN.js";var _=`@for (evaluation of evaluations; track $index) {
    <p class="awg-edition-tka-evaluation no-para"><span [compile-html]="evaluation" [compile-html-ref]="ref"></span></p>
}
`;var R="";var s=class{constructor(){this.navigateToReportFragmentRequest=new a,this.openModalRequest=new a,this.selectSvgSheetRequest=new a,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={evaluations:[{type:t}],navigateToReportFragmentRequest:[{type:r}],openModalRequest:[{type:r}],selectSvgSheetRequest:[{type:r}]}}};s=o([l({selector:"awg-edition-tka-evaluations",template:_,changeDetection:n.OnPush,styles:[R]})],s);var S=`@if (labelType === 'evaluation') {
...
`;var T="";var m=class{constructor(e){this.utils=e}static{this.ctorParameters=()=>[{type:g}]}static{this.propDecorators={id:[{type:t}],labelType:[{type:t}]}}};m=o([l({selector:"awg-edition-tka-label",template:S,changeDetection:n.OnPush,styles:[T]})],m);var C=`<table aria-label="Table for text-critical comments" class="table table-hover table-condensed awg-edition-tka-table">
