import{a as G}from"./chunk-QYMCKAPA.js";import"./chunk-3GWTUQ35.js";import{a as $}from"./chunk-GYSG6DRK.js";import{b as M,c as U}from"./chunk-J44SJ7W4.js";import"./chunk-3F66QUQP.js";import{m as D}from"./chunk-SF2RIEEF.js";import{F as q,U as B}from"./chunk-ZRLKKSTB.js";import{b as O,e as N,i as R}from"./chunk-3BZQ7CXH.js";import"./chunk-LV4P6VJV.js";import"./chunk-I22XAGWJ.js";import"./chunk-UJPKQH37.js";import{B as x,Ua as a,W as S,Wa as o,Xa as g,Y as y,Za as w,da as s,ia as L,k as E,ka as c,kb as T,o as i,xa as d}from"./chunk-2UFBJ743.js";var F=`@if (introBlockContent) {
...
`;var v=class{constructor(){this.languageChangeRequest=new c}setLanguage(t){(t===0||t===1)&&this.languageChangeRequest.emit(t)}static{this.propDecorators={introBlockContent:[{type:o}],notesLabel:[{type:o}],currentLanguage:[{type:o}],languageChangeRequest:[{type:g}]}}};v=i([a({selector:"awg-edition-intro-nav",template:H,changeDetection:d.OnPush,standalone:!1,styles:[j]})],v);var A=`<div class="p-3 border rounded-3 text-center awg-edition-intro-partial-disclaimer">
...
`;var V="";var b=class{static{this.propDecorators={editionComplex:[{type:o}],editionLabel:[{type:o}],editionRoute:[{type:o}],seriesRoute:[{type:o}],sectionRoute:[{type:o}],introRoute:[{type:o}]}}};b=i([a({selector:"awg-edition-intro-partial-disclaimer",template:A,standalone:!1,styles:[V]})],b);var W=`<div class="awg-edition-intro-placeholder">
...
`;var z="";var _=class{static{this.propDecorators={editionComplex:[{type:o}],editionLabel:[{type:o}]}}};_=i([a({selector:"awg-edition-intro-placeholder",template:W,changeDetection:d.OnPush,standalone:!1,styles:[z]})],_);var Y=`<!-- content: intro -->
<div>
    <!-- modal -->
    <awg-modal #modal />
...
`;var Z="";var h=class{constructor(){this._editionOutlineService=s(U),this._editionStateService=s(B),this._router=s(N),this._destroyed$=new E,this.UTILS=$,this.currentLanguage=0,this.notesLabels=new Map([[0,"Anmerkungen"],[1,"Notes"]]),this.selectedEditionComplex=this._editionStateService.selectedEditionComplex,this.viewData=s(G).introViewData,this._editionStateService.updateIsIntroView(!0),this._initScrollListener(),s(L).onDestroy(()=>{this._editionStateService.updateIsIntroView(!1)})}get editionRouteConstants(){return q}ngOnInit(){this.listenToRouteChanges()}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}listenToRouteChanges(){this._router.events.pipe(S(this._destroyed$)).subscribe(t=>{if(this._isNavigationEndToIntro(t)){let{seriesId:e,sectionId:n}=this._extractUrlSegments(t.urlAfterRedirects);e&&n?this._updateEditionState(e,n):console.error("Invalid URL segments:",t.urlAfterRedirects)}})}onIntroFragmentNavigate(t){let e={fragment:t?.fragmentId??""};this._router.navigate([],e)}onLanguageSet(t){this.currentLanguage=t}onModalOpen(t){t&&this.modal.open(t)}onReportFragmentNavigate(t){let e=this.editionRouteConstants.EDITION_REPORT.route,n={fragment:t?.fragmentId??""};this._navigateWithComplexId(t?.complexId,e,n)}onSvgSheetSelect(t){let e=this.editionRouteConstants.EDITION_SHEETS.route,n={queryParams:{id:t?.sheetId??""}};this._navigateWithComplexId(t?.complexId,e,n)}_extractUrlSegments(t){if(!t)return{seriesId:void 0,sectionId:void 0};let e=t.split("/"),n=e.indexOf("series")+1,l=e.indexOf("section")+1,m=e[n],r=e[l],C=u=>u!==void 0&&/^[1-3]$/.test(u),k=u=>u!==void 0&&/^[1-5]+[ab]?$/.test(u);return{seriesId:C(m)?m:void 0,sectionId:k(r)?r:void 0}}_initScrollListener(){x(globalThis,"scroll").pipe(y(200),S(this._destroyed$)).subscribe({next:t=>this._onIntroScroll(t)})}_isNavigationEndToIntro(t){return t instanceof O&&t.urlAfterRedirects?.includes("intro")}_navigateWithComplexId(t,e,n){let l=t?`/edition/complex/${t}`:this.selectedEditionComplex()?.baseRoute??"/edition/series";this._router.navigate([l,e],n)}_onIntroScroll(t){if(t?.type==="scroll"){let e=globalThis.scrollY||document.documentElement.scrollTop,n=document.querySelectorAll(".awg-edition-intro-section"),l=document.querySelectorAll("a.awg-edition-intro-nav-link"),m=null;n.forEach(r=>{let C=r.offsetTop-10,k=r.offsetTop+r.offsetHeight;C<=e&&k>e&&(m=r.id)}),l.forEach(r=>{r.classList.toggle("active",r.hash.includes(m))})}}_updateEditionState(t,e){let n=this._editionOutlineService.getEditionSeriesById(t)??null,l=this._editionOutlineService.getEditionSectionById(t,e)??null;this._editionStateService.updateSelectedEditionSeries(n),this._editionStateService.updateSelectedEditionSection(l)}static{this.ctorParameters=()=>[]}static{this.propDecorators={modal:[{type:T,args:["modal",{static:!0}]}]}}};h=i([a({selector:"awg-edition-intro",template:Y,changeDetection:d.OnPush,standalone:!1,styles:[Z]})],h);var dt=[{path:"",component:h,data:{title:"AWG Online Edition \u2013 Intro"}}],J=[h],I=class{};I=i([w({imports:[R.forChild(dt)],exports:[R]})],I);var K=class{};K=i([w({imports:[D,I],declarations:[f,v,b,_,J]})],K);export{K as EditionIntroModule};
