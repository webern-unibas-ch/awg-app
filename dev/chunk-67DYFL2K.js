import{j as s,l as f,o as m}from"./chunk-Q5BBFFUU.js";import{Da as e,F as n,Sa as p,U as g,_ as r,ub as d}from"./chunk-OIF6Z6X7.js";var l=`@if (prefaceData$ | async; as prefaceData) {
...
`;var t,a=(t=class{constructor(){this.currentLanguage=0,this.GLYPHS=s,this._editionDataService=n(f),this._editionStateService=n(m),this.ref=this}ngOnInit(){this._editionStateService.updateIsPrefaceView(!0),this.prefaceData$=this._editionDataService.getEditionPrefaceData()}getGlyph(o){let c=Object.values(this.GLYPHS).find(w=>w.alt===o);return c?c.hex:""}setLanguage(o){this.currentLanguage=o}ngOnDestroy(){this._editionStateService.clearIsPrefaceView()}},t.ctorParameters=()=>[],t);a=e([g({selector:"awg-edition-preface",template:l,styles:[u]})],a);var x=[{path:"",component:a,data:{title:"AWG Online Edition \u2013 Preface"}}],h=[a],i=class{};i=e([r({imports:[p.forChild(x)],exports:[p]})],i);var _=class{};_=e([r({imports:[d,i],declarations:[h]})],_);export{_ as EditionPrefaceModule};
