import{a as x}from"./chunk-PP6HJ337.js";import{f as D}from"./chunk-5Y5LCJPN.js";import"./chunk-QEXK52VH.js";import{b as r,i as B,n as c,z as n}from"./chunk-A5YYGDDF.js";import{A as N,G as L,La as a,Ma as P,Oa as j,R as i,T as g,X as M,h as y,k as U,l as e,ob as A,s as G,x as l}from"./chunk-XQNG4NDI.js";var F=`<!--
...
`;var se="";var _,$=(_=class{},_.propDecorators={complexes:[{type:g}]},_);$=e([i({selector:"awg-edition-complex-card",template:ne,changeDetection:L.OnPush,styles:[se]})],$);var re=`<div class="p-3 pt-4 text-center shadow border rounded-3 awg-jumbotron">
    <h1 id="{{ jumbotronId }}" class="mb-4">{{ jumbotronTitle }}</h1>
</div>
`;var de="";var C,V=(C=class{},C.propDecorators={jumbotronId:[{type:g}],jumbotronTitle:[{type:g}]},C);V=e([i({selector:"awg-edition-jumbotron",template:re,changeDetection:L.OnPush,styles:[de]})],V);var le=class{};le=e([M({imports:[A,k],declarations:[oe,$,V]})],le);export{le as EditionViewModule};
