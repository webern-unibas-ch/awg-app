import{g as L}from"./chunk-E4CMDWDU.js";import"./chunk-HYWY6BIK.js";import{b as I,g as w}from"./chunk-JKZCJZJO.js";import{g as k}from"./chunk-4EYQLOKG.js";import{c as n,h as D,m as d,p as s}from"./chunk-WJ465VCC.js";import"./chunk-FZO45QEG.js";import"./chunk-YTY75QFF.js";import{Aa as C,N as l,W as N,ea as i,k as T,n as O,o as t,pb as o,rb as x,vb as _}from"./chunk-RZA3R7JI.js";var y=`<!-- sideinfo: edition -->
<div class="card">
...
`;var M="";var p=class{constructor(){this.editionInfoHeader="Edition",this.DISPLAYED_SECTIONS=[d.getEditionSectionById("1","5"),d.getEditionSectionById("2","2a")],this._editionStateService=i(s)}get editionRouteConstants(){return n}ngOnInit(){this.setupEditionView()}setupEditionView(){this._editionStateService.getSelectedEditionSection().subscribe(r=>{this.selectedEditionSection=r})}combineComplexes(r){let c=r?.content?.complexTypes?.opus||[],a=r?.content?.complexTypes?.mnr||[];return[...c,...a]}};p=t([o({selector:"awg-edition-info",template:y,standalone:!1,styles:[M]})],p);var V=`<!--
...
`;var F="";var f=class{constructor(){this.editionViewTitle="Editions\xFCbersicht",this.editionViewId="awg-edition-view",this._editionStateService=i(s)}get editionRouteConstants(){return n}ngOnInit(){this.setupEditionView()}setupEditionView(){this.selectedEditionSeries$=this._editionStateService.getSelectedEditionSeries().pipe(l(0)),this.selectedEditionSection$=this._editionStateService.getSelectedEditionSection().pipe(l(0)),this.selectedEditionComplex$=this._editionStateService.getSelectedEditionComplex().pipe(l(0)),this.isIntroView$=this._editionStateService.getIsIntroView().pipe(l(0)),this.isPrefaceView$=this._editionStateService.getIsPrefaceView().pipe(l(0)),this.isRowTableView$=this._editionStateService.getIsRowTableView().pipe(l(0))}};f=t([o({selector:"awg-edition-view",template:W,changeDetection:C.Eager,standalone:!1,styles:[F]})],f);var pe=[{path:"",outlet:"side",component:p},{path:"",component:f,children:[{path:"preface",loadChildren:()=>import("./chunk-RROQ3NKO.js").then(e=>e.EditionPrefaceModule)},{path:"row-tables",loadChildren:()=>import("./chunk-3ZGIOFJB.js").then(e=>e.EditionRowTablesModule)},{path:"series",component:E},{path:"series/:id",component:h,children:[{path:"sections",component:g},{path:"section/:id",loadChildren:()=>import("./chunk-URBLMTVW.js").then(e=>e.EditionSectionDetailModule)},{path:"sections/:id",redirectTo:"section/:id",pathMatch:"full"},{path:"",redirectTo:"sections",pathMatch:"full"}]},{path:"composition",redirectTo:"complex",pathMatch:"prefix"},{path:"complex/:complexId",component:u,children:[{path:"",component:S,children:[{path:"intro",loadChildren:()=>import("./chunk-EPM6QE55.js").then(e=>e.EditionIntroModule)},{path:"sheets",loadChildren:()=>import("./chunk-QLJEROBK.js").then(e=>e.EditionSheetsModule)},{path:"report",loadChildren:()=>import("./chunk-QQRHA4JO.js").then(e=>e.EditionReportModule)},{path:"graph",loadChildren:()=>import("./chunk-MISRZ2FB.js").then(e=>e.EditionGraphModule)},{path:"",redirectTo:"sheets",pathMatch:"full"}]}]}]}],J=[f,u,S,p,g,E,h],b=class{};b=t([_({imports:[w.forChild(pe)],exports:[w]})],b);var K=`<div class="p-3 pt-4 text-center shadow border rounded-3 awg-jumbotron">
    <h3 id="{{ jumbotronId }}" [innerHTML]="jumbotronTitle"></h3>
</div>
`;var Q="";var R=class{static{this.propDecorators={jumbotronId:[{type:x}],jumbotronTitle:[{type:x}]}}};R=t([o({selector:"awg-edition-jumbotron",template:K,changeDetection:C.OnPush,standalone:!1,styles:[Q]})],R);var Y=class{};Y=t([_({imports:[L,b],declarations:[J,R]})],Y);export{Y as EditionViewModule};
