import{a as v}from"./chunk-GYSG6DRK.js";import{c as C}from"./chunk-57ATL23E.js";import{f as k,n as y}from"./chunk-6347MYB4.js";import{J as u}from"./chunk-7T2EW5XL.js";import{Ua as m,Wa as o,Xa as r,Za as T,a as b,b as S,da as l,ka as a,kb as _,o as i,xa as s}from"./chunk-CE57Q5C6.js";var I=`@for (evaluation of evaluations; track $index) {
    <p class="awg-edition-tka-evaluation no-para-margin">
        <span [compile-html]="evaluation" [compile-html-ref]="ref"></span>
    </p>
}
`;var R="";var p=class{constructor(){this._editionGlyphService=l(u),this.navigateToReportFragmentRequest=new a,this.openModalRequest=new a,this.selectSvgSheetRequest=new a,this.ref=this}getGlyph(e){return this._editionGlyphService.getGlyph(e)}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={evaluations:[{type:o}],navigateToReportFragmentRequest:[{type:r}],openModalRequest:[{type:r}],selectSvgSheetRequest:[{type:r}]}}};p=i([m({selector:"awg-edition-tka-evaluations",template:I,changeDetection:s.OnPush,standalone:!1,styles:[R]})],p);var E=`@if (labelType === 'evaluation') {
