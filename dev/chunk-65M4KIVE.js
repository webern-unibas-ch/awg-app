import{a as q}from"./chunk-BFCQAWTL.js";import{a as ye,e as we}from"./chunk-5B2QMMKW.js";import{A,Ab as he,Bb as y,Cb as ce,D as v,Db as ge,Ea as ie,Eb as pe,Fa as oe,Fb as ve,G as r,Ha as W,J as ee,Jb as Se,K as p,Mb as me,Nb as ue,O as h,Pa as ne,Q as l,R as a,S as te,T as S,Ub as H,Wa as re,Xb as fe,Ya as ae,Z as u,a as j,aa as se,ab as le,b as Z,cc as _e,f as Y,h as w,i as Q,j as n,jb as _,kc as m,o as X,s as K,t as J,y as z,z as D,zb as de}from"./chunk-L5DKO235.js";var Ce=`<div class="awg-edition-svg-sheet-footer mt-4">
...
`;var b=class{constructor(){this.selectSvgSheetRequest=new r,this.UTILS=v(_)}isSelectedSvgSheet(e,t){let s=e,i=this.selectedSvgSheet?.id;return t&&this.selectedSvgSheet?.content?.[0]?.partial&&(s+=t,i+=this.selectedSvgSheet.content[0].partial),s===i}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={navItemLabel:[{type:l}],svgSheets:[{type:l}],selectedSvgSheet:[{type:l}],selectSvgSheetRequest:[{type:a}]}}};b=n([h({selector:"awg-edition-svg-sheet-nav-item",template:ke,changeDetection:p.OnPush,standalone:!1,styles:[xe]})],b);var Re=`@if (svgSheetsData) {
