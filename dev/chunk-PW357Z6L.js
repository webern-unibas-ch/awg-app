import{a as W}from"./chunk-WYM5L6IN.js";import{a as Oe,e as Ie}from"./chunk-R44FWSZM.js";import{A as V,Ab as ye,Bb as b,Cb as we,D as g,Db as Ce,Ea as ve,Eb as be,Fa as pe,Fb as ke,H as he,Ha as ee,I as v,Jb as xe,M as n,Mb as Re,Na as Se,Nb as Ee,O as h,Pa as ue,Q as l,R as a,S as ce,T as p,Ub as te,Xb as Te,Ya as me,Z as m,a as ie,aa as ge,b as oe,cb as fe,cc as Le,f as re,h as I,i as ne,j as r,jb as C,kc as S,o as ae,s as le,t as de,y as J,z,zb as _e}from"./chunk-QEZO3ZLG.js";var De=`<div class="awg-edition-svg-sheet-footer mt-4">
...
`;var je="";var L,$=(L=class{constructor(){this.openModalRequest=new n,this.selectSvgSheetRequest=new n,this.faSquare=ue,this.folioLegends=[{color:"olivedrab",label:"aktuell ausgew\xE4hlt"},{color:"orange",label:"ausw\xE4hlbar"},{color:"grey",label:"(momentan noch) nicht ausw\xE4hlbar"}]}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},L.propDecorators={selectedConvolute:[{type:l}],selectedSvgSheet:[{type:l}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]},L);$=r([h({selector:"awg-edition-convolute",template:Ue,changeDetection:v.OnPush,standalone:!1,styles:[je]})],$);var Ze=`<!-- embedded svg: Edition Folio Viewer -->
