import{a as P}from"./chunk-2M5RQSAZ.js";import{a as Te,e as Oe}from"./chunk-RJOC2JUP.js";import{f as C}from"./chunk-ARBM3YIJ.js";import"./chunk-QI7ZJAEQ.js";import{a as fe,b as we,c as b,d as ye,e as _e,f as Ce,g as be,l as ke,n as xe,o as Re,v as ee,y as Ee}from"./chunk-DOOWV3P7.js";import{A as K,B as V,C as z,Ca as r,I as h,L as le,N as a,Oa as he,Pa as ge,Ra as J,S as m,T as c,V as d,W as l,Y as de,Ya as pe,Z as g,_a as ve,a as te,b as ie,bb as Se,ea as ce,f as se,h as D,ib as me,k as oe,ob as ue,p as re,t as ne,tb as p,u as ae}from"./chunk-XXWOVZJP.js";var De=`<div class="awg-edition-svg-sheet-footer mt-4">
...
`;var Ie="";var u,I=(u=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new a,this.openModalRequest=new a,this.selectSvgSheetRequest=new a,this.faChevronRight=ue,this.faChevronDown=me,this.showTextcritics=!1,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleTextcritics(){this.showTextcritics=!this.showTextcritics}},u.ctorParameters=()=>[{type:C}],u.propDecorators={selectedTextcriticalCommentBlocks:[{type:d}],selectedTextcritics:[{type:d}],showTkA:[{type:d}],navigateToReportFragmentRequest:[{type:l}],openModalRequest:[{type:l}],selectSvgSheetRequest:[{type:l}]},u);I=r([c({selector:"awg-edition-svg-sheet-footer",template:De,changeDetection:h.OnPush,styles:[Ie]})],I);var W=class{};W=r([g({imports:[p,P],declarations:[I],exports:[I]})],W);var Ae=`<h6 class="card-title">
    {{ navItemLabel }}:
...
`;var Le=`a#dropDownSheetNav.btn{border:none!important}a#dropDownSheetNav.active,a#dropDownSheetNav:active{color:#149b9e!important}a#dropDownSheetNav:hover{color:#333!important}a#dropDownSheetNav>span{display:inline-block;white-space:break-spaces;text-align:start}
`;var f,A=(f=class{constructor(e){this.utils=e,this.selectSvgSheetRequest=new a,this.disclaimerWorkEditions="Werkeditionen sind aus rechtlichen Gr\xFCnden fr\xFChestens ab 2049 online verf\xFCgbar. Bis dahin konsultieren Sie bitte die entsprechende Printausgabe.",this.faCalendarXmark=Se}isSelectedSvgSheet(e,t){let i=e,s=this.selectedSvgSheet?.id;return t&&this.selectedSvgSheet?.content?.[0]?.partial&&(i+=t,s+=this.selectedSvgSheet.content[0].partial),i===s}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},f.ctorParameters=()=>[{type:C}],f.propDecorators={navItemLabel:[{type:d}],svgSheets:[{type:d}],selectedSvgSheet:[{type:d}],selectSvgSheetRequest:[{type:l}]},f);A=r([c({selector:"awg-edition-svg-sheet-nav-item",template:Ae,changeDetection:h.OnPush,styles:[Le]})],A);var qe=`@if (svgSheetsData) {
...
`;var Me="";var k,L=(k=class{constructor(){this.selectSvgSheetRequest=new a}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},k.propDecorators={svgSheetsData:[{type:d}],selectedSvgSheet:[{type:d}],selectSvgSheetRequest:[{type:l}]},k);L=r([c({selector:"awg-edition-svg-sheet-nav",template:qe,changeDetection:h.OnPush,styles:[Me]})],L);var H=class{};H=r([g({imports:[p],declarations:[L,A],exports:[L,A]})],H);var Ge=`<div class="awg-edition-svg-sheet-viewer-nav">
...
`;var x,q=(x=class{constructor(){this.browseSvgSheetRequest=new a}browseSvgSheet(e){e&&this.browseSvgSheetRequest.emit(e)}},x.propDecorators={browseSvgSheetRequest:[{type:l}]},x);q=r([c({selector:"awg-edition-svg-sheet-viewer-nav",template:Ge,changeDetection:h.OnPush,styles:[Ne]})],q);var Fe=`<div class="card awg-edition-svg-sheet-viewer-settings float-none my-2">
...
`;var He="";var T,F=(T=class{constructor(){this.openModalRequest=new a,this.selectSvgSheetRequest=new a,this.faSquare=ve,this.folioLegends=[{color:"olivedrab",label:"aktuell ausgew\xE4hlt"},{color:"orange",label:"ausw\xE4hlbar"},{color:"grey",label:"(momentan noch) nicht ausw\xE4hlbar"}]}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},T.propDecorators={selectedConvolute:[{type:d}],selectedSvgSheet:[{type:d}],openModalRequest:[{type:l}],selectSvgSheetRequest:[{type:l}]},T);F=r([c({selector:"awg-edition-convolute",template:We,changeDetection:h.OnPush,styles:[He]})],F);var Ue=`<!-- embedded svg: Edition Folio Viewer -->
...
`;var Xe="";var _,$=(_=class{constructor(e,t,i,s,o,n){this.editionDataService=e,this.editionSheetsService=t,this.editionStateService=i,this.utils=s,this.route=o,this.router=n,this.errorObject=null,this.isLoading=!0,this.showTkA=!1,this._destroyed$=new D,this._isFirstPageLoad=!0}get editionRouteConstants(){return fe}ngOnInit(){this.getEditionSheetsData()}getEditionSheetsData(){this.errorObject=null,this.snapshotQueryParamsId=this.route.snapshot.queryParamMap.get("id"),re([this.route.paramMap,this.route.queryParamMap]).pipe(K(([e,t])=>this._fetchEditionComplexData(t)),ne(e=>(this.errorObject=e,this.isLoading=!1,oe)),V(this._destroyed$)).subscribe({next:()=>{this.isLoading=!1},error:e=>{this.errorObject=e,this.isLoading=!1}})}onLinkBoxSelect(e){if(!this.selectedSvgSheet||!this.selectedTextcritics?.linkBoxes)return;let t=this.selectedTextcritics.linkBoxes.find(i=>i.svgGroupId===e);if(t){let i=t.linkTo;this.onSvgSheetSelect(i)}}onReportFragmentNavigate(e){let t=this.editionRouteConstants.EDITION_REPORT.route,i={fragment:e?.fragmentId??""};this._navigateWithComplexId(e?.complexId,t,i)}onOverlaySelect(e){this.selectedTextcriticalCommentBlocks=this.editionSheetsService.getTextcriticalCommentsForOverlays(this.selectedTextcritics.comments,e),this.showTkA=this.utils.isNotEmptyArray(this.selectedTextcriticalCommentBlocks)}onBrowseSvgSheet(e){let t=this.editionSheetsService.getCurrentEditionType(this.selectedSvgSheet,this.svgSheetsData.sheets);if(!t)return;let i=this.svgSheetsData.sheets[t],s=this.editionSheetsService.getNextSheetId(e,this.selectedSvgSheet,i);this.onSvgSheetSelect({complexId:"",sheetId:s})}onSvgSheetSelect(e){let t=this.editionRouteConstants.EDITION_SHEETS.route,i={queryParams:{id:e?.sheetId??""},queryParamsHandling:"merge"};this._navigateWithComplexId(e?.complexId,t,i)}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}_assignData(e){this.folioConvoluteData=e[0],this.svgSheetsData=e[1],this.textcriticsData=e[2]}_fetchEditionComplexData(e){return this.isLoading=!0,this.editionStateService.getSelectedEditionComplex().pipe(z(t=>this.editionComplex=t),K(t=>this.editionDataService.getEditionSheetsData(t)),z(t=>this._assignData(t)),z(()=>this._handleQueryParams(e)))}_getDefaultSheetId(){let e=this.svgSheetsData?.sheets?.sketchEditions?.[0],t=e?.content?.length>1?e.content[0]?.partial:"";return(e?.id||"")+t}_handleQueryParams(e){let t=e?.get("id");t&&this.svgSheetsData?this._selectSvgSheet(t):(t=this._isFirstPageLoad&&this.snapshotQueryParamsId?this.snapshotQueryParamsId:this._getDefaultSheetId(),t===""&&(this.selectedSvgSheet=void 0),this.onSvgSheetSelect({complexId:"",sheetId:t})),this._isFirstPageLoad=!1,this.isLoading=!1}_navigateWithComplexId(e,t,i){let s=e?`/edition/complex/${e}/`:this.editionComplex.baseRoute;this.router.navigate([s,t],i)}_selectSvgSheet(e){e&&(this.selectedSvgSheet=this.editionSheetsService.selectSvgSheetById(this.svgSheetsData.sheets,e),this.selectedConvolute=this.editionSheetsService.selectConvolute(this.folioConvoluteData.convolutes,this.svgSheetsData.sheets,this.selectedSvgSheet),this.selectedTextcritics=this.editionSheetsService.findTextcritics(this.textcriticsData.textcritics,this.selectedSvgSheet),this.onOverlaySelect([]),this.utils.isNotEmptyObject(this.selectedTextcritics)&&this.utils.isNotEmptyArray(this.selectedTextcritics.comments)&&(this.selectedTextcriticalCommentBlocks=this.selectedTextcritics.comments))}},_.ctorParameters=()=>[{type:ke},{type:xe},{type:Re},{type:C},{type:he},{type:ge}],_.propDecorators={modal:[{type:m,args:["modal",{static:!0}]}]},_);$=r([c({selector:"awg-edition-sheets",template:Ze,styles:[Xe]})],$);var ft=[{path:"",component:$,data:{title:"AWG Online Edition \u2013 Sheets"}}],Ye=[$],Q=class{};Q=r([g({imports:[J.forChild(ft)],exports:[J]})],Q);var Qe=class{};Qe=r([g({imports:[p,j,Y,Q],declarations:[Ye]})],Qe);export{Qe as EditionSheetsModule};
