import{a as Ce,e as be}from"./chunk-OMLZ5DOG.js";import{a as A}from"./chunk-RDF3GNN6.js";import{A as v,Aa as ae,C as r,Ca as le,Ea as de,F as ee,Fa as ce,G as p,J as c,L as l,La as he,M as a,Ma as ge,N as te,Na as _,O as S,Oa as pe,Pa as ve,Qa as Se,R as u,Ra as me,T as ie,Va as ue,Ya as fe,Za as _e,a as j,b as Z,eb as U,f as Y,h as w,hb as ye,i as Q,j as n,ka as se,la as oe,lb as we,mb as y,na as W,o as X,qb as m,r as K,s as J,ta as ne,v as P,w as F,x as D,za as re}from"./chunk-U6KVMW3K.js";var ke=`<h6 class="card-title">
    {{ facetItemLabel }}:
...
`;var C=class{constructor(){this.selectSvgSheetRequest=new r,this.UTILS=v(y)}isSelectedSvgSheet(e,t){let i=e,s=this.selectedSvgSheet?.id;return t&&this.selectedSvgSheet?.content?.[0]?.partial&&(i+=t,s+=this.selectedSvgSheet.content[0].partial),i===s}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={facetItemLabel:[{type:l}],svgSheets:[{type:l}],selectedSvgSheet:[{type:l}],selectSvgSheetRequest:[{type:a}]}}};C=n([c({selector:"awg-edition-svg-sheet-facet-item",template:ke,changeDetection:p.OnPush,standalone:!1,styles:[xe]})],C);var Re=`@if (svgSheetsData) {
