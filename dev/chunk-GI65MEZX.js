import{a as C}from"./chunk-PP6HJ337.js";import{f as L}from"./chunk-GCS6MI6S.js";import{m as s}from"./chunk-23OVM6MO.js";import{c as r,v as P}from"./chunk-KBLFZMJW.js";import"./chunk-JNHLCCVT.js";import{A as y,G as N,La as l,Ma as V,Oa as $,R as i,T as g,X as D,h as T,l as e,ob as G,s as U,x as d}from"./chunk-KHOU7TSZ.js";var A=`<!--
...
<!-- edition routes -->
<router-outlet />
`;var B="";var c,x=(c=class{constructor(t,o,a){this.route=t,this.editionService=o,this.utils=a}get editionRouteConstants(){return r}ngOnInit(){this.getEditionComplexFromRoute()}getEditionComplexFromRoute(){this.route.paramMap.subscribe(t=>{let o=t.get("complexId")||"";this.editionService.updateEditionComplex(P[o.toUpperCase()]),this.selectedEditionComplex$=this.editionService.getEditionComplex().pipe(d(0))})}ngOnDestroy(){this.editionService.clearEditionComplex()}},c.ctorParameters=()=>[{type:l},{type:s},{type:L}],c);x=e([i({selector:"awg-edition-complex",template:A,styles:[B]})],x);var F=`@if (editionRouterLinkButtons) {
    <awg-router-link-button-group [routerLinkButtons]="editionRouterLinkButtons" [queryParamsHandling]="''">
    </awg-router-link-button-group>
}

<router-outlet />
`;var H="";var p,v=(p=class{constructor(t){this.editionService=t,this._destroyed$=new T}ngOnInit(){this.getEditionComplex()}getEditionComplex(){this.editionService.getEditionComplex().pipe(y(this._destroyed$)).subscribe({next:t=>{this.editionComplex=t,this.setButtons()}})}setButtons(){this.editionRouterLinkButtons=[new C(this.editionComplex.baseRoute,r.EDITION_INTRO.route,r.EDITION_INTRO.short,!1),new C(this.editionComplex.baseRoute,r.EDITION_SHEETS.route,r.EDITION_SHEETS.short,!1),new C(this.editionComplex.baseRoute,r.EDITION_REPORT.route,r.EDITION_REPORT.short,!1),new C(this.editionComplex.baseRoute,r.EDITION_GRAPH.route,r.EDITION_GRAPH.short,!1)]}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}},p.ctorParameters=()=>[{type:s}],p);v=e([i({selector:"awg-edition-detail-nav",template:F,styles:[H]})],v);var J=`@if (editionOutline) {
...
`;var q="";var u,I=(u=class{constructor(t,o){this.route=t,this.editionService=o}ngOnInit(){this.getSeries()}getSeries(){let t=this.route.snapshot.paramMap.get("id");this.selectedSeries=this.editionService.getEditionSeriesById(t),this.editionService.updateSelectedEditionSeries(this.selectedSeries)}},u.ctorParameters=()=>[{type:l},{type:s}],u);I=e([i({selector:"awg-edition-series-detail",template:W,styles:[q]})],I);var X=`@if (
    selectedSection &&
...
`;var Z="";var h,b=(h=class{constructor(t,o,a){this.route=t,this.editionService=o,this.utils=a,this._destroyed$=new T}ngOnInit(){this.getSection()}getSection(){let t=this.route.snapshot.paramMap.get("id");this.editionService.getSelectedEditionSeries().pipe(y(this._destroyed$),U(o=>!!o)).subscribe(o=>{this.selectedSeries=o;let a=o.series.route;this.selectedSection=this.editionService.getEditionSectionById(a,t),this.editionService.updateSelectedEditionSection(this.selectedSection)})}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}},h.ctorParameters=()=>[{type:l},{type:s},{type:L}],h);b=e([i({selector:"awg-edition-section-detail",template:X,styles:[Z]})],b);var K=`@if (selectedSeries$ | async; as selectedSeries) {
...
`;var ee="";var S,O=(S=class{constructor(t,o,a){this.editionService=t,this.route=o,this.router=a,this.editionViewTitle="Inhalt",this.editionViewId="awg-edition-view"}get editionRouteConstants(){return r}ngOnInit(){this.getSelectionsFromRoute(),this.routeToSidenav()}getSelectionsFromRoute(){this.selectedEditionSeries$=this.editionService.getSelectedEditionSeries().pipe(d(0)),this.selectedEditionSection$=this.editionService.getSelectedEditionSection().pipe(d(0)),this.selectedEditionComplex$=this.editionService.getEditionComplex().pipe(d(0)),this.isPrefaceView$=this.editionService.getIsPrefaceView().pipe(d(0)),this.isRowTableView$=this.editionService.getIsRowTableView().pipe(d(0))}routeToSidenav(){this.router.navigate([{outlets:{side:"editionInfo"}}],{preserveFragment:!0})}},S.ctorParameters=()=>[{type:s},{type:l},{type:V}],S);O=e([i({selector:"awg-edition-view",template:Y,styles:[ee]})],O);var xe=[{path:"",component:O,children:[{path:"series",component:R},{path:"series/:id",component:I,children:[{path:"sections",component:w},{path:"section/:id",component:b},{path:"sections/:id",redirectTo:"section/:id",pathMatch:"full"},{path:"",redirectTo:"sections",pathMatch:"full"}]},{path:"composition",redirectTo:"complex",pathMatch:"prefix"},{path:"complex/:complexId",component:x,children:[{path:"",component:v,children:[{path:"intro",loadChildren:()=>import("./chunk-RVK3GZOJ.js").then(n=>n.EditionIntroModule)},{path:"sheets",loadChildren:()=>import("./chunk-UF5IEBY6.js").then(n=>n.EditionSheetsModule)},{path:"report",loadChildren:()=>import("./chunk-P7VIG7Z3.js").then(n=>n.EditionReportModule)},{path:"graph",loadChildren:()=>import("./chunk-YQJ5BKXS.js").then(n=>n.EditionGraphModule)},{path:"",redirectTo:"sheets",pathMatch:"full"}]}]},{path:"preface",loadChildren:()=>import("./chunk-W7UY2RPU.js").then(n=>n.EditionPrefaceModule)},{path:"row-tables",loadChildren:()=>import("./chunk-ZPNPX4ED.js").then(n=>n.EditionRowTablesModule)}]}],te=[O,x,v,w,b,R,I],M=class{};M=e([D({imports:[$.forChild(xe)],exports:[$]})],M);var ie=`<div class="row row-cols-1 row-cols-md-3 row-cols-xl-5 g-4">
...
`;var oe="";var f,k=(f=class{},f.propDecorators={complexes:[{type:g}]},f);k=e([i({selector:"awg-edition-complex-card",template:ie,changeDetection:N.OnPush,styles:[oe]})],k);var se=`<div
...
`;var ne="";var _,j=(_=class{},_.propDecorators={jumbotronId:[{type:g}],jumbotronTitle:[{type:g}]},_);j=e([i({selector:"awg-edition-jumbotron",template:se,changeDetection:N.OnPush,styles:[ne]})],j);var re=class{};re=e([D({imports:[G,M],declarations:[te,k,j]})],re);export{re as EditionViewModule};
