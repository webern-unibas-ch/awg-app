import{A as i,G as C,J as o,Ja as n,L as x,O as _,Qa as D,Va as d,Xa as s,h as T,i as O,j as t,ka as I,kb as k,na as w,ob as y,t as l,w as N}from"./chunk-NUGPBYBK.js";var L=`<!-- sideinfo: edition -->
<div class="card">
...
`;var F="";var f=class{constructor(){this.editionViewTitle="Editions\xFCbersicht",this.editionViewId="awg-edition-view",this._editionStateService=i(s)}get editionRouteConstants(){return n}ngOnInit(){this.setupEditionView()}setupEditionView(){this.selectedEditionSeries$=this._editionStateService.getSelectedEditionSeries().pipe(l(0)),this.selectedEditionSection$=this._editionStateService.getSelectedEditionSection().pipe(l(0)),this.selectedEditionComplex$=this._editionStateService.getSelectedEditionComplex().pipe(l(0)),this.isIntroView$=this._editionStateService.getIsIntroView().pipe(l(0)),this.isPrefaceView$=this._editionStateService.getIsPrefaceView().pipe(l(0)),this.isRowTableView$=this._editionStateService.getIsRowTableView().pipe(l(0))}};f=t([o({selector:"awg-edition-view",template:W,changeDetection:C.Eager,standalone:!1,styles:[F]})],f);var pe=[{path:"",outlet:"side",component:p},{path:"",component:f,children:[{path:"preface",loadChildren:()=>import("./chunk-TYNLOLON.js").then(e=>e.EditionPrefaceModule)},{path:"row-tables",loadChildren:()=>import("./chunk-F6ZBJXWT.js").then(e=>e.EditionRowTablesModule)},{path:"series",component:E},{path:"series/:id",component:h,children:[{path:"sections",component:g},{path:"section/:id",loadChildren:()=>import("./chunk-QGSJZBFX.js").then(e=>e.EditionSectionDetailModule)},{path:"sections/:id",redirectTo:"section/:id",pathMatch:"full"},{path:"",redirectTo:"sections",pathMatch:"full"}]},{path:"composition",redirectTo:"complex",pathMatch:"prefix"},{path:"complex/:complexId",component:u,children:[{path:"",component:S,children:[{path:"intro",loadChildren:()=>import("./chunk-XWDXJOF3.js").then(e=>e.EditionIntroModule)},{path:"sheets",loadChildren:()=>import("./chunk-DIPXNP22.js").then(e=>e.EditionSheetsModule)},{path:"report",loadChildren:()=>import("./chunk-WRWENRR3.js").then(e=>e.EditionReportModule)},{path:"graph",loadChildren:()=>import("./chunk-N6GABCDH.js").then(e=>e.EditionGraphModule)},{path:"",redirectTo:"sheets",pathMatch:"full"}]}]}]}],J=[f,u,S,p,g,E,h],b=class{};b=t([_({imports:[w.forChild(pe)],exports:[w]})],b);var K=`<div class="p-3 pt-4 text-center shadow border rounded-3 awg-jumbotron">
    <h3 id="{{ jumbotronId }}" [innerHTML]="jumbotronTitle"></h3>
</div>
`;var Q="";var R=class{static{this.propDecorators={jumbotronId:[{type:x}],jumbotronTitle:[{type:x}]}}};R=t([o({selector:"awg-edition-jumbotron",template:K,changeDetection:C.OnPush,standalone:!1,styles:[Q]})],R);var Y=class{};Y=t([_({imports:[y,b],declarations:[J,R]})],Y);export{Y as EditionViewModule};
