import{D as r,H as o,Ka as g,Na as h,S as t,Sb as v,U as n,Ub as d,X as a,h as u,j as e,qb as x,r as C,rc as D,z as E}from"./chunk-7SCHPD7Z.js";var w=`<div class="row row-cols-1 row-cols-md-3 row-cols-xl-5 g-4">
...
`;var y="";var l=class{static{this.propDecorators={complexes:[{type:n}]}}};l=e([t({selector:"awg-edition-section-detail-complex-card",template:w,changeDetection:o.OnPush,styles:[y]})],l);var I=`<awg-alert-info
    [infoMessage]="
        'Die Online-Edition wird in Bezug auf Umfang und Funktionalit\xE4t kontinuierlich erweitert.'
    "></awg-alert-info>
`;var R="";var p=class{};p=e([t({selector:"awg-edition-section-detail-disclaimer",template:I,changeDetection:o.OnPush,styles:[R]})],p);var O=`@if (selectedSeries && selectedSection) {
    <div class="card awg-edition-card h-100">
...
`;var b="";var m=class{static{this.propDecorators={selectedSeries:[{type:n}],selectedSection:[{type:n}]}}};m=e([t({selector:"awg-edition-section-detail-intro-card",template:O,changeDetection:o.OnPush,styles:[b]})],m);var L=`<awg-alert-info
    [infoMessage]="
        ...
        '.]'
    "></awg-alert-info>
`;var N="";var S=class{static{this.propDecorators={selectedSeries:[{type:n}],selectedSection:[{type:n}]}}};S=e([t({selector:"awg-edition-section-detail-placeholder",template:L,changeDetection:o.OnPush,styles:[N]})],S);var U=`@if (selectedSection$ | async; as selectedSection) {
    @if (
