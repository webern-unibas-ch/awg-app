import{a as x}from"./chunk-W4RURGAL.js";import{f as p}from"./chunk-KNCJ7UXV.js";import"./chunk-XFOKPBXD.js";import{a as M,i as j,l as U,o as P}from"./chunk-Q5BBFFUU.js";import{A,Da as o,F as D,J as r,O as t,Qa as W,Sa as F,T as G,U as a,W as n,X as i,_ as h,k as N,t as L,ub as T}from"./chunk-OIF6Z6X7.js";var B=`<div class="awg-source-description-corrections">
...
`;var H="";var m,_=(m=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},m.ctorParameters=()=>[],m.propDecorators={corrections:[{type:n}],navigateToReportFragmentRequest:[{type:i}],openModalRequest:[{type:i}],selectSvgSheetRequest:[{type:i}]},m);_=o([a({selector:"awg-source-description-corrections",template:B,changeDetection:r.OnPush,styles:[H]})],_);var z=`@if (details?.length) {
...
`;var Q="";var u,E=(u=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},u.ctorParameters=()=>[],u.propDecorators={details:[{type:n}],detailsClass:[{type:n}],detailsLabel:[{type:n}],navigateToReportFragmentRequest:[{type:i}],openModalRequest:[{type:i}],selectSvgSheetRequest:[{type:i}]},u);E=o([a({selector:"awg-source-description-details",template:z,changeDetection:r.OnPush,styles:[Q]})],E);var Z=`@if (sourceDescriptionListData) {
...
`;var K="";var d,w=(d=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.FIRM_SIGNS=j,this.ref=this}getWritingInstruments(e){let s=e.secondary?.join(", ");return`${s?`${e.main}; ${s}`:e.main}.`}getWritingMaterialFirmSign(e){return e&&this.FIRM_SIGNS[e]?this.FIRM_SIGNS[e]:{route:"",full:"Not a known firm sign.",short:"unknown"}}getWritingMaterialItemLocation(e){if(!this.utils.isNotEmptyObject(e)||!this.utils.isNotEmptyArray(e.folios))return"";let s=e.folios.map(c=>c.endsWith("v")||c.endsWith("r")?`${c.slice(0,-1)}<sup>${c.slice(-1)}</sup>`:c),l=s.length>1?`${s.slice(0,-1).join(", ")} und ${s.slice(-1)}`:s[0],S=e.info?`${e.info} `:"",y=e.position?` ${e.position}`:"";return`${S}auf Bl. ${l}${y}`}getWritingMaterialFormat(e){let{orientation:s,height:l,width:S}=e,y=c=>this.utils.isNotEmptyObject(c)?c.uncertainty?`${c.uncertainty} ${c.value}`:c.value:"";return`Format: ${s} ${y(l)} \xD7 ${y(S)} mm`}getWritingMaterialSystems(e){return[`${e.number} ${e.number===1?"System":"Systeme"}`,e.info&&` (${e.info})`,e.addendum&&`, ${e.addendum}`].filter(Boolean).join("")}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},d.ctorParameters=()=>[{type:p}],d.propDecorators={sourceDescriptionListData:[{type:n}],navigateToReportFragmentRequest:[{type:i}],openModalRequest:[{type:i}],selectSvgSheetRequest:[{type:i}]},d);w=o([a({selector:"awg-source-description",template:Z,changeDetection:r.OnPush,styles:[K]})],w);var C=class{};C=o([h({imports:[T,x],declarations:[w,E,_],exports:[w]})],C);var V=`@if (sourceEvaluationListData) {
...
`;var Y="";var g,q=(g=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.ref=this}get editionRouteConstants(){return M}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},g.ctorParameters=()=>[{type:p}],g.propDecorators={editionComplex:[{type:n}],sourceEvaluationListData:[{type:n}],navigateToReportFragmentRequest:[{type:i}],openModalRequest:[{type:i}],selectSvgSheetRequest:[{type:i}]},g);q=o([a({selector:"awg-source-evaluation",template:V,changeDetection:r.OnPush,styles:[Y]})],q);var J=`<div class="card">
    <div class="card-body">
...
`;var X=`table.awg-source-list-sources>tbody>tr>th{white-space:nowrap}
`;var f,$=(f=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}},f.ctorParameters=()=>[{type:p}],f.propDecorators={sourceListData:[{type:n}],navigateToReportFragmentRequest:[{type:i}],openModalRequest:[{type:i}]},f);$=o([a({selector:"awg-source-list",template:J,changeDetection:r.OnPush,styles:[X]})],$);var ee=`@if (textcriticsData) {
    <div ngbAccordion>
...
`;var te="";var v,I=(v=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},v.ctorParameters=()=>[{type:p}],v.propDecorators={textcriticsData:[{type:n}],navigateToReportFragmentRequest:[{type:i}],openModalRequest:[{type:i}],selectSvgSheetRequest:[{type:i}]},v);I=o([a({selector:"awg-textcritics-list",template:ee,changeDetection:r.OnPush,styles:[te]})],I);var ie=`<!-- content: edition report -->
<div>
    <!-- modal -->
...
`;var oe="";var R,b=(R=class{constructor(){this.errorObject=null,this.titles={sourceList:"1. Quellen\xFCbersicht",sourceDescription:"2. Quellenbeschreibung",sourceEvaluation:"3. Quellenbewertung",tka:"4. Textkritische Anmerkungen"},this._editionDataService=D(U),this._editionStateService=D(P),this._router=D(W)}get editionRouteConstants(){return M}ngOnInit(){this.getEditionReportData()}getEditionReportData(){this.editionReportData$=this._editionStateService.getSelectedEditionComplex().pipe(A(e=>(this.editionComplex=e,this._editionDataService.getEditionReportData(this.editionComplex))),L(e=>(this.errorObject=e,N)))}onModalOpen(e){e&&this.modal.open(e)}onReportFragmentNavigate(e){let s=this.editionRouteConstants.EDITION_REPORT.route,l={fragment:e?.fragmentId??""};this._navigateWithComplexId(e?.complexId,s,l)}onSvgSheetSelect(e){let s=this.editionRouteConstants.EDITION_SHEETS.route,l={queryParams:{id:e?.sheetId??""}};this._navigateWithComplexId(e?.complexId,s,l)}_navigateWithComplexId(e,s,l){let S=e?`/edition/complex/${e}/`:this.editionComplex.baseRoute;this._router.navigate([S,s],l)}},R.propDecorators={modal:[{type:G,args:["modal",{static:!0}]}]},R);b=o([a({selector:"awg-edition-report",template:ie,changeDetection:r.OnPush,styles:[oe]})],b);var we=[{path:"",component:b,data:{title:"AWG Online Edition \u2013 Report"}}],se=[b],O=class{};O=o([h({imports:[F.forChild(we)],exports:[F]})],O);var ne=class{};ne=o([h({imports:[T,x,C,O],declarations:[I,q,$,se]})],ne);export{ne as EditionReportModule};
