import{a as ye,e as Ce}from"./chunk-J4MOM5N6.js";import{a as A}from"./chunk-YUTZFZT7.js";import{A as g,Aa as re,C as r,Ca as ae,Ea as le,F as J,Fa as de,G as p,J as d,L as l,La as he,M as a,Ma as ce,N as ee,Na as ge,O as v,Oa as pe,Pa as ve,R as u,T as te,Ta as Se,Wa as me,Xa as ue,a as H,b as j,cb as U,f as Z,fb as fe,gb as _e,h as w,i as Y,j as n,ka as ie,kb as we,la as se,lb as _,na as B,o as Q,pb as S,r as X,s as K,ta as oe,v as P,w as I,x as F,za as ne}from"./chunk-WR5WNWSX.js";var be=`<h6 class="card-title">
    {{ facetItemLabel }}:
...
`;var Re="";var C=class{constructor(){this.isMinimized=!1,this.selectSvgSheetRequest=new r,this.toggleSheetFacetRequest=new r,this.faAnglesLeft=le,this.faListUl=de}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleSheetFacet(){this.toggleSheetFacetRequest.emit(!this.isMinimized)}static{this.propDecorators={isMinimized:[{type:l}],svgSheetsData:[{type:l}],selectedSvgSheet:[{type:l}],selectSvgSheetRequest:[{type:a}],toggleSheetFacetRequest:[{type:a}]}}};C=n([d({selector:"awg-edition-svg-sheet-facet",template:ke,changeDetection:p.OnPush,standalone:!1,styles:[Re]})],C);var q=class{};q=n([v({imports:[S],declarations:[C,y],exports:[C,y]})],q);var Ee=`<div class="awg-edition-svg-sheet-footer mt-4">
...
`;var Te="";var b=class{constructor(){this.navigateToReportFragmentRequest=new r,this.openModalRequest=new r,this.selectSvgSheetRequest=new r,this.faChevronRight=oe,this.faChevronDown=ne,this.showEvaluation=!1,this.UTILS=g(_),this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleEvaluation(){this.showEvaluation=!this.showEvaluation}static{this.ctorParameters=()=>[]}static{this.propDecorators={selectedTextcriticalCommentary:[{type:l}],selectedTextcritics:[{type:l}],showTkA:[{type:l}],navigateToReportFragmentRequest:[{type:a}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]}}};b=n([d({selector:"awg-edition-svg-sheet-footer",template:Ee,changeDetection:p.OnPush,standalone:!1,styles:[Te]})],b);var D=class{};D=n([v({imports:[S,A],declarations:[b],exports:[b]})],D);var Le=`<div class="awg-edition-svg-sheet-viewer-nav">
...
`;var Ne="";var T=class{constructor(){this.openModalRequest=new r,this.selectSvgSheetRequest=new r,this.faSquare=ae,this.folioLegends=[{color:"olivedrab",label:"aktuell ausgew\xE4hlt"},{color:"orange",label:"ausw\xE4hlbar"},{color:"grey",label:"(momentan noch) nicht ausw\xE4hlbar"}]}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={selectedConvolute:[{type:l}],selectedSvgSheet:[{type:l}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]}}};T=n([d({selector:"awg-edition-convolute",template:Ge,changeDetection:p.OnPush,standalone:!1,styles:[Ne]})],T);var ze=`<!-- embedded svg: Edition Folio Viewer -->
