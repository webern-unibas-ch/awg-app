import{j as y}from"./chunk-OD3IKSEP.js";import"./chunk-NRJBYYT3.js";import{c as R,i as O}from"./chunk-VLG7LXMJ.js";import{g as k}from"./chunk-R3T6RTQX.js";import{c as n,h as D,m as a,p as s}from"./chunk-AMPKBCZN.js";import"./chunk-O252IYCW.js";import"./chunk-DNAIPX3F.js";import{Aa as I,N as l,W as _,ea as i,k as C,n as N,o as t,pb as o,rb as T,vb as b}from"./chunk-V7BW7F4C.js";var L=`<!-- sideinfo: edition -->
<div class="card">
...
<!-- edition routes -->
<router-outlet />
`;var j="";var u=class{constructor(){this._editionStateService=i(s),this._route=i(R),this._utils=i(k)}get editionRouteConstants(){return n}ngOnInit(){this.updateEditionComplexFromRoute()}updateEditionComplexFromRoute(){this._route.paramMap.subscribe(r=>{let c=r.get("complexId")||"",d=D.getEditionComplexById(c);if(this._utils.isNotEmptyObject(d)){let w=a.getEditionSeriesById(d.pubStatement.series.route),q=a.getEditionSectionById(d.pubStatement.series.route,d.pubStatement.section.route);this._editionStateService.updateSelectedEditionSeries(w),this._editionStateService.updateSelectedEditionSection(q),this._editionStateService.updateSelectedEditionComplex(d),this.selectedEditionComplex$=this._editionStateService.getSelectedEditionComplex().pipe(l(0))}else this.selectedEditionComplex$=N})}ngOnDestroy(){this._editionStateService.clearSelectedEditionComplex(),this._editionStateService.clearSelectedEditionSeries(),this._editionStateService.clearSelectedEditionSection()}};u=t([o({selector:"awg-edition-complex",template:V,standalone:!1,styles:[j]})],u);var A=`@if (editionRouterLinkButtons) {
...
`;var F="";var f=class{constructor(){this.editionViewTitle="Editions\xFCbersicht",this.editionViewId="awg-edition-view",this._editionStateService=i(s)}get editionRouteConstants(){return n}ngOnInit(){this.setupEditionView()}setupEditionView(){this.selectedEditionSeries$=this._editionStateService.getSelectedEditionSeries().pipe(l(0)),this.selectedEditionSection$=this._editionStateService.getSelectedEditionSection().pipe(l(0)),this.selectedEditionComplex$=this._editionStateService.getSelectedEditionComplex().pipe(l(0)),this.isIntroView$=this._editionStateService.getIsIntroView().pipe(l(0)),this.isPrefaceView$=this._editionStateService.getIsPrefaceView().pipe(l(0)),this.isRowTableView$=this._editionStateService.getIsRowTableView().pipe(l(0))}};f=t([o({selector:"awg-edition-view",template:W,changeDetection:I.Eager,standalone:!1,styles:[F]})],f);var pe=[{path:"",outlet:"side",component:p},{path:"",component:f,children:[{path:"preface",loadChildren:()=>import("./chunk-7WL6HPRO.js").then(e=>e.EditionPrefaceModule)},{path:"row-tables",loadChildren:()=>import("./chunk-C6KJLENV.js").then(e=>e.EditionRowTablesModule)},{path:"series",component:E},{path:"series/:id",component:h,children:[{path:"sections",component:g},{path:"section/:id",loadChildren:()=>import("./chunk-7BZRDHAM.js").then(e=>e.EditionSectionDetailModule)},{path:"sections/:id",redirectTo:"section/:id",pathMatch:"full"},{path:"",redirectTo:"sections",pathMatch:"full"}]},{path:"composition",redirectTo:"complex",pathMatch:"prefix"},{path:"complex/:complexId",component:u,children:[{path:"",component:S,children:[{path:"intro",loadChildren:()=>import("./chunk-XEFFC5IN.js").then(e=>e.EditionIntroModule)},{path:"sheets",loadChildren:()=>import("./chunk-F6WHLRMQ.js").then(e=>e.EditionSheetsModule)},{path:"report",loadChildren:()=>import("./chunk-5DYLU73V.js").then(e=>e.EditionReportModule)},{path:"graph",loadChildren:()=>import("./chunk-PCPCMTQK.js").then(e=>e.EditionGraphModule)},{path:"",redirectTo:"sheets",pathMatch:"full"}]}]}]}],J=[f,u,S,p,g,E,h],v=class{};v=t([b({imports:[O.forChild(pe)],exports:[O]})],v);var K=`<div class="p-3 pt-4 text-center shadow border rounded-3 awg-jumbotron">
    <h3 id="{{ jumbotronId }}" [innerHTML]="jumbotronTitle"></h3>
</div>
`;var Q="";var x=class{static{this.propDecorators={jumbotronId:[{type:T}],jumbotronTitle:[{type:T}]}}};x=t([o({selector:"awg-edition-jumbotron",template:K,changeDetection:I.OnPush,standalone:!1,styles:[Q]})],x);var Y=class{};Y=t([b({imports:[y,v],declarations:[J,x]})],Y);export{Y as EditionViewModule};
