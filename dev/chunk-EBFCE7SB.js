import{Ba as u,D as c,J as o,M as i,R as n,cb as d,ec as m,j as e,rb as p}from"./chunk-RZNBUU2V.js";var l=`<!-- sideinfo: structure -->
<div class="card">
...
`;var h="";var r=class{constructor(){this.structureViewTitle="Datenstrukturmodell",this.structureViewId="awg-structure-view"}};r=e([i({selector:"awg-structure-view",template:w,changeDetection:o.Eager,standalone:!1,styles:[h]})],r);var k=[{path:"",component:r,data:{title:"AWG Online Edition \u2013 Structure"}},{path:"",outlet:"side",component:t}],f=[r,t],s=class{};s=e([n({imports:[u.forChild(k)],exports:[u]})],s);var _=class{};_=e([n({imports:[m,s],declarations:[f]})],_);export{_ as StructureViewModule};
