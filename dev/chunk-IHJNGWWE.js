import{B as U,D as c,Da as G,Fa as P,G as g,Ha as y,Jb as H,K as d,Kb as V,Lb as L,Nb as W,O as s,Q as n,R as m,T as f,Z as F,a as E,b as R,h as N,i as k,j as i,jb as j,kc as z,l as D,n as O,o as T,q as B,s as q,x as M,y as x,z as $,zb as A}from"./chunk-L5DKO235.js";var Y=`@if (introBlockContent) {
...
`;var _=class{constructor(){this.navigateToIntroFragmentRequest=new g,this.navigateToReportFragmentRequest=new g,this.openModalRequest=new g,this.selectSvgSheetRequest=new g,this._editionGlyphService=c(V),this.ref=this}getGlyph(t){return this._editionGlyphService.getGlyph(t)}navigateToIntroFragment(t){t?.fragmentId&&this.navigateToIntroFragmentRequest.emit(t)}navigateToReportFragment(t){t?.fragmentId&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}selectSvgSheet(t){t?.sheetId&&this.selectSvgSheetRequest.emit(t)}static{this.ctorParameters=()=>[]}static{this.propDecorators={introBlockContent:[{type:n}],notesLabel:[{type:n}],navigateToIntroFragmentRequest:[{type:m}],navigateToReportFragmentRequest:[{type:m}],openModalRequest:[{type:m}],selectSvgSheetRequest:[{type:m}]}}};_=i([s({selector:"awg-edition-intro-content",template:Y,changeDetection:d.OnPush,standalone:!1,styles:[Z]})],_);var J=`@if (introBlockContent) {
...
`;var et="";var v=class{static{this.propDecorators={editionComplex:[{type:n}],editionLabel:[{type:n}]}}};v=i([s({selector:"awg-edition-intro-placeholder",template:tt,changeDetection:d.OnPush,standalone:!1,styles:[et]})],v);var ot=`<!-- content: intro -->
<div>
    <!-- modal -->
