import{a as x}from"./chunk-3TDVJTKT.js";import{f as l}from"./chunk-RDIAWPJA.js";import{a as G,m as W}from"./chunk-MLJWJOLZ.js";import{c as D,v as L}from"./chunk-OPTPEN2Q.js";import"./chunk-6TXQSV6X.js";import{G as r,L as i,Ma as A,Oa as k,Q as F,R as a,T as p,U as o,X as v,k as q,l as s,ob as b,t as O,z as N}from"./chunk-BXL5SEJS.js";var U=`<div class="awg-source-description-corrections">
...
`;var B="";var u,S=(u=class{constructor(t){this.utils=t,this.navigateToReportFragmentRequest=new i,this.openModalRequest=new i,this.selectSvgSheetRequest=new i,this.FIRM_SIGNS=L,this.ref=this}getWritingInstruments(t){let e=t.secondary?.join(", ");return`${e?`${t.main}; ${e}`:t.main}.`}getWritingMaterialFirmSign(t){return t&&this.FIRM_SIGNS[t]?this.FIRM_SIGNS[t]:{route:"",full:"Not a known firm sign.",short:"unknown"}}getWritingMaterialItemLocation(t){if(!this.utils.isNotEmptyObject(t)||!this.utils.isNotEmptyArray(t.folios))return"";let e=t.folios.map(c=>c.endsWith("v")||c.endsWith("r")?`${c.slice(0,-1)}<sup>${c.slice(-1)}</sup>`:c),n=e.length>1?`${e.slice(0,-1).join(", ")} und ${e.slice(-1)}`:e[0],y=t.info?`${t.info} `:"",R=t.position?` ${t.position}`:"";return`${y}auf Bl. ${n}${R}`}getWritingMaterialFormat(t){let{orientation:e,height:n,width:y}=t,R=c=>this.utils.isNotEmptyObject(c)?c.uncertainty?`${c.uncertainty} ${c.value}`:c.value:"";return`Format: ${e} ${R(n)} \xD7 ${R(y)} mm`}getWritingMaterialSystems(t){return[`${t.number} ${t.number===1?"System":"Systeme"}`,t.info&&` (${t.info})`,t.addendum&&`, ${t.addendum}`].filter(Boolean).join("")}navigateToReportFragment(t){t?.fragmentId&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}selectSvgSheet(t){t?.sheetId&&this.selectSvgSheetRequest.emit(t)}},u.ctorParameters=()=>[{type:l}],u.propDecorators={sourceDescriptionListData:[{type:p}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]},u);S=s([a({selector:"awg-source-description",template:j,changeDetection:r.OnPush,styles:[B]})],S);var M=class{};M=s([v({imports:[b,x],declarations:[S,T],exports:[S]})],M);var H=`@if (sourceEvaluationListData) {
...
`;var z="";var d,E=(d=class{constructor(t){this.utils=t,this.navigateToReportFragmentRequest=new i,this.openModalRequest=new i,this.selectSvgSheetRequest=new i,this.ref=this}get editionRouteConstants(){return D}navigateToReportFragment(t){t?.fragmentId&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}selectSvgSheet(t,e){e&&this.selectSvgSheetRequest.emit({complexId:t,sheetId:e})}},d.ctorParameters=()=>[{type:l}],d.propDecorators={editionComplex:[{type:p}],sourceEvaluationListData:[{type:p}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]},d);E=s([a({selector:"awg-source-evaluation",template:H,changeDetection:r.OnPush,styles:[z]})],E);var Q=`<div class="card">
    <div class="card-body">
...
`;var g,_=(g=class{constructor(t){this.utils=t,this.navigateToReportFragmentRequest=new i,this.openModalRequest=new i,this.ref=this}navigateToReportFragment(t){t?.fragmentId&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}},g.ctorParameters=()=>[{type:l}],g.propDecorators={sourceListData:[{type:p}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}]},g);_=s([a({selector:"awg-source-list",template:Q,changeDetection:r.OnPush,styles:[Z]})],_);var K=`@if (textcriticsData) {
    <div ngbAccordion>
...
`;var J="";var h,w=(h=class{constructor(t,e,n){this.editionDataService=t,this.editionService=e,this.router=n,this.errorObject=null,this.titles={sourceList:"1. Quellen\xFCbersicht",sourceDescription:"2. Quellenbeschreibung",sourceEvaluation:"3. Quellenbewertung",tka:"4. Textkritische Anmerkungen"}}get editionRouteConstants(){return D}ngOnInit(){this.getEditionReportData()}getEditionReportData(){this.editionReportData$=this.editionService.getEditionComplex().pipe(N(t=>(this.editionComplex=t,this.editionDataService.getEditionReportData(this.editionComplex))),O(t=>(this.errorObject=t,q)))}onModalOpen(t){t&&this.modal.open(t)}onReportFragmentNavigate(t){let e=this.editionRouteConstants.EDITION_REPORT.route,n={fragment:t?.fragmentId??""};this._navigateWithComplexId(t.complexId,e,n)}onSvgSheetSelect(t){let e=this.editionRouteConstants.EDITION_SHEETS.route,n={queryParams:{id:t?.sheetId??""}};this._navigateWithComplexId(t?.complexId,e,n)}_navigateWithComplexId(t,e,n){let y=t?`/edition/complex/${t}/`:this.editionComplex.baseRoute;this.router.navigate([y,e],n)}},h.ctorParameters=()=>[{type:G},{type:W},{type:A}],h.propDecorators={modal:[{type:F,args:["modal",{static:!0}]}]},h);w=s([a({selector:"awg-edition-report",template:Y,changeDetection:r.OnPush,styles:[J]})],w);var dt=[{path:"",component:w,data:{title:"AWG Online Edition \u2013 Report"}}],X=[w],C=class{};C=s([v({imports:[k.forChild(dt)],exports:[k]})],C);var tt=class{};tt=s([v({imports:[b,x,M,C],declarations:[I,E,_,X]})],tt);export{tt as EditionReportModule};
