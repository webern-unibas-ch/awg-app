import{a as m}from"./chunk-PP6HJ337.js";import{C as i,G as C,Gb as n,Ka as I,Na as w,Nb as k,R as o,Sb as d,T as x,Ub as s,W as _,h as T,i as O,qb as D,rc as y,u as a,y as N,ya as t}from"./chunk-UVZRJI7X.js";var L=`<!-- sideinfo: edition -->
<div class="card">
...
`;var F="";var f=class{constructor(){this.editionViewTitle="Editions\xFCbersicht",this.editionViewId="awg-edition-view",this._editionStateService=i(s)}get editionRouteConstants(){return n}ngOnInit(){this.setupEditionView()}setupEditionView(){this.selectedEditionSeries$=this._editionStateService.getSelectedEditionSeries().pipe(a(0)),this.selectedEditionSection$=this._editionStateService.getSelectedEditionSection().pipe(a(0)),this.selectedEditionComplex$=this._editionStateService.getSelectedEditionComplex().pipe(a(0)),this.isIntroView$=this._editionStateService.getIsIntroView().pipe(a(0)),this.isPrefaceView$=this._editionStateService.getIsPrefaceView().pipe(a(0)),this.isRowTableView$=this._editionStateService.getIsRowTableView().pipe(a(0))}};f=t([o({selector:"awg-edition-view",template:W,changeDetection:C.Default,styles:[F]})],f);var ue=[{path:"",outlet:"side",component:p},{path:"",component:f,children:[{path:"preface",loadChildren:()=>import("./chunk-PZJ5TTND.js").then(e=>e.EditionPrefaceModule)},{path:"row-tables",loadChildren:()=>import("./chunk-2D7G4SMJ.js").then(e=>e.EditionRowTablesModule)},{path:"series",component:E},{path:"series/:id",component:h,children:[{path:"sections",component:g},{path:"section/:id",loadChildren:()=>import("./chunk-QMD5ZMJ3.js").then(e=>e.EditionSectionDetailModule)},{path:"sections/:id",redirectTo:"section/:id",pathMatch:"full"},{path:"",redirectTo:"sections",pathMatch:"full"}]},{path:"composition",redirectTo:"complex",pathMatch:"prefix"},{path:"complex/:complexId",component:u,children:[{path:"",component:S,children:[{path:"intro",loadChildren:()=>import("./chunk-SO3AIZK5.js").then(e=>e.EditionIntroModule)},{path:"sheets",loadChildren:()=>import("./chunk-JYRJLPXD.js").then(e=>e.EditionSheetsModule)},{path:"report",loadChildren:()=>import("./chunk-5E6JEVW3.js").then(e=>e.EditionReportModule)},{path:"graph",loadChildren:()=>import("./chunk-NSPYO524.js").then(e=>e.EditionGraphModule)},{path:"",redirectTo:"sheets",pathMatch:"full"}]}]}]}],J=[f,u,S,p,g,E,h],b=class{};b=t([_({imports:[w.forChild(ue)],exports:[w]})],b);var K=`<div class="p-3 pt-4 text-center shadow border rounded-3 awg-jumbotron">
    <h3 id="{{ jumbotronId }}" [innerHTML]="jumbotronTitle"></h3>
</div>
`;var Q="";var c,R=(c=class{},c.propDecorators={jumbotronId:[{type:x}],jumbotronTitle:[{type:x}]},c);R=t([o({selector:"awg-edition-jumbotron",template:K,changeDetection:C.OnPush,styles:[Q]})],R);var Y=class{};Y=t([_({imports:[y,b],declarations:[J,R]})],Y);export{Y as EditionViewModule};
