import{B,D as g,Gb as F,H as m,La as M,M as l,Na as b,R as q,Rb as U,S as r,U as o,Ub as P,V as d,X as h,a as w,b as E,h as k,i as R,j as i,l as x,n as L,o as y,q as D,qb as $,rc as G,s as O,x as T,y as S,z as N}from"./chunk-3QKLUT5W.js";var j=`@if (introBlockContent) {
...
`;var f=class{constructor(){this.navigateToIntroFragmentRequest=new l,this.navigateToReportFragmentRequest=new l,this.openModalRequest=new l,this.selectSvgSheetRequest=new l,this.ref=this}navigateToIntroFragment(t){t?.fragmentId&&this.navigateToIntroFragmentRequest.emit(t)}navigateToReportFragment(t){t?.fragmentId&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}selectSvgSheet(t){t?.sheetId&&this.selectSvgSheetRequest.emit(t)}static{this.ctorParameters=()=>[]}static{this.propDecorators={introBlockContent:[{type:o}],notesLabel:[{type:o}],navigateToIntroFragmentRequest:[{type:d}],navigateToReportFragmentRequest:[{type:d}],openModalRequest:[{type:d}],selectSvgSheetRequest:[{type:d}]}}};f=i([r({selector:"awg-edition-intro-content",template:j,changeDetection:m.OnPush,styles:[H]})],f);var A=`@if (introBlockContent) {
...
`;var _=class{constructor(){this.languageChangeRequest=new l}setLanguage(t){(t===0||t===1)&&this.languageChangeRequest.emit(t)}static{this.propDecorators={introBlockContent:[{type:o}],notesLabel:[{type:o}],currentLanguage:[{type:o}],languageChangeRequest:[{type:d}]}}};_=i([r({selector:"awg-edition-intro-nav",template:A,changeDetection:m.OnPush,styles:[W]})],_);var V=`<div class="p-3 border rounded-3 text-center awg-edition-intro-partial-disclaimer">
...
`;var z="";var v=class{static{this.propDecorators={editionComplex:[{type:o}],editionLabel:[{type:o}],editionRoute:[{type:o}],seriesRoute:[{type:o}],sectionRoute:[{type:o}],introRoute:[{type:o}]}}};v=i([r({selector:"awg-edition-intro-partial-disclaimer",template:V,styles:[z]})],v);var Y=`<div class="awg-edition-intro-placeholder">
...
`;var Z="";var C=class{static{this.propDecorators={editionComplex:[{type:o}],editionLabel:[{type:o}]}}};C=i([r({selector:"awg-edition-intro-placeholder",template:Y,changeDetection:m.OnPush,styles:[Z]})],C);var J=`<!-- content: intro -->
<div>
    <!-- modal -->
