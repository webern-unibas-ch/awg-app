import{a as o}from"./chunk-JFKXFNRN.js";import{c as d,i as w}from"./chunk-KC4HWWAZ.js";import"./chunk-W2UYZXHE.js";import{e as b}from"./chunk-RGAHEKRW.js";import{a as f}from"./chunk-CXG3XTBH.js";import{Aa as n,Cc as u,Db as r,ea as s,lc as h,o as t,pb as a,qa as e,rb as i}from"./chunk-HOFVETHS.js";var _=`<!-- sideinfo: contact -->
<div class="card">
    <div class="card-body bg-light">
        <h5 id="awg-contact-side-info-header" class="mb-3">{{ CONTACT_SIDE_INFO_HEADER }}</h5>
        <awg-contact-address
            [pageMetaData]="pageMetaData()"
            [contactMetaData]="contactMetaData()"></awg-contact-address>
        <awg-contact-map [embedUrl]="mapEmbedUrl()" [linkUrl]="mapLinkUrl()"></awg-contact-map>
    </div>
</div>
`;var D="";var I=`<address>
...
`;var v="";var c=class{constructor(){this.pageMetaData=r({}),this.contactMetaData=r({})}static{this.propDecorators={pageMetaData:[{type:i,args:[{isSignal:!0,alias:"pageMetaData",required:!1,transform:void 0}]}],contactMetaData:[{type:i,args:[{isSignal:!0,alias:"contactMetaData",required:!1,transform:void 0}]}]}}};c=t([a({selector:"awg-contact-address",template:I,changeDetection:n.OnPush,styles:[v]})],c);var C=`<iframe
...
<div class="awg-contact-view p-5 border rounded-3">
    ...
    <!-- citation -->
    <!-- citation heading -->
    <awg-heading [title]="CITATION_TITLE" [id]="CITATION_ID"></awg-heading>
    ...
    <div class="awg-citation-description mb-5">
        ...
        <p class="awg-citation-text">
            ...
            <span class="awg-citation-version">{{ page?.version }}</span> vom
            <span class="awg-citation-version-release">{{ page?.versionReleaseDate | date: 'longDate' }}</span
    ...
    <awg-heading [title]="DOCUMENTATION_TITLE" [id]="DOCUMENTATION_ID"></awg-heading>
    ...
    <!-- imprint -->
    <!-- imprint heading -->
    <awg-heading [title]="IMPRINT_TITLE" [id]="IMPRINT_ID"></awg-heading>
    ...
    <div class="awg-imprint-description">
        ...
        <p>
            ...
            @for (developer of contact?.developers; track developer.name) {
                {{ developer.name
                }}<awg-meta-identifier-badges [identifiers]="developer.identifiers"></awg-meta-identifier-badges><br />
            }
    ...
    <div id="awg-disclaimer">
        ...
        <p>
            ...
            <a href="{{ page?.githubUrl }}">GitHub</a> unter einer
...
`;var p=class{constructor(){this._coreService=s(d),this.CITATION_ID="awg-citation",this.CITATION_TITLE="Zitation",this.IMPRINT_ID="awg-imprint",this.IMPRINT_TITLE="Impressum",this.DOCUMENTATION_ID="awg-documentation",this.DOCUMENTATION_TITLE="Dokumentation",this.contactMetaData=e(this._coreService.getMetaDataSection(o.contact)).asReadonly(),this.pageMetaData=e(this._coreService.getMetaDataSection(o.page)).asReadonly(),this.today=e(Date.now()).asReadonly()}};p=t([a({selector:"awg-contact-view",template:A,changeDetection:n.OnPush,imports:[h,f,w],styles:[N]})],p);var ze=[{path:"",component:p,data:{title:"AWG Online Edition \u2013 Contact"}},{path:"",outlet:"side",component:g}];export{ze as CONTACT_VIEW_ROUTES};
