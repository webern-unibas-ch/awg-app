import{E as s,Ea as w,Ha as E,J as o,Lb as y,Nb as m,P as t,R as i,U as p,h as C,j as e,jb as D,kc as I,r as x,z as v}from"./chunk-5KKKKAFE.js";var R=`<div class="row row-cols-1 row-cols-md-3 row-cols-xl-5 g-4">
...
`;var O="";var r,S=(r=class{},r.propDecorators={complexes:[{type:i}]},r);S=e([t({selector:"awg-edition-section-detail-complex-card",template:R,changeDetection:o.OnPush,standalone:!1,styles:[O]})],S);var b=`<awg-alert-info
    [infoMessage]="'Die Online-Edition wird in Bezug auf Umfang und Funktionalit\xE4t kontinuierlich erweitert.'"></awg-alert-info>
`;var L="";var _=class{};_=e([t({selector:"awg-edition-section-detail-disclaimer",template:b,changeDetection:o.OnPush,standalone:!1,styles:[L]})],_);var N=`@if (selectedSeries && selectedSection) {
    <div class="card awg-edition-card h-100">
...
`;var U="";var c,f=(c=class{},c.propDecorators={selectedSeries:[{type:i}],selectedSection:[{type:i}]},c);f=e([t({selector:"awg-edition-section-detail-intro-card",template:N,changeDetection:o.OnPush,standalone:!1,styles:[U]})],f);var M=`<awg-alert-info
    [infoMessage]="
        ...
        '.]'
    "></awg-alert-info>
`;var T="";var a,h=(a=class{},a.propDecorators={selectedSeries:[{type:i}],selectedSection:[{type:i}]},a);h=e([t({selector:"awg-edition-section-detail-placeholder",template:M,changeDetection:o.OnPush,standalone:!1,styles:[T]})],h);var G=`@if (selectedSection$ | async; as selectedSection) {
    @if (
