import{a as g}from"./chunk-PP6HJ337.js";import{f as j}from"./chunk-Q4BTS5QO.js";import"./chunk-FQMMXNCW.js";import{a as n,h as $,m as l,o as s}from"./chunk-WBFAT3TC.js";import{B as D,Ca as e,I as M,Oa as x,Pa as L,Ra as N,T as o,V as O,Z as R,h as y,k,sb as V,x as r}from"./chunk-LY2JR32L.js";var G=`<!--
...
`;var Q="";var S,v=(S=class{constructor(t,d){this.editionStateService=t,this.router=d,this.editionViewTitle="Editions\xFCbersicht",this.editionViewId="awg-edition-view"}get editionRouteConstants(){return n}ngOnInit(){this.setupEditionView(),this.navigateToSideOutlet()}setupEditionView(){this.selectedEditionSeries$=this.editionStateService.getSelectedEditionSeries().pipe(r(0)),this.selectedEditionSection$=this.editionStateService.getSelectedEditionSection().pipe(r(0)),this.selectedEditionComplex$=this.editionStateService.getSelectedEditionComplex().pipe(r(0)),this.isIntroView$=this.editionStateService.getIsIntroView().pipe(r(0)),this.isPrefaceView$=this.editionStateService.getIsPrefaceView().pipe(r(0)),this.isRowTableView$=this.editionStateService.getIsRowTableView().pipe(r(0))}navigateToSideOutlet(){this.router.navigate([{outlets:{side:"editionInfo"}}],{preserveFragment:!0})}},S.ctorParameters=()=>[{type:s},{type:L}],S);v=e([o({selector:"awg-edition-view",template:K,styles:[Q]})],v);var he=[{path:"",component:v,children:[{path:"preface",loadChildren:()=>import("./chunk-E4RMIMPV.js").then(i=>i.EditionPrefaceModule)},{path:"row-tables",loadChildren:()=>import("./chunk-MOLNNAQA.js").then(i=>i.EditionRowTablesModule)},{path:"series",component:b},{path:"series/:id",component:_,children:[{path:"sections",component:I},{path:"section/:id",loadChildren:()=>import("./chunk-WZIQKWSY.js").then(i=>i.EditionSectionDetailModule)},{path:"sections/:id",redirectTo:"section/:id",pathMatch:"full"},{path:"",redirectTo:"sections",pathMatch:"full"}]},{path:"composition",redirectTo:"complex",pathMatch:"prefix"},{path:"complex/:complexId",component:f,children:[{path:"",component:C,children:[{path:"intro",loadChildren:()=>import("./chunk-DE5GCR2T.js").then(i=>i.EditionIntroModule)},{path:"sheets",loadChildren:()=>import("./chunk-BR57YGZH.js").then(i=>i.EditionSheetsModule)},{path:"report",loadChildren:()=>import("./chunk-UY224DAO.js").then(i=>i.EditionReportModule)},{path:"graph",loadChildren:()=>import("./chunk-GDVJH7U6.js").then(i=>i.EditionGraphModule)},{path:"",redirectTo:"sheets",pathMatch:"full"}]}]}]}],q=[v,f,C,I,b,_],w=class{};w=e([R({imports:[N.forChild(he)],exports:[N]})],w);var Y=`<div class="p-3 pt-4 text-center shadow border rounded-3 awg-jumbotron">
