import{a as p}from"./chunk-JFKXFNRN.js";import{c as u,i as d}from"./chunk-KC4HWWAZ.js";import"./chunk-W2UYZXHE.js";import{a as c}from"./chunk-CXG3XTBH.js";import{Aa as t,ea as o,lc as a,o as e,pb as r,qa as s}from"./chunk-HOFVETHS.js";var m=`<!-- sideinfo: structure -->
<div class="card">
...
`;var _="";var i=class{constructor(){this._coreService=o(u),this.STRUCTURE_SIDE_INFO_HEADER="Strukturmodell",this.structureMetaData=s(this._coreService.getMetaDataSection(p.structure)).asReadonly()}};i=e([r({selector:"awg-structure-info",template:m,changeDetection:t.OnPush,imports:[a,d],styles:[_]})],i);var l=`<!-- content: structure -->
<div class="awg-structure-view p-5 border rounded-3">
    <!-- heading -->
    <awg-heading [id]="STRUCTURE_VIEW_ID" [title]="STRUCTURE_VIEW_TITLE"></awg-heading>
