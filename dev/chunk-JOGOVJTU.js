import{a as H,b}from"./chunk-IUMG36W6.js";import{a}from"./chunk-GYSG6DRK.js";import{b as G,c as P,p as D}from"./chunk-YY7NLSKL.js";import{D as h,L as j,M as B,R as W}from"./chunk-7FZXOXZG.js";import{e as N,i as A}from"./chunk-VYYE6CBN.js";import"./chunk-HR6VI64U.js";import"./chunk-QJMMSUMS.js";import"./chunk-Q5OYA2D7.js";import{I as O,Ua as r,V as U,Wa as i,Xa as o,Za as d,bb as f,da as w,ka as t,kb as F,o as s,q as k,xa as n}from"./chunk-Z7GJXLFY.js";var z=`<table class="awg-source-description-content-table half-para-margin" role="presentation">
...
`;var K=`.awg-source-description-content-table{margin-left:25px}
`;var T=class{constructor(){this.selectSvgSheetRequest=new t,this.UTILS=a,this.ref=this}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={content:[{type:i}],selectSvgSheetRequest:[{type:o}]}}};T=s([r({selector:"awg-source-description-content-table",template:z,changeDetection:n.OnPush,standalone:!1,styles:[K]})],T);var Q=`<div class="awg-source-description-contents">
...
`;var _=class{constructor(){this.selectSvgSheetRequest=new t,this.openAllContentDetails=!0,this.UTILS=a,this.ref=this}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleAllContentDetails(e){this.openAllContentDetails=e}static{this.ctorParameters=()=>[]}static{this.propDecorators={contents:[{type:i}],selectSvgSheetRequest:[{type:o}]}}};_=s([r({selector:"awg-source-description-contents",template:Q,changeDetection:n.OnPush,standalone:!1,styles:[Z]})],_);var V=`<div class="awg-source-description-corrections">
...
`;var Y=`p{display:flex;align-items:baseline}p .awg-source-description-details-label{flex-shrink:0;white-space:nowrap}p .awg-source-description-details-content{flex:1}
`;var x=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.UTILS=a,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={details:[{type:i}],detailsClass:[{type:i}],detailsLabel:[{type:i}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]}}};x=s([r({selector:"awg-source-description-details",template:X,changeDetection:n.OnPush,standalone:!1,styles:[Y]})],x);var ee=`<p class="awg-source-description-writing-materials">
...
`;var te=`p{display:flex;align-items:baseline}p .awg-source-description-writing-materials-label{flex-shrink:0;white-space:nowrap}p .awg-source-description-writing-materials-content{flex:1}
`;var I=class{constructor(){this.UTILS=a,this.TRADEMARKS=j,this.ref=this}getTrademark(e){return e&&this.TRADEMARKS[e]?this.TRADEMARKS[e]:{route:"",full:"Not a known trademark.",short:"unknown"}}getItemLocus(e){if(a.isEmptyObject(e))return"";let c=p=>p.endsWith("v")||p.endsWith("r")?`${p.slice(0,-1)}<sup>${p.slice(-1)}</sup>`:p,m=p=>p.length===1?p[0].includes("all")?"auf allen Bl\xE4ttern":`auf Bl. ${p[0]}`:p.length>1?`auf Bl. ${p.slice(0,-1).join(", ")} und ${p.slice(-1)}`:"",g=e.folios.map(c),y=m(g),R=e.preFolioInfo?`${e.preFolioInfo} `:"",u=y?" ":"",ge=e.position?`${u}${e.position}`:"";return`${R}${y}${ge}`}getDimensions(e){let{orientation:c,height:m,width:g,unit:y}=e,R=u=>a.isEmptyObject(u)?"":u.uncertainty?`${u.uncertainty} ${u.value}`:u.value;return`Format: ${c} ${R(m)} \xD7 ${R(g)} ${y}`}getSystems(e){return[`${e.totalSystems} ${e.totalSystems===1?"System":"Systeme"}`,e.totalSystemsAddendum&&` (${e.totalSystemsAddendum})`,e.additionalInfo&&`, ${e.additionalInfo}`].filter(Boolean).join("")}static{this.ctorParameters=()=>[]}static{this.propDecorators={writingMaterials:[{type:i}]}}};I=s([r({selector:"awg-source-description-writing-materials",template:ee,changeDetection:n.OnPush,standalone:!1,styles:[te]})],I);var oe=`@if (sourceDescriptionListData) {
...
`;var se="";var v=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.UTILS=a,this.ref=this}getWritingInstruments(e){let c=e.secondary?.join(", ");return`${c?`${e.main}; ${c}`:e.main}.`}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={sourceDescriptionListData:[{type:i}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]}}};v=s([r({selector:"awg-source-description",template:oe,changeDetection:n.OnPush,standalone:!1,styles:[se]})],v);var E=class{};E=s([d({imports:[D,b],declarations:[v,_,T,C,x,I],exports:[v]})],E);var ie=`@if (sourceEvaluationListData) {
...
`;var ne="";var L=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.UTILS=a,this.ref=this}get editionRouteConstants(){return h}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={editionComplex:[{type:i}],sourceEvaluationListData:[{type:i}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]}}};L=s([r({selector:"awg-source-evaluation",template:ie,changeDetection:n.OnPush,standalone:!1,styles:[ne]})],L);var re=`<div class="card">
    <div class="card-body">
...
`;var ae="";var M=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.UTILS=a,this.ref=this}onSourceClick(e){e.hasDescription?this.navigateToReportFragment({complexId:"",fragmentId:e.linkTo}):this._openModal(e.linkTo)}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}_openModal(e){e&&this.openModalRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={sourceListData:[{type:i}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}]}}};M=s([r({selector:"awg-source-list",template:re,changeDetection:n.OnPush,standalone:!1,styles:[ae]})],M);var ce=`@if (textcriticsListData) {
    <div ngbAccordion>
...
`;var le="";var q=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.EDITION_UTILS=H,this.UTILS=a,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={textcriticsListData:[{type:i}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]}}};q=s([r({selector:"awg-textcritics-list",template:ce,changeDetection:n.OnPush,standalone:!1,styles:[le]})],q);var pe=`<!-- content: edition report -->
<div>
    <!-- modal -->
    <awg-modal #modal />

    <!-- report -->
    @if (editionReportData(); as editionReportData) {
        <div class="awg-edition-report-view" ngbAccordion>
            ...
            <div ngbAccordionItem="awg-source-list" [collapsed]="false">
                ...
                <div ngbAccordionCollapse>
                    <div ngbAccordionBody>
                        <ng-template>
                            @if (sourceListData(); as sourceListData) {
                                <awg-source-list
            ...
            <div ngbAccordionItem="awg-source-desc" [collapsed]="false">
                ...
                <div ngbAccordionCollapse>
                    <div ngbAccordionBody>
                        <ng-template>
                            @if (sourceDescriptionListData(); as sourceDescriptionListData) {
            ...
            <div ngbAccordionItem="awg-source-evaluation" [collapsed]="false">
                ...
                <div ngbAccordionCollapse>
                    <div ngbAccordionBody>
                        <ng-template>
                            @if (sourceEvaluationListData(); as sourceEvaluationListData) {
            ...
            <div ngbAccordionItem="awg-tka-panel" [collapsed]="false">
                ...
                <div ngbAccordionCollapse>
                    <div ngbAccordionBody>
                        <ng-template>
                            @if (textcriticsListData(); as textcriticsListData) {
                                <awg-textcritics-list
                                    [textcriticsListData]="textcriticsListData"
                                    (navigateToReportFragmentRequest)="onReportFragmentNavigate($event)"
                                    (openModalRequest)="onModalOpen($event)"
                                    (selectSvgSheetRequest)="onSvgSheetSelect($event)" />
                            }
...
`;var me="";var S=class{constructor(){this._editionDataService=w(B),this._editionStateService=w(W),this._router=w(N),this.errorObject=null,this.selectedEditionComplex=this._editionStateService.selectedEditionComplex,this.editionReportData=P(G(this.selectedEditionComplex).pipe(U(e=>e?this._editionDataService.getEditionReportData(e):k(null)),O(e=>(this.errorObject=e,k(void 0)))),{initialValue:null}),this.sourceListData=f(()=>{let e=this.editionReportData();return e&&e[0]?e[0]:null}),this.sourceDescriptionListData=f(()=>{let e=this.editionReportData();return e&&e[1]?e[1]:null}),this.sourceEvaluationListData=f(()=>{let e=this.editionReportData();return e&&e[2]?e[2]:null}),this.textcriticsListData=f(()=>{let e=this.editionReportData();return e&&e[3]?e[3]:null}),this.titles={sourceList:"1. Quellen\xFCbersicht",sourceDescription:"2. Quellenbeschreibung",sourceEvaluation:"3. Quellenbewertung",tka:"4. Textkritische Anmerkungen"}}onModalOpen(e){e&&this.modal.open(e)}onReportFragmentNavigate(e){let c=h.EDITION_REPORT.route,m={fragment:e?.fragmentId??""};this._navigateWithComplexId(e?.complexId,c,m)}onSvgSheetSelect(e){let c=h.EDITION_SHEETS.route,m={queryParams:{id:e?.sheetId??""}};this._navigateWithComplexId(e?.complexId,c,m)}_navigateWithComplexId(e,c,m){let g=e?`/edition/complex/${e}`:this.selectedEditionComplex()?.baseRoute??"/edition/series";this._router.navigate([g,c],m)}static{this.propDecorators={modal:[{type:F,args:["modal",{static:!0}]}]}}};S=s([r({selector:"awg-edition-report",template:pe,changeDetection:n.OnPush,standalone:!1,styles:[me]})],S);var Ae=[{path:"",component:S,data:{title:"AWG Online Edition \u2013 Report"}}],ue=[S],$=class{};$=s([d({imports:[A.forChild(Ae)],exports:[A]})],$);var de=class{};de=s([d({imports:[D,b,E,$],declarations:[q,L,M,ue]})],de);export{de as EditionReportModule};
