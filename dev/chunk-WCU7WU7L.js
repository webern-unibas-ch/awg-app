import{B as N,D as U,M as G,S as M,T as A,W as V,ca as f,na as H}from"./chunk-KVOJL3ZT.js";import{f as T,g as q}from"./chunk-CP3FWJPD.js";import"./chunk-7YSBWCTR.js";import"./chunk-BFBPMFLO.js";import{Aa as I,Ca as i,Cb as m,Ib as a,ea as O,o as r,ra as L,sb as o,ub as s}from"./chunk-SL5PEVTS.js";var W=`@if (statisticsData(); as statisticsData) {
...
`;var k=class{constructor(){this.breakdown=a.required(),this.containerClasses=a("small text-muted"),this.showEmptyBadges=a(!1),this.displayedBadges=m(()=>{let e=this.breakdown(),t=this.showEmptyBadges();return[{label:"Op",val:e.opus,type:"primary"},{label:"M",val:e.mnr,type:"secondary"},{label:"M*",val:e.mnrX,type:"info"}].filter(n=>t||n.val>0)})}static{this.propDecorators={breakdown:[{type:s,args:[{isSignal:!0,alias:"breakdown",required:!0,transform:void 0}]}],containerClasses:[{type:s,args:[{isSignal:!0,alias:"containerClasses",required:!1,transform:void 0}]}],showEmptyBadges:[{type:s,args:[{isSignal:!0,alias:"showEmptyBadges",required:!1,transform:void 0}]}]}}};k=r([o({selector:"awg-statistics-breakdown-badge",template:Z,changeDetection:i.OnPush,styles:[ee]})],k);var B=class{constructor(){this.seriesBreakdownData=a.required(),this.ROUTES={edition:f.EDITION,series:f.SERIES,section:f.SECTION}}static{this.propDecorators={seriesBreakdownData:[{type:s,args:[{isSignal:!0,alias:"seriesBreakdownData",required:!0,transform:void 0}]}]}}};B=r([o({selector:"awg-statistics-series-breakdown",template:Q,changeDetection:i.OnPush,imports:[T,q,k,p],styles:[Y]})],B);var te=`@if (summaryCards(); as summaryCards) {
