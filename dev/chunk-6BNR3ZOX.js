import{a as o,b as s}from"./chunk-6ENTRED6.js";import{b as w}from"./chunk-VFCAPNHR.js";import"./chunk-S3OI6YI5.js";import{h as f}from"./chunk-UI7TY66R.js";import{a as D,b as r}from"./chunk-SM34WE4K.js";import{Ac as m,Ca as t,Hb as i,ea as u,o as e,pc as b,ra as h,sb as a,ub as n}from"./chunk-XD7ZVAYO.js";var I=`<!-- sideinfo: contact -->
<div class="card">
...
`;var M="";var c=class{constructor(){this.embedUrl=i.required(),this.linkUrl=i.required(),this.LINK_LABEL="Gr\xF6\xDFere Karte anzeigen",this.IFRAME_SETTINGS={width:"100%",height:"350"}}static{this.propDecorators={embedUrl:[{type:n,args:[{isSignal:!0,alias:"embedUrl",required:!0,transform:void 0}]}],linkUrl:[{type:n,args:[{isSignal:!0,alias:"linkUrl",required:!0,transform:void 0}]}]}}};c=e([a({selector:"awg-contact-map",template:v,changeDetection:t.OnPush,imports:[r],styles:[M]})],c);var p=class{constructor(){this._sanitizer=u(f),this.CONTACT_SIDE_INFO_HEADER="Kontakt",this.contactMetaData=o[s.contact],this.pageMetaData=o[s.page],this.mapEmbedUrl=this._sanitizer.bypassSecurityTrustResourceUrl(m.CONTACT_MAP_UNSAFE_EMBED_URL),this.mapLinkUrl=m.CONTACT_MAP_LINK_URL}};p=e([a({selector:"awg-contact-side-info",template:I,changeDetection:t.OnPush,imports:[d,c],styles:[_]})],p);var E=`<!-- content: contact -->
...
`;var l=class{constructor(){this.CITATION_ID="awg-citation",this.CITATION_TITLE="Zitation",this.IMPRINT_ID="awg-imprint",this.IMPRINT_TITLE="Impressum",this.DOCUMENTATION_ID="awg-documentation",this.DOCUMENTATION_TITLE="Dokumentation",this.contactMetaData=o[s.contact],this.pageMetaData=o[s.page],this.today=h(Date.now()).asReadonly()}};l=e([a({selector:"awg-contact-view",template:E,changeDetection:t.OnPush,imports:[b,r,D,w],styles:[N]})],l);var Te=[{path:"",component:l,data:{title:"AWG Online Edition \u2013 Contact"}},{path:"",outlet:"side",component:p}];export{Te as CONTACT_VIEW_ROUTES};
