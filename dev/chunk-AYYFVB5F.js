import{a as f}from"./chunk-PP6HJ337.js";import{f as j}from"./chunk-WHG4UXFL.js";import"./chunk-I254P3LG.js";import{a as n,h as G,m as r,o as s}from"./chunk-OCUTK2OC.js";import{B as A,Ca as t,I as w,Oa as O,Ra as D,T as i,V as k,Z as T,h as L,k as M,tb as V,x as a}from"./chunk-VFHTK4A5.js";var P=`<!-- sideinfo: edition -->
<div class="card">
...
`;var Z="";var E,x=(E=class{constructor(e){this.editionStateService=e,this.editionViewTitle="Editions\xFCbersicht",this.editionViewId="awg-edition-view"}get editionRouteConstants(){return n}ngOnInit(){this.setupEditionView()}setupEditionView(){this.selectedEditionSeries$=this.editionStateService.getSelectedEditionSeries().pipe(a(0)),this.selectedEditionSection$=this.editionStateService.getSelectedEditionSection().pipe(a(0)),this.selectedEditionComplex$=this.editionStateService.getSelectedEditionComplex().pipe(a(0)),this.isIntroView$=this.editionStateService.getIsIntroView().pipe(a(0)),this.isPrefaceView$=this.editionStateService.getIsPrefaceView().pipe(a(0)),this.isRowTableView$=this.editionStateService.getIsRowTableView().pipe(a(0))}},E.ctorParameters=()=>[{type:s}],E);x=t([i({selector:"awg-edition-view",template:q,changeDetection:w.Default,styles:[Z]})],x);var Ce=[{path:"",outlet:"side",component:C},{path:"",component:x,children:[{path:"preface",loadChildren:()=>import("./chunk-5M6JGBGU.js").then(o=>o.EditionPrefaceModule)},{path:"row-tables",loadChildren:()=>import("./chunk-CG3FW5FB.js").then(o=>o.EditionRowTablesModule)},{path:"series",component:_},{path:"series/:id",component:R,children:[{path:"sections",component:v},{path:"section/:id",loadChildren:()=>import("./chunk-BBEEVBVO.js").then(o=>o.EditionSectionDetailModule)},{path:"sections/:id",redirectTo:"section/:id",pathMatch:"full"},{path:"",redirectTo:"sections",pathMatch:"full"}]},{path:"composition",redirectTo:"complex",pathMatch:"prefix"},{path:"complex/:complexId",component:I,children:[{path:"",component:b,children:[{path:"intro",loadChildren:()=>import("./chunk-W3IM7M5N.js").then(o=>o.EditionIntroModule)},{path:"sheets",loadChildren:()=>import("./chunk-ERQNNYCV.js").then(o=>o.EditionSheetsModule)},{path:"report",loadChildren:()=>import("./chunk-CSCAD5PS.js").then(o=>o.EditionReportModule)},{path:"graph",loadChildren:()=>import("./chunk-V7MSCOMN.js").then(o=>o.EditionGraphModule)},{path:"",redirectTo:"sheets",pathMatch:"full"}]}]}]}],X=[x,I,b,C,v,_,R],N=class{};N=t([T({imports:[D.forChild(Ce)],exports:[D]})],N);var ee=`<div class="p-3 pt-4 text-center shadow border rounded-3 awg-jumbotron">
