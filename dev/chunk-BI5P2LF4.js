import{a as M}from"./chunk-2M5RQSAZ.js";import{f as p}from"./chunk-ARBM3YIJ.js";import"./chunk-QI7ZJAEQ.js";import{a as T,i as W,l as U,o as j}from"./chunk-DOOWV3P7.js";import{A as L,Ca as o,I as r,N as t,Pa as G,Ra as O,S as A,T as a,V as n,W as i,Z as R,k,t as N,tb as D}from"./chunk-XXWOVZJP.js";var P=`<div class="awg-source-description-corrections">
...
`;var Z="";var d,w=(d=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.FIRM_SIGNS=W,this.ref=this}getWritingInstruments(e){let s=e.secondary?.join(", ");return`${s?`${e.main}; ${s}`:e.main}.`}getWritingMaterialFirmSign(e){return e&&this.FIRM_SIGNS[e]?this.FIRM_SIGNS[e]:{route:"",full:"Not a known firm sign.",short:"unknown"}}getWritingMaterialItemLocation(e){if(!this.utils.isNotEmptyObject(e)||!this.utils.isNotEmptyArray(e.folios))return"";let s=e.folios.map(l=>l.endsWith("v")||l.endsWith("r")?`${l.slice(0,-1)}<sup>${l.slice(-1)}</sup>`:l),c=s.length>1?`${s.slice(0,-1).join(", ")} und ${s.slice(-1)}`:s[0],S=e.info?`${e.info} `:"",y=e.position?` ${e.position}`:"";return`${S}auf Bl. ${c}${y}`}getWritingMaterialFormat(e){let{orientation:s,height:c,width:S}=e,y=l=>this.utils.isNotEmptyObject(l)?l.uncertainty?`${l.uncertainty} ${l.value}`:l.value:"";return`Format: ${s} ${y(c)} \xD7 ${y(S)} mm`}getWritingMaterialSystems(e){return[`${e.number} ${e.number===1?"System":"Systeme"}`,e.info&&` (${e.info})`,e.addendum&&`, ${e.addendum}`].filter(Boolean).join("")}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},d.ctorParameters=()=>[{type:p}],d.propDecorators={sourceDescriptionListData:[{type:n}],navigateToReportFragmentRequest:[{type:i}],openModalRequest:[{type:i}],selectSvgSheetRequest:[{type:i}]},d);w=o([a({selector:"awg-source-description",template:Q,changeDetection:r.OnPush,styles:[Z]})],w);var E=class{};E=o([R({imports:[D,M],declarations:[w,_,x],exports:[w]})],E);var K=`@if (sourceEvaluationListData) {
...
`;var ie="";var h,b=(h=class{constructor(e,s,c){this.editionDataService=e,this.editionStateService=s,this.router=c,this.errorObject=null,this.titles={sourceList:"1. Quellen\xFCbersicht",sourceDescription:"2. Quellenbeschreibung",sourceEvaluation:"3. Quellenbewertung",tka:"4. Textkritische Anmerkungen"}}get editionRouteConstants(){return T}ngOnInit(){this.getEditionReportData()}getEditionReportData(){this.editionReportData$=this.editionStateService.getSelectedEditionComplex().pipe(L(e=>(this.editionComplex=e,this.editionDataService.getEditionReportData(this.editionComplex))),N(e=>(this.errorObject=e,k)))}onModalOpen(e){e&&this.modal.open(e)}onReportFragmentNavigate(e){let s=this.editionRouteConstants.EDITION_REPORT.route,c={fragment:e?.fragmentId??""};this._navigateWithComplexId(e?.complexId,s,c)}onSvgSheetSelect(e){let s=this.editionRouteConstants.EDITION_SHEETS.route,c={queryParams:{id:e?.sheetId??""}};this._navigateWithComplexId(e?.complexId,s,c)}_navigateWithComplexId(e,s,c){let S=e?`/edition/complex/${e}/`:this.editionComplex.baseRoute;this.router.navigate([S,s],c)}},h.ctorParameters=()=>[{type:U},{type:j},{type:G}],h.propDecorators={modal:[{type:A,args:["modal",{static:!0}]}]},h);b=o([a({selector:"awg-edition-report",template:te,changeDetection:r.OnPush,styles:[ie]})],b);var Se=[{path:"",component:b,data:{title:"AWG Online Edition \u2013 Report"}}],oe=[b],I=class{};I=o([R({imports:[O.forChild(Se)],exports:[O]})],I);var se=class{};se=o([R({imports:[D,M,E,I],declarations:[$,q,C,oe]})],se);export{se as EditionReportModule};
