import{a as V,b as j}from"./chunk-B6FUZHXW.js";import{a as y}from"./chunk-GYSG6DRK.js";import{f as k,p as L}from"./chunk-UTFCXFBN.js";import{D as c,J as M,O as a,R as n}from"./chunk-EVFLTVEZ.js";import{c as b,f as D,i as R}from"./chunk-GMAYQNSO.js";import"./chunk-SPQM6XLJ.js";import"./chunk-3M2JVDVZ.js";import"./chunk-CENFHFVV.js";import{Ua as o,W as T,Wa as x,Za as g,bb as N,da as i,k as w,na as O,o as t,xa as f}from"./chunk-3CKLVO73.js";var A=`<!-- sideinfo: edition -->
<div class="card">
...
`;var G="";var m=class{constructor(){this._editionStateService=i(n),this.EDITION_INFO_HEADER="Edition",this.generalEditionLinks=j,this.selectedEditionSection=this._editionStateService.selectedEditionSection,this.sectionsData=O(V.map(r=>a.getEditionSectionById(r.seriesId,r.sectionId))).asReadonly()}};m=t([o({selector:"awg-edition-info",template:A,imports:[k,D],styles:[G]})],m);var U=`<div class="p-3 pt-4 text-center shadow border rounded-3 awg-jumbotron">
    <h3 [id]="jumbotronId" [innerHTML]="jumbotronTitle"></h3>
</div>
`;var B="";var C=class{static{this.propDecorators={jumbotronId:[{type:x}],jumbotronTitle:[{type:x}]}}};C=t([o({selector:"awg-edition-jumbotron",template:U,changeDetection:f.OnPush,standalone:!1,styles:[B]})],C);var W=`<!--
...
<!-- edition routes -->
<router-outlet />
`;var P="";var p=class{constructor(){this._editionStateService=i(n),this._route=i(b),this.selectedEditionComplex=this._editionStateService.selectedEditionComplex}get editionRouteConstants(){return c}ngOnInit(){this.updateEditionComplexFromRoute()}updateEditionComplexFromRoute(){this._route.paramMap.subscribe(r=>{let s=r.get("complexId")||"",d=M.getEditionComplexById(s);if(y.isEmptyObject(d))this._editionStateService.updateSelectedEditionSeries(null);else{let l=a.getEditionSeriesById(d.pubStatement.series.route),te=a.getEditionSectionById(d.pubStatement.series.route,d.pubStatement.section.route);this._editionStateService.updateSelectedEditionSeries(l),this._editionStateService.updateSelectedEditionSection(te),this._editionStateService.updateSelectedEditionComplex(d)}})}ngOnDestroy(){this._editionStateService.updateSelectedEditionSeries(null)}};p=t([o({selector:"awg-edition-complex",template:W,standalone:!1,styles:[P]})],p);var H=`@if (editionRouterLinkButtons(); as linkButtons) {
    <awg-router-link-button-group [routerLinkButtons]="linkButtons" [queryParamsHandling]="''" />
}

<router-outlet />
`;var z="";var I=class{constructor(r,s,d,l){this.root=r,this.link=s,this.label=d,this.disabled=l}};var u=class{constructor(){this._editionStateService=i(n),this.selectedEditionComplex=this._editionStateService.selectedEditionComplex,this.editionRouterLinkButtons=N(()=>{let r=this.selectedEditionComplex();if(!r)return null;let s=c;return[s.EDITION_INTRO,s.EDITION_SHEETS,s.EDITION_REPORT,s.EDITION_GRAPH].map(l=>new I(r.baseRoute,l.route,l.short,!1))})}};u=t([o({selector:"awg-edition-detail-nav",template:H,standalone:!1,styles:[z]})],u);var $=`@if (editionOutline) {
...
`;var F="";var h=class{constructor(){this._editionStateService=i(n),this.editionOutline=a.getEditionOutline(),this._editionStateService.updateSelectedEditionSeries(null)}static{this.ctorParameters=()=>[]}};h=t([o({selector:"awg-edition-series",template:$,standalone:!1,styles:[F]})],h);var J=`<router-outlet />
`;var K="";var E=class{constructor(){this._editionStateService=i(n),this._route=i(b),this._destroyed$=new w}ngOnInit(){this.updateSeriesFromRoute()}updateSeriesFromRoute(){this._route.paramMap.pipe(T(this._destroyed$)).subscribe({next:r=>{let s=r.get("id"),d=a.getEditionSeriesById(s);this._editionStateService.updateSelectedEditionSeries(d)}})}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}};E=t([o({selector:"awg-edition-series-detail",template:J,standalone:!1,styles:[K]})],E);var Q=`@if (selectedSeries(); as selectedSeries) {
...
`;var S=class{constructor(){this._editionStateService=i(n),this.selectedSeries=this._editionStateService.selectedEditionSeries}};S=t([o({selector:"awg-edition-sections",template:Q,standalone:!1,styles:[q]})],S);var Z=`<!-- content: edition-view -->
...
`;var X="";var _=class{constructor(){this._editionStateService=i(n),this.EDITION_VIEW_ID="awg-edition-view",this.EDITION_VIEW_TITLE="Editions\xFCbersicht",this.isIntroView=this._editionStateService.isIntroView,this.isPrefaceView=this._editionStateService.isPrefaceView,this.isRowTableView=this._editionStateService.isRowTableView,this.selectedEditionComplex=this._editionStateService.selectedEditionComplex,this.selectedEditionSection=this._editionStateService.selectedEditionSection,this.selectedEditionSeries=this._editionStateService.selectedEditionSeries}get editionRouteConstants(){return c}};_=t([o({selector:"awg-edition-view",template:Z,changeDetection:f.Eager,standalone:!1,styles:[X]})],_);var fe=[{path:"",outlet:"side",component:m},{path:"",component:_,children:[{path:"preface",loadChildren:()=>import("./chunk-OTZ7JU22.js").then(e=>e.EditionPrefaceModule)},{path:"row-tables",loadChildren:()=>import("./chunk-N7MTCH2P.js").then(e=>e.EditionRowTablesModule)},{path:"series",component:h},{path:"series/:id",component:E,children:[{path:"sections",component:S},{path:"section/:sectionId",loadChildren:()=>import("./chunk-KVI2R7VC.js").then(e=>e.EditionSectionDetailModule)},{path:"sections/:sectionId",redirectTo:"section/:sectionId",pathMatch:"full"},{path:"",redirectTo:"sections",pathMatch:"full"}]},{path:"composition",redirectTo:"complex",pathMatch:"prefix"},{path:"complex/:complexId",component:p,children:[{path:"",component:u,children:[{path:"intro",loadChildren:()=>import("./chunk-TSIMH2TO.js").then(e=>e.EditionIntroModule)},{path:"sheets",loadChildren:()=>import("./chunk-ZHJTS6V2.js").then(e=>e.EditionSheetsModule)},{path:"report",loadChildren:()=>import("./chunk-C2HFE2IH.js").then(e=>e.EditionReportModule)},{path:"graph",loadChildren:()=>import("./chunk-MRUDEK7T.js").then(e=>e.EditionGraphModule)},{path:"",redirectTo:"sheets",pathMatch:"full"}]}]}]}],Y=[_,p,u,S,h,E],v=class{};v=t([g({imports:[R.forChild(fe)],exports:[R]})],v);var ee=class{};ee=t([g({imports:[L,v,m],declarations:[Y,C]})],ee);export{ee as EditionViewModule};
