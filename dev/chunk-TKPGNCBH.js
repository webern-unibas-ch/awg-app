import{a as W}from"./chunk-YBCPIWVM.js";import{a as Oe,e as Ie}from"./chunk-M2HWHSMI.js";import{A as V,Ab as ye,Bb as b,Cb as we,D as g,Db as Ce,Ea as ve,Eb as be,Fa as pe,Fb as ke,H as he,Ha as ee,I as v,Jb as xe,M as n,Mb as Re,Nb as Ee,O as h,Pa as Se,Q as l,R as a,S as ce,T as p,Ub as te,Wa as ue,Xb as Te,Ya as me,Z as m,a as ie,aa as ge,ab as fe,b as oe,cc as Le,f as re,h as I,i as ne,j as r,jb as C,kc as S,o as ae,s as le,t as de,y as J,z,zb as _e}from"./chunk-WR7QTV56.js";var De=`<div class="awg-edition-svg-sheet-footer mt-4">
...
`;var Ae="";var f,D=(f=class{constructor(){this.navigateToReportFragmentRequest=new n,this.openModalRequest=new n,this.selectSvgSheetRequest=new n,this.faChevronRight=Se,this.faChevronDown=ue,this.showEvaluation=!1,this.UTILS=g(C),this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleEvaluation(){this.showEvaluation=!this.showEvaluation}},f.ctorParameters=()=>[],f.propDecorators={selectedTextcriticalCommentary:[{type:l}],selectedTextcritics:[{type:l}],showTkA:[{type:l}],navigateToReportFragmentRequest:[{type:a}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]},f);D=r([h({selector:"awg-edition-svg-sheet-footer",template:De,changeDetection:v.OnPush,standalone:!1,styles:[Ae]})],D);var H=class{};H=r([p({imports:[S,W],declarations:[D],exports:[D]})],H);var qe=`<h6 class="card-title">
    {{ navItemLabel }}:
...
`;var Ge=`a#dropDownSheetNav.btn{border:none!important}a#dropDownSheetNav.active,a#dropDownSheetNav:active{color:#149b9e!important}a#dropDownSheetNav:hover{color:#333!important}a#dropDownSheetNav>span{display:inline-block;white-space:break-spaces;text-align:start}
`;var k,A=(k=class{constructor(){this.selectSvgSheetRequest=new n,this.UTILS=g(C)}isSelectedSvgSheet(e,t){let s=e,i=this.selectedSvgSheet?.id;return t&&this.selectedSvgSheet?.content?.[0]?.partial&&(s+=t,i+=this.selectedSvgSheet.content[0].partial),s===i}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},k.propDecorators={navItemLabel:[{type:l}],svgSheets:[{type:l}],selectedSvgSheet:[{type:l}],selectSvgSheetRequest:[{type:a}]},k);A=r([h({selector:"awg-edition-svg-sheet-nav-item",template:qe,changeDetection:v.OnPush,standalone:!1,styles:[Ge]})],A);var Me=`@if (svgSheetsData) {
...
`;var Fe="";var x,q=(x=class{constructor(){this.selectSvgSheetRequest=new n}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},x.propDecorators={svgSheetsData:[{type:l}],selectedSvgSheet:[{type:l}],selectSvgSheetRequest:[{type:a}]},x);q=r([h({selector:"awg-edition-svg-sheet-nav",template:Me,changeDetection:v.OnPush,standalone:!1,styles:[Fe]})],q);var U=class{};U=r([p({imports:[S],declarations:[q,A],exports:[q,A]})],U);var Ne=`<div class="awg-edition-svg-sheet-viewer-nav">
...
`;var R,G=(R=class{constructor(){this.browseSvgSheetRequest=new n}browseSvgSheet(e){e&&this.browseSvgSheetRequest.emit(e)}},R.propDecorators={browseSvgSheetRequest:[{type:a}]},R);G=r([h({selector:"awg-edition-svg-sheet-viewer-nav",template:Ne,changeDetection:v.OnPush,standalone:!1,styles:[$e]})],G);var Be=`<div class="card awg-edition-svg-sheet-viewer-settings float-none my-2">
...
`;var _,F=(_=class{constructor(){this.browseSvgSheetRequest=new n,this.selectLinkBoxRequest=new n,this.selectOverlaysRequest=new n,this.faCompressArrowsAlt=me,this.hasAvailableTkaOverlays=!1,this.sliderConfig=new Oe(1,.1,10,.01,1),this.suppliedClasses=new Map,this.svgSheetFilePath="",this._availableTkaOverlays=[],this._selectedTkaOverlays=[],this._isRendered=!1,this._destroyed$=new I,this._resize$=new I,this._cdr=g(ge),this._svgDrawingService=g(Te),this.ref=this}onResize(){!this.svgSheetSelection||!this.svgSheetRootGroupSelection||(this._getContainerDimensions(this.svgSheetContainerRef),this._resize$.next(!0))}ngOnChanges(e){e.selectedSvgSheet&&this._isRendered&&this.renderSheet()}ngAfterViewInit(){this._resize$.pipe(de(150),z(this._destroyed$)).subscribe(()=>{this.renderSheet()}),this.renderSheet(),this._isRendered=!0}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}browseSvgSheet(e){e&&this.browseSvgSheetRequest.emit(e)}onSuppliedClassesOpacityToggle(e){let{className:t,isCurrentlyVisible:s}=e;this._svgDrawingService.toggleSuppliedClassOpacity(this.svgSheetRootGroupSelection,t,s)}onTkkClassesHighlightToggle(e){let t="tkk";this._svgDrawingService.getGroupsBySelector(this.svgSheetRootGroupSelection,t).nodes().forEach(i=>{let[o,d]=this._getOverlayAndSelection(i.id,t),c=e?b.fill:b.transparent;this._svgDrawingService.updateTkkOverlayColor(o,d,c)})}onZoomChange(e){this.sliderConfig.value=e,this._rescaleZoom()}renderSheet(){this._clearSvg(),this._availableTkaOverlays=[],this._selectedTkaOverlays=[],this.svgSheetFilePath=this.selectedSvgSheet?.content?.[0].svg,this.svgSheetFilePath&&this._createSvg().then(()=>{this.resetZoom(),this._createSvgOverlays(),this._cdr.detectChanges()})}resetZoom(){!this.svgSheetSelection||!this.sliderConfig||(this.onZoomChange(this.sliderConfig.initial),this._resetZoomTranslation())}_clearSvg(){this.svgSheetRootGroupSelection?.selectAll("*").remove(),this.svgSheetSelection?.selectAll("*").remove()}_createSvg(){return re(this,null,function*(){if(!this.svgSheetContainerRef){console.warn("No svg sheet container ref");return}this.svgSheetSelection=yield this._svgDrawingService.createSvg(this.svgSheetFilePath,this.svgSheetElementRef?.nativeElement,this.svgSheetRootGroupRef?.nativeElement),this.svgSheetRootGroupSelection=this.svgSheetSelection.select("#awg-edition-svg-sheet-root-group"),this._getContainerDimensions(this.svgSheetContainerRef),this._zoomHandler(this.svgSheetRootGroupSelection,this.svgSheetSelection)})}_createSvgOverlays(){this.svgSheetRootGroupSelection&&(this._createOverlays("link-box",this._createLinkBoxOverlay.bind(this)),this._createOverlays("tkk",this._createTkaOverlay.bind(this)),this.hasAvailableTkaOverlays=!!this._availableTkaOverlays&&this._availableTkaOverlays.length>0,this._getSuppliedClasses())}_createOverlays(e,t){let s=this._svgDrawingService.getGroupsBySelector(this.svgSheetRootGroupSelection,e);s&&s.nodes().forEach(i=>{t(i,e)})}_createLinkBoxOverlay(e){let t=e.id,s=this._svgDrawingService.getD3SelectionById(this.svgSheetRootGroupSelection,t),i=s.select("path");i.style("fill",this._svgDrawingService.linkBoxFillColor),s.on("mouseover",()=>{let o=this._svgDrawingService.linkBoxHoverFillColor;this._svgDrawingService.fillD3SelectionWithColor(i,o),s.style("cursor","pointer")}).on("mouseout",()=>{let o=this._svgDrawingService.linkBoxFillColor;this._svgDrawingService.fillD3SelectionWithColor(i,o)}).on("click",()=>{this._onLinkBoxSelect(t)})}_createTkaOverlay(e,t){let s=e.id,i=e.getBBox();this._availableTkaOverlays.push(new we(ye.tka,s,!1));let o=this._svgDrawingService.createOverlayGroup(this.svgSheetRootGroupSelection,s,i,t),[d,c]=this._getOverlayAndSelection(s,t);o.on("mouseover",()=>{this._svgDrawingService.updateTkkOverlayColor(d,c,b.hover),c.style("cursor","pointer")}).on("mouseout",()=>{this._svgDrawingService.updateTkkOverlayColor(d,c,b.fill)}).on("click",()=>{d&&(d.isSelected=!d.isSelected),this._svgDrawingService.updateTkkOverlayColor(d,c,b.hover),this._selectedTkaOverlays=this._getSelectedOverlays(this._availableTkaOverlays),this._onOverlaySelect(this._selectedTkaOverlays)})}_getContainerDimensions(e){let t=this._svgDrawingService.getContainerDimensions(e);this._divWidth=this._divWidth?this._divWidth:t.width,this._divHeight=this._divHeight?this._divHeight:t.height}_getOverlayById(e,t){return e.find(s=>s.id===t)}_getOverlayAndSelection(e,t){let s=this._getOverlayById(this._availableTkaOverlays,e),i=this._svgDrawingService.getOverlayGroupRectSelection(this.svgSheetRootGroupSelection,e,t);return[s,i]}_getSelectedOverlays(e){return e.filter(t=>t.isSelected)}_getSuppliedClasses(){this.suppliedClasses=this._svgDrawingService.getSuppliedClasses(this.svgSheetRootGroupSelection)}_onLinkBoxSelect(e){e&&this.selectLinkBoxRequest.emit(e)}_onOverlaySelect(e){e&&this.selectOverlaysRequest.emit(e)}_rescaleZoom(){!this.svgSheetSelection||!this.sliderConfig.value||this._zoomBehaviour.scaleTo(this.svgSheetSelection,this.sliderConfig.value)}_resetZoomTranslation(){!this.svgSheetSelection||!this.svgSheetRootGroupSelection||this.svgSheetRootGroupSelection.attr("transform","translate(0,0)")}_roundToScaleStepDecimalPrecision(e){let t=this.sliderConfig.stepSize;return((o,d)=>+(Math.round(+(o+"e"+d))+"e-"+d))(e,(o=>Math.floor(o)===o?0:o.toString().split(".")[1].length)(t))}_zoomHandler(e,t){let s=i=>{let o=i.transform,d=this._roundToScaleStepDecimalPrecision(o.k);e.attr("transform",o),this.sliderInput?.nativeElement&&(this.sliderInput.nativeElement.value=d,this.sliderConfig.value=d),this.sliderInputLabel?.nativeElement&&(this.sliderInputLabel.nativeElement.innerText=d+"x")};this._zoomBehaviour=Ie().scaleExtent([this.sliderConfig.min,this.sliderConfig.max]).on("zoom",s),t.call(this._zoomBehaviour)}},_.ctorParameters=()=>[],_.propDecorators={svgSheetContainerRef:[{type:m,args:["svgSheetContainer"]}],svgSheetElementRef:[{type:m,args:["svgSheetElement"]}],svgSheetRootGroupRef:[{type:m,args:["svgSheetRootGroup"]}],sliderInput:[{type:m,args:["sliderInput"]}],sliderInputLabel:[{type:m,args:["sliderInputLabel"]}],selectedSvgSheet:[{type:l}],browseSvgSheetRequest:[{type:a}],selectLinkBoxRequest:[{type:a}],selectOverlaysRequest:[{type:a}],onResize:[{type:ce,args:["window:resize"]}]},_);F=r([h({selector:"awg-edition-svg-sheet-viewer",template:ze,standalone:!1,styles:[Ve]})],F);var j=class{};j=r([p({imports:[S,W],declarations:[F,G,M],exports:[F,G,M]})],j);var We=`<div ngbAccordion #accoladeAcc [class.fullscreen]="isFullscreen">
...
`;var je="";var L,$=(L=class{constructor(){this.openModalRequest=new n,this.selectSvgSheetRequest=new n,this.faSquare=fe,this.folioLegends=[{color:"olivedrab",label:"aktuell ausgew\xE4hlt"},{color:"orange",label:"ausw\xE4hlbar"},{color:"grey",label:"(momentan noch) nicht ausw\xE4hlbar"}]}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},L.propDecorators={selectedConvolute:[{type:l}],selectedSvgSheet:[{type:l}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]},L);$=r([h({selector:"awg-edition-convolute",template:Ue,changeDetection:v.OnPush,standalone:!1,styles:[je]})],$);var Ze=`<!-- embedded svg: Edition Folio Viewer -->
...
`;var Ye=`.svgGrid{margin-bottom:2em}.svgRow{padding-top:1em;width:inherit;text-align:center;box-shadow:5px 5px 6px #ccc;border:1px solid #eeeeee}.svgCol{display:inline-block}
`;var Y=class{constructor(){this._bgColor="#a3a3a3",this._disabledColor="grey",this._fgColor="orange",this._contentSegmentFillColor="#eeeeee",this._contentSegmentFontFamily="Source Sans Pro, source-sans-pro, sans-serif",this._contentSegmentFontSize="11px",this._contentSegmentOffsetCorrection=4,this._contentSegmentStrokeWidth=2,this._defaultNumberOfSystems=18,this._reversedRotationAngle=180,this._sheetFillColor="white",this._sheetStrokeWidth=1,this._systemsLineStrokeWidth=.7}getFolioSvgData(e,t){let s=new Ce(e,t,this._contentSegmentOffsetCorrection);return new be(s)}addViewBoxToSvgCanvas(e,t){e.attr("viewBox",t.viewBox).attr("width",t.svgWidth).attr("height",t.svgHeight).attr("version","1.1").attr("xmlns","https://www.w3.org/2000/svg").attr("xlink","https://www.w3.org/1999/xlink").attr("preserveAspectRatio","xMinYMin meet")}addFolioToSvgCanvas(e,t,s){this.ref=s;let i=this._appendCanvasSheetGroup(e,t.sheet.folioId);this._addFolioSheetToSvgCanvas(i,t),this._addFolioSystemsToSvgCanvas(i,t),this._addFolioContentSegmentsToSvgCanvas(i,t)}_addFolioSheetToSvgCanvas(e,t){let{sheet:s}=t,{folioId:i,sheetRectangle:o,trademarkRectangle:d}=s;this._appendSheetGroupSheetTitle(e,i),this._appendSheetGroupSheetRectangle(e,o),d&&this._appendSheetGroupTrademark(e,d,i,t.systems.systemsReversed)}_addFolioSystemsToSvgCanvas(e,t){t.systems.systemsLines.forEach((s,i)=>{let o=t.systems.systemsReversed?t.systems.systemsLines.length-i:i+1,d=t.systems.systemsLabelPositions[i],c=this._appendSvgElementWithAttrs(e,"g",{systemsGroupId:o,class:"systems-group"}),w=this._appendSvgElementWithAttrs(c,"g",{systemLineGroupId:o,class:"system-line-group"});this._appendSystemsGroupLabel(c,d,o),this._appendSystemsGroupLines(w,s)})}_addFolioContentSegmentsToSvgCanvas(e,t){t?.contentSegments?.forEach(s=>{if(!s)return;let i=this._appendContentSegmentGroup(e,s),o=this._appendContentSegmentLink(i);this._appendContentSegmentLinkPolygon(o,s.segmentVertices,t.systems.systemsLines.length),this._appendContentSegmentLinkLabel(o,s)})}_appendCanvasSheetGroup(e,t){return this._appendSvgElementWithAttrs(e,"g",{sheetGroupId:t,class:"sheet-group"})}_appendContentSegmentGroup(e,t){let s=this._appendContentSegmentGroupElement(e,t);return this._appendContentSegmentGroupTitle(s,t),s.on("click",()=>t.selectable?this.ref.selectSvgSheet({complexId:t.complexId,sheetId:t.sheetId}):this.ref.openModal(t.linkTo)),s}_appendContentSegmentGroupElement(e,t){return this._appendSvgElementWithAttrs(e,"g",{contentSegmentGroupId:t.segmentLabel,contentSegmentId:t.sheetId,class:"content-segment-group",stroke:t.selectable?this._fgColor:this._disabledColor,fill:t.selectable?this._fgColor:this._disabledColor})}_appendContentSegmentGroupTitle(e,t){return this._appendSvgElementWithAttrs(e,"title",{}).text(t.segmentLabel)}_appendContentSegmentLink(e){return this._appendSvgElementWithAttrs(e,"a",{class:"content-segment-link"})}_appendContentSegmentLinkLabel(e,t){let s=this._appendContentSegmentLinkLabelTextElement(e,t.centeredXPosition,t.centeredYPosition);return this._appendContentSegmentLinkLabelTspanElements(s,t),t.segmentReversed&&s.attr("transform",`rotate(${this._reversedRotationAngle}, ${t.centeredXPosition}, ${t.centeredYPosition})`),s}_appendContentSegmentLinkLabelTextElement(e,t,s){let i={class:"content-segment-label",x:t,y:s};return i["font-family"]=this._contentSegmentFontFamily,i["dominant-baseline"]="middle",i["text-anchor"]="middle",this._appendSvgElementWithAttrs(e,"text",i).style("font-size",this._contentSegmentFontSize)}_appendContentSegmentLinkLabelTspanElements(e,t){t.segmentLabelArray.forEach((s,i)=>{if(s!==""){let o={};i>0&&(o.x=t.centeredXPosition,o.y=t.centeredYPosition,o.dy="1.2em",o["text-anchor"]="middle"),this._appendSvgElementWithAttrs(e,"tspan",o).text(s)}})}_appendContentSegmentLinkPolygon(e,t,s=this._defaultNumberOfSystems){let i=this._contentSegmentStrokeWidth*(this._defaultNumberOfSystems/s),o={class:"content-segment-shape",points:t,fill:this._contentSegmentFillColor};return o["stroke-width"]=i,this._appendSvgElementWithAttrs(e,"polygon",o)}_appendSheetGroupSheetRectangle(e,t){let{x:s,y:i}=t.UPPER_LEFT_CORNER,{x:o,y:d}=t.LOWER_RIGHT_CORNER,c={x:s,y:i,width:o-s,height:d-i,fill:this._sheetFillColor,stroke:this._bgColor};return c["stroke-width"]=this._sheetStrokeWidth,this._appendSvgElementWithAttrs(e,"rect",c)}_appendSheetGroupSheetTitle(e,t){this._appendSvgElementWithAttrs(e,"title",{class:"sheet-group-title"}).text(`Bl. ${t}`)}_appendSheetGroupTrademark(e,t,s,i){let o=this._appendSheetGroupTrademarkGroup(e,s);this._appendSheetGroupTrademarkRectangle(o,t),this._appendSheetGroupTrademarkSymbol(o,t,i),this._appendSheetGroupTrademarkTitle(o)}_appendSheetGroupTrademarkGroup(e,t){return this._appendSvgElementWithAttrs(e,"g",{trademarkGroupId:t,class:"trademark-group"})}_appendSheetGroupTrademarkRectangle(e,t){let{x:s,y:i}=t.UPPER_LEFT_CORNER,{x:o,y:d}=t.LOWER_RIGHT_CORNER,c={class:"trademark-rectangle",x:s,y:i,width:o-s,height:d-i,fill:this._sheetFillColor,stroke:this._bgColor};return c["stroke-width"]=this._sheetStrokeWidth,this._appendSvgElementWithAttrs(e,"rect",c)}_appendSheetGroupTrademarkSymbol(e,t,s){let{x:i,y:o}=t.UPPER_LEFT_CORNER,{x:d,y:c}=t.LOWER_RIGHT_CORNER,w=(i+d)/2,et=(o+c)/2,se={class:"trademark-symbol",d:"M 10 39 Q 12 36 14 39 T 18 39 Q 20 36 22 39 T 26 39 Q 28 36 30 39 T 34 39 M 10 43 T 34 43 M 14 31 L 15 30 L 17 30 L 15 26 L 17 23 L 22 23 L 18 31 L 14 31 M 20 31 L 21 30 L 23 30 L 21 26 L 22 23 L 27 23 L 24 31 L 20 31 M 14 17 L 18 15 L 21 14 L 22 15 L 21 17 L 18 17 L 14 19 M 13 15 L 14 17 L 14 19 L 13 19 L 13 19 L 12 19 L 13 18 L 12 18 L 13 17 L 12 17 L 13 15 M 17 23 L 20 20 L 21 17 L 22 15 L 25 15 L 27 23 M 26 24 L 30 20 L 30 17 L 29 18 L 28 18 L 28 17 L 30 15 L 31 17 L 31 21 L 26 25 M 25 15 L 27 14 L 26 13 L 27 12 L 26 11 L 27 10 L 26 9 L 27 8 L 26 7 L 25 8 L 24 7 L 23 8 L 22 7 L 21 8 L 20 7 L 19 8 L 18 9 L 19 9 L 21 10 L 18 11 L 20 12 L 18 13 L 21 14 L 22 15",fill:this._disabledColor,stroke:this._disabledColor,transform:`translate(${w-10}, ${et-10}) scale(0.5)${s?` rotate(${this._reversedRotationAngle}, 20, 20)`:""}`};return se["stroke-width"]=this._contentSegmentStrokeWidth,this._appendSvgElementWithAttrs(e,"path",se)}_appendSheetGroupTrademarkTitle(e){this._appendSvgElementWithAttrs(e,"title",{class:"trademark-title"}).text("Firmenzeichen")}_appendSystemsGroupLabel(e,t,s){let i={class:"system-label",x:t.x,y:t.y,fill:this._bgColor};i["dominant-baseline"]="hanging",this._appendSvgElementWithAttrs(e,"text",i).text(s)}_appendSystemsGroupLines(e,t){t.forEach(s=>{let{x:i,y:o}=s.START_POINT,{x:d,y:c}=s.END_POINT,w={class:"system-line",x1:i,y1:o,x2:d,y2:c,stroke:this._bgColor};w["stroke-width"]=this._systemsLineStrokeWidth,this._appendSvgElementWithAttrs(e,"line",w)})}_appendSvgElementWithAttrs(e,t,s){let i=e.append(t);return Object.keys(s).forEach(o=>{i.attr(o,s[o])}),i}};Y=r([he({providedIn:"root"})],Y);var y,B=(y=class{constructor(){this.openModalRequest=new n,this.selectSvgSheetRequest=new n,this.canvasArray=[],this.folioSvgDataArray=[],this.viewBoxArray=[],this._folioSettings={factor:1.5,formatX:175,formatY:270,initialOffsetX:5,initialOffsetY:5,numberOfFolios:0},this._folioService=g(Y),this.ref=this}ngOnChanges(e){e.selectedConvolute&&this.prepareFolioSvgOutput()}ngAfterViewChecked(){this.createSVGCanvas()}createSVGCanvas(){this.canvasArray=[],this.viewBoxArray.length===this.folioSvgDataArray.length&&(this.folioSvgDataArray.forEach((e,t)=>{let s=`#folio-${this.selectedSvgSheet.id}-${e.sheet.folioId}`,i=this._d3Select(s);i.empty()||(i.selectAll("*").remove(),this._folioService.addViewBoxToSvgCanvas(i,this.viewBoxArray[t]),this._folioService.addFolioToSvgCanvas(i,e,this.ref),this.canvasArray.push(i))}),this.toggleActiveClass())}isSelectedSvgSheet(e){let t=this.selectedSvgSheet?.content[0]?.partial||"";return e===`${this.selectedSvgSheet?.id}${t}`}openModal(e){e&&this.openModalRequest.emit(e)}prepareFolioSvgOutput(){this.folioSvgDataArray=[],this.viewBoxArray=[],this.selectedConvolute?.folios&&(this.folioSvgDataArray=this.selectedConvolute.folios.map(e=>{let t=oe(ie({},this._folioSettings),{formatX:+e.dimensions.width,formatY:+e.dimensions.height,numberOfFolios:this.selectedConvolute.folios.length}),s=this._calculateViewBoxDimension(t,"X"),i=this._calculateViewBoxDimension(t,"Y");return this.viewBoxArray.push(new ke(s,i)),this._folioService.getFolioSvgData(t,e)}))}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleActiveClass(){this.canvasArray&&this.canvasArray.forEach(e=>{e.selectAll(".content-segment-group").classed("active",(t,s,i)=>{let o=te(i[s]).attr("contentSegmentId");return this.isSelectedSvgSheet(o)})})}_calculateViewBoxDimension(e,t){let s=`format${t}`,i=`initialOffset${t}`;return(e[s]+2*e[i])*e.factor}_d3Select(e){return te(e)}},y.ctorParameters=()=>[],y.propDecorators={selectedConvolute:[{type:l}],selectedSvgSheet:[{type:l}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]},y);B=r([h({selector:"awg-edition-folio-viewer",template:Ze,changeDetection:v.OnPush,standalone:!1,styles:[Ye]})],B);var Q=class{};Q=r([p({imports:[S],declarations:[B],exports:[B]})],Q);var X=class{};X=r([p({imports:[S,Q],declarations:[$],exports:[$]})],X);var Qe=`<!-- content: edition detail -->
<div>
    <!-- modal -->
...
`;var Xe="";var O,P=(O=class{constructor(){this.errorObject=null,this.isFullscreen=!1,this.showTkA=!1,this._isFirstPageLoad=!0,this._destroyed$=new I,this._editionDataService=g(xe),this._editionSheetsService=g(Re),this._editionStateService=g(Ee),this._loadingService=g(Le),this._route=g(ve),this._router=g(pe),this._utils=g(C)}get editionRouteConstants(){return _e}get isLoading$(){return this._loadingService.getLoadingStatus()}ngOnInit(){this.getEditionSheetsData()}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}getEditionSheetsData(){this.errorObject=null,this.snapshotQueryParamsId=this._route.snapshot.queryParamMap.get("id"),ae([this._route.paramMap,this._route.queryParamMap]).pipe(J(([,e])=>this._fetchEditionComplexData(e)),le(e=>(this.errorObject=e,ne)),z(this._destroyed$)).subscribe()}onBrowseSvgSheet(e){let t=this._editionSheetsService.getCurrentEditionType(this.selectedSvgSheet,this.svgSheetsData.sheets);if(!t)return;let s=this.svgSheetsData.sheets[t],i=this._editionSheetsService.getNextSheetId(e,this.selectedSvgSheet,s);this.onSvgSheetSelect({complexId:"",sheetId:i})}onFullscreenToggle(e){this.isFullscreen=e}onLinkBoxSelect(e){if(!this.selectedSvgSheet||!this.selectedTextcritics?.linkBoxes)return;let t=this.selectedTextcritics.linkBoxes.find(s=>s.svgGroupId===e);if(t){let s=t.linkTo;this.onSvgSheetSelect(s)}}onOverlaySelect(e){this.selectedTextcriticalCommentary=this._editionSheetsService.filterTextcriticalCommentaryForOverlays(this.selectedTextcritics.commentary,e),this.showTkA=this._utils.isNotEmptyArray(this.selectedTextcriticalCommentary.comments)}onReportFragmentNavigate(e){let t=this.editionRouteConstants.EDITION_REPORT.route,s={fragment:e?.fragmentId??""};this._navigateWithComplexId(e?.complexId,t,s)}onSvgSheetSelect(e){let t=this.editionRouteConstants.EDITION_SHEETS.route,s={queryParams:{id:e?.sheetId??""},queryParamsHandling:"merge"};this._navigateWithComplexId(e?.complexId,t,s)}_assignData(e){this.folioConvoluteData=e[0],this.svgSheetsData=e[1],this.textcriticsData=e[2]}_fetchEditionComplexData(e){return this._editionStateService.getSelectedEditionComplex().pipe(V(t=>this.editionComplex=t),J(t=>this._editionDataService.getEditionSheetsData(t)),V(t=>this._assignData(t)),V(()=>this._handleQueryParams(e)))}_getDefaultSheetId(){let e=this.svgSheetsData?.sheets,t=e?.textEditions?.[0]||e?.sketchEditions?.[0],s=t?.content?.[0]?.partial??"";return(t?.id||"")+s}_handleQueryParams(e){let t=e?.get("id");t&&this.svgSheetsData?this._selectSvgSheet(t):(t=this._isFirstPageLoad&&this.snapshotQueryParamsId?this.snapshotQueryParamsId:this._getDefaultSheetId(),t===""&&(this.selectedSvgSheet=void 0),this.onSvgSheetSelect({complexId:"",sheetId:t})),this._isFirstPageLoad=!1}_navigateWithComplexId(e,t,s){let i=e?`/edition/complex/${e}/`:this.editionComplex.baseRoute;this._router.navigate([i,t],s)}_selectSvgSheet(e){e&&(this.selectedSvgSheet=this._editionSheetsService.selectSvgSheetById(this.svgSheetsData.sheets,e),this.selectedConvolute=this._editionSheetsService.selectConvolute(this.folioConvoluteData.convolutes,this.svgSheetsData.sheets,this.selectedSvgSheet),this.selectedTextcritics=this._editionSheetsService.findTextcritics(this.textcriticsData.textcritics,this.selectedSvgSheet),this.onOverlaySelect([]),this._utils.isNotEmptyObject(this.selectedTextcritics)&&this._utils.isNotEmptyObject(this.selectedTextcritics.commentary)&&(this.selectedTextcriticalCommentary=this.selectedTextcritics.commentary))}},O.propDecorators={modal:[{type:m,args:["modal",{static:!0}]}]},O);P=r([h({selector:"awg-edition-sheets",template:Qe,standalone:!1,styles:[Xe]})],P);var wt=[{path:"",component:P,data:{title:"AWG Online Edition \u2013 Sheets"}}],Ke=[P],K=class{};K=r([p({imports:[ee.forChild(wt)],exports:[ee]})],K);var Je=class{};Je=r([p({imports:[S,Z,X,K],declarations:[Ke]})],Je);export{Je as EditionSheetsModule};
