import{a as g,b as ye}from"./chunk-MSTPLEVO.js";import{a as N}from"./chunk-PP6HJ337.js";import{Bb as A,D as s,Da as R,Ea as X,Ga as K,Ha as D,I as J,Ia as C,K as c,Ka as me,M as n,Ma as De,Oa as ge,R as a,Ra as Pe,T as l,U as p,Va as Ae,W as E,_a as Z,a as Ce,bb as fe,bc as be,cb as Le,cc as _e,dc as ke,fc as se,h as v,i as xe,ic as qe,j as o,jc as ae,kb as ee,l as ue,n as b,na as _,nb as k,nc as ie,ob as te,p as Te,pb as P,qa as z,qb as re,r as I,rb as y,sb as Oe,t as Ie,tb as m,u as O,ub as w,vb as q,w as Ee,wb as ve,xb as d,y as W,yb as oe,z as u}from"./chunk-H3VGMIRL.js";var Ne=`<!-- resource detail header -->
...
`;var j=class{constructor(){this.resourceRequest=new c}navigateToResource(e){e&&(e=e.toString(),this.resourceRequest.emit(e))}static{this.propDecorators={header:[{type:l}],resourceUrl:[{type:l}],resourceRequest:[{type:p}]}}};j=o([a({selector:"awg-resource-detail-header",template:Ne,changeDetection:n.OnPush,standalone:!1,styles:[je]})],j);var Ve=`<!-- resourceDetailData content -->
...
`;var Me="";var F=class{constructor(){this.gndRequest=new c,this.resourceRequest=new c}exposeGnd(e){e?.type&&this.gndRequest.emit(e)}navigateToResource(e){e&&(e=e.toString(),this.resourceRequest.emit(e))}static{this.propDecorators={content:[{type:l}],gndRequest:[{type:p}],resourceRequest:[{type:p}]}}};F=o([a({selector:"awg-resource-detail-html-content",template:Ge,changeDetection:n.OnPush,standalone:!1,styles:[Me]})],F);var Ue=`<!--
/************************************************
*
*               CREDITS
*
...
`;var G=class{constructor(){this.galleryOptions=[new De({width:"100%",imageSize:"contain",thumbnailSize:"contain",thumbnailMargin:5,thumbnailsMargin:0,previewCloseOnClick:!0,previewCloseOnEsc:!0,previewZoom:!0,previewRotate:!0,linkTarget:"_blank"})]}static{this.propDecorators={images:[{type:l}]}}};G=o([a({selector:"awg-resource-detail-html-content-imageobjects",template:Ue,changeDetection:n.OnPush,standalone:!1,styles:[$e]})],G);var He=`<!--
/************************************************
*
*               CREDITS
*
...
`;var U=class{constructor(){this.gndRequest=new c,this.resourceRequest=new c,this.metaBreakLine="Versionsdatum"}ngOnChanges(e){e.props&&this._checkForGND(e.props)}exposeGnd(e){e?.type&&this.gndRequest.emit(e)}navigateToResource(e){e&&(e=e.toString(),this.resourceRequest.emit(e))}ngOnDestroy(){this._removeGnd()}_checkForGND(e){let t=e.currentValue.filter(r=>r.pid==="856"&&r.values&&r.values.length>0);this._removeGnd(),t.length>0&&t.forEach(r=>{r.values.forEach(i=>{this._setGnd(i)})})}_setGnd(e){let t=new _e(be.SET,e);this.exposeGnd(t)}_removeGnd(){let e=new _e(be.REMOVE,null);this.exposeGnd(e)}static{this.propDecorators={props:[{type:l}],gndRequest:[{type:p}],resourceRequest:[{type:p}]}}};U=o([a({selector:"awg-resource-detail-html-content-props",template:Qe,changeDetection:n.OnPush,standalone:!1,styles:[Ye]})],U);var We=`<awg-json-viewer
    jsonViewerHeader="Converted JSON response from Salsah-API"
    [jsonViewerData]="resourceJsonConvertedData">
</awg-json-viewer>
`;var Je="";var $=class{static{this.propDecorators={resourceJsonConvertedData:[{type:l}]}}};$=o([a({selector:"awg-resource-detail-json-converted",template:We,changeDetection:n.OnPush,standalone:!1,styles:[Je]})],$);var ze=`<awg-json-viewer jsonViewerHeader="Raw JSON response from Salsah-API" [jsonViewerData]="resourceJsonRawData">
</awg-json-viewer>
`;var Xe="";var H=class{static{this.propDecorators={resourceJsonRawData:[{type:l}]}}};H=o([a({selector:"awg-resource-detail-json-raw",template:ze,changeDetection:n.OnPush,standalone:!1,styles:[Xe]})],H);var ne=class{};ne=o([E({imports:[ie],declarations:[j,V,F,G,M,U,$,H],exports:[j,V,F,G,M,U,$,H]})],ne);var Ke=`@if (extendedSearchForm) {
...
`;var vt="";var Y=class{constructor(){this.searchTitle="Suche",this.searchId="search",this._router=s(C)}ngOnInit(){this.navigateToSideOutlet()}navigateToSideOutlet(){this._router.navigate([{outlets:{side:"searchInfo"}}],{preserveFragment:!0,queryParamsHandling:"preserve"})}ngOnDestroy(){this._router.navigate([{outlets:{side:null}}])}};Y=o([a({selector:"awg-data",template:ft,standalone:!1,styles:[vt]})],Y);var gr=[{path:"",component:Y,children:[{path:"",pathMatch:"full",redirectTo:"search"},{path:"search",component:Q,children:[{path:"",component:T,children:[{path:"",pathMatch:"full",redirectTo:"fulltext"},{path:"fulltext",data:{title:"AWG Online Edition \u2013 Fulltext Search"},component:T},{path:"extended",data:{title:"AWG Online Edition \u2013 Extended Search"},component:T},{path:"detail/:id",redirectTo:"resource/:id"}]}]}]},{path:"resource/:id",component:x,data:{title:"AWG Online Edition \u2013 Resource Detail"},children:[{path:"",pathMatch:"full",redirectTo:"html"},{path:"html",data:{title:"AWG Online Edition \u2013 Resource Detail HTML"},component:x},{path:"converted-json",data:{title:"AWG Online Edition \u2013 Resource Detail JSON Converted"},component:x},{path:"raw-json",data:{title:"AWG Online Edition \u2013 Resource Detail JSON Raw"},component:x}]}],bt=[Y,Q,T,x],de=class{};de=o([E({imports:[me.forChild(gr)],exports:[me]})],de);var _t=class{};_t=o([E({imports:[ie,ne,de],declarations:[bt,ce,pe,he]})],_t);export{_t as DataViewModule};
