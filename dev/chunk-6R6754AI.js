import{a as r,b as o}from"./chunk-O44GI4KW.js";import{b as D}from"./chunk-QSGG4RFN.js";import"./chunk-BGGPLHQO.js";import{h as b}from"./chunk-JYIXRVGB.js";import{a as f}from"./chunk-BVPCGSEX.js";import{Bc as g,Ca as t,Ib as i,ea as u,o as e,qc as h,ra as m,sb as a,ub as n}from"./chunk-Z3BUILC6.js";var w=`<!-- sideinfo: contact -->
<div class="card">
...
`;var C="";var s=class{constructor(){this.pageMetaData=i.required(),this.contactMetaData=i.required()}static{this.propDecorators={pageMetaData:[{type:n,args:[{isSignal:!0,alias:"pageMetaData",required:!0,transform:void 0}]}],contactMetaData:[{type:n,args:[{isSignal:!0,alias:"contactMetaData",required:!0,transform:void 0}]}]}}};s=e([a({selector:"awg-contact-address",template:_,changeDetection:t.OnPush,styles:[C]})],s);var A=`<iframe
...
`;var v="";var d=class{constructor(){this.embedUrl=i.required(),this.linkUrl=i.required(),this.LINK_LABEL="Gr\xF6\xDFere Karte anzeigen",this.IFRAME_SETTINGS={width:"100%",height:"350"}}static{this.propDecorators={embedUrl:[{type:n,args:[{isSignal:!0,alias:"embedUrl",required:!0,transform:void 0}]}],linkUrl:[{type:n,args:[{isSignal:!0,alias:"linkUrl",required:!0,transform:void 0}]}]}}};d=e([a({selector:"awg-contact-map",template:A,changeDetection:t.OnPush,styles:[v]})],d);var c=class{constructor(){this._sanitizer=u(b),this.CONTACT_SIDE_INFO_HEADER="Kontakt",this.contactMetaData=r[o.contact],this.pageMetaData=r[o.page],this.mapEmbedUrl=this._sanitizer.bypassSecurityTrustResourceUrl(g.CONTACT_MAP_UNSAFE_EMBED_URL),this.mapLinkUrl=g.CONTACT_MAP_LINK_URL}};c=e([a({selector:"awg-contact-side-info",template:w,changeDetection:t.OnPush,imports:[s,d],styles:[I]})],c);var M=`<!-- content: contact -->
...
`;var p=class{constructor(){this.CITATION_ID="awg-citation",this.CITATION_TITLE="Zitation",this.IMPRINT_ID="awg-imprint",this.IMPRINT_TITLE="Impressum",this.DOCUMENTATION_ID="awg-documentation",this.DOCUMENTATION_TITLE="Dokumentation",this.contactMetaData=r[o.contact],this.pageMetaData=r[o.page],this.today=m(Date.now()).asReadonly()}};p=e([a({selector:"awg-contact-view",template:M,changeDetection:t.OnPush,imports:[h,f,D],styles:[N]})],p);var Se=[{path:"",component:p,data:{title:"AWG Online Edition \u2013 Contact"}},{path:"",outlet:"side",component:c}];export{Se as CONTACT_VIEW_ROUTES};
