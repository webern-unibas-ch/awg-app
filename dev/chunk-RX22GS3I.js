import{a as t}from"./chunk-JFKXFNRN.js";import{f as m}from"./chunk-JWRONSD3.js";import"./chunk-FBSFVWHY.js";import{c as d}from"./chunk-O7HQUMJW.js";import"./chunk-GDDPWYC3.js";import{e as u,l as g}from"./chunk-ZN2NI6RN.js";import"./chunk-B3J2Y3BU.js";import{Aa as r,Cc as p,ea as a,o as e,pb as o,vb as s}from"./chunk-UOBPUXIH.js";var h=`<!-- sideinfo: contact -->
<div class="card">
...
`;var i=class{constructor(){this.imprintTitle="Impressum",this.imprintId="awg-imprint",this.citationTitle="Zitation",this.citationId="awg-citation",this.documentationTitle="Dokumentation",this.documentationId="awg-documentation",this.dateFormat="d. MMMM yyyy",this._coreService=a(d)}ngOnInit(){this.provideMetaData(),this.today=Date.now()}provideMetaData(){this.pageMetaData=this._coreService.getMetaDataSection(t.page),this.contactMetaData=this._coreService.getMetaDataSection(t.contact)}};i=e([o({selector:"awg-contact-view",template:f,changeDetection:r.Eager,standalone:!1,styles:[w]})],i);var k=[{path:"",component:i,data:{title:"AWG Online Edition \u2013 Contact"}},{path:"",outlet:"side",component:n}],D=[i,n],c=class{};c=e([s({imports:[g.forChild(k)],exports:[g]})],c);var v=class{};v=e([s({imports:[m,c],declarations:[D]})],v);export{v as ContactViewModule};
