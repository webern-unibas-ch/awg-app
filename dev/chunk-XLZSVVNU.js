import{f as z}from"./chunk-FG5FOD7D.js";import"./chunk-QDXHM6VR.js";import{a as G,c as P,g as y}from"./chunk-DGFTDAOD.js";import{h as W}from"./chunk-4VITREEW.js";import{c as j,k as A,l as H,m as L,p as V}from"./chunk-VEPNBYV2.js";import"./chunk-UT3WYQSC.js";import"./chunk-LARCB5KM.js";import{Aa as s,B as q,I as B,Ib as F,U as M,V as x,W as $,Y as U,a as E,b as k,ea as c,k as N,ma as g,n as R,o as i,pb as d,q as D,rb as n,sb as p,u as O,v as T,vb as f}from"./chunk-ZCYNGYSZ.js";var Y=`@if (introBlockContent) {
...
`;var X="";var _=class{static{this.propDecorators={editionComplex:[{type:n}],editionLabel:[{type:n}],editionRoute:[{type:n}],seriesRoute:[{type:n}],sectionRoute:[{type:n}],introRoute:[{type:n}]}}};_=i([d({selector:"awg-edition-intro-partial-disclaimer",template:Q,standalone:!1,styles:[X]})],_);var tt=`<div class="awg-edition-intro-placeholder">
...
`;var et="";var v=class{static{this.propDecorators={editionComplex:[{type:n}],editionLabel:[{type:n}]}}};v=i([d({selector:"awg-edition-intro-placeholder",template:tt,changeDetection:s.OnPush,standalone:!1,styles:[et]})],v);var ot=`<!-- content: intro -->
<div>
    <!-- modal -->
    <awg-modal #modal />
...
`;var nt="";var h=class{constructor(){this.currentLanguage=0,this.notesLabels=new Map([[0,"Anmerkungen"],[1,"Notes"]]),this.errorObject=null,this.UTILS=c(W),this._destroyed$=new N,this._editionDataService=c(A),this._editionStateService=c(V),this._router=c(P),this._initScrollListener()}get editionRouteConstants(){return j}ngOnInit(){this.getEditionIntroData()}ngOnDestroy(){this._editionStateService.clearIsIntroView(),this.editionIntroData$=void 0,this._destroyed$.next(!0),this._destroyed$.complete()}getEditionIntroData(){this._router.events.subscribe(t=>{if(this._isNavigationEndToIntro(t)){let{seriesNumber:e,sectionNumber:o}=this._extractUrlSegments(t.urlAfterRedirects);e&&o?this._updateEditionState(e,o):console.error("Invalid URL segments:",t.urlAfterRedirects)}}),this._loadEditionIntroData()}onIntroFragmentNavigate(t){let e={fragment:t?.fragmentId??""};this._router.navigate([],e)}onLanguageSet(t){this.currentLanguage=t}onModalOpen(t){t&&this.modal.open(t)}onReportFragmentNavigate(t){let e=this.editionRouteConstants.EDITION_REPORT.route,o={fragment:t?.fragmentId??""};this._navigateWithComplexId(t?.complexId,e,o)}onSvgSheetSelect(t){let e=this.editionRouteConstants.EDITION_SHEETS.route,o={queryParams:{id:t?.sheetId??""}};this._navigateWithComplexId(t?.complexId,e,o)}_extractUrlSegments(t){if(!t)return{seriesNumber:void 0,sectionNumber:void 0};let e=t.split("/"),o=e.indexOf("series")+1,r=e.indexOf("section")+1,l=e[o],a=e[r],S=u=>u!==void 0&&/^[1-3]$/.test(u),C=u=>u!==void 0&&/^[1-5]+[ab]?$/.test(u);return{seriesNumber:S(l)?l:void 0,sectionNumber:C(a)?a:void 0}}_fetchAndFilterIntroData(t,e,o){return this._editionDataService.getEditionSectionIntroData(t,e).pipe(x(r=>o?(this.editionComplex=o,this._editionDataService.getEditionComplexIntroData(this.editionComplex).pipe(O(l=>{let a=l.intro[0].id;return this._filterSectionIntroDataById(r,a)}))):(this.editionComplex=void 0,D(r))))}_filterSectionIntroDataById(t,e){return k(E({},t),{intro:t.intro.map(o=>k(E({},o),{content:o.content.filter(r=>r.blockId===e)}))})}_initScrollListener(){q(globalThis,"scroll").pipe(U(200),$(this._destroyed$)).subscribe({next:t=>this._onIntroScroll(t)})}_isNavigationEndToIntro(t){return t instanceof G&&t.urlAfterRedirects?.includes("intro")}_loadEditionIntroData(){this.editionIntroData$=T([this._editionStateService.getSelectedEditionSeries(),this._editionStateService.getSelectedEditionSection(),this._editionStateService.getSelectedEditionComplex().pipe(M(null))]).pipe(x(([t,e,o])=>t&&e?this._fetchAndFilterIntroData(t.series.route,e.section.route,o):R),B(t=>(this.errorObject=t,R)))}_navigateWithComplexId(t,e,o){let r=t?`/edition/complex/${t}/`:this.editionComplex.baseRoute;this._router.navigate([r,e],o)}_onIntroScroll(t){if(t?.type==="scroll"){let e=globalThis.scrollY||document.documentElement.scrollTop,o=document.querySelectorAll(".awg-edition-intro-section"),r=document.querySelectorAll("a.awg-edition-intro-nav-link"),l=null;o.forEach(a=>{let S=a.offsetTop-10,C=a.offsetTop+a.offsetHeight;S<=e&&C>e&&(l=a.id)}),r.forEach(a=>{a.classList.toggle("active",a.hash.includes(l))})}}_updateEditionState(t,e){let o=L.getEditionSeriesById(t),r=L.getEditionSectionById(t,e);this._editionStateService.updateSelectedEditionSeries(o),this._editionStateService.updateSelectedEditionSection(r),this._editionStateService.updateIsIntroView(!0)}static{this.ctorParameters=()=>[]}static{this.propDecorators={modal:[{type:F,args:["modal",{static:!0}]}]}}};h=i([d({selector:"awg-edition-intro",template:ot,changeDetection:s.OnPush,standalone:!1,styles:[nt]})],h);var ft=[{path:"",component:h,data:{title:"AWG Online Edition \u2013 Intro"}}],it=[h],I=class{};I=i([f({imports:[y.forChild(ft)],exports:[y]})],I);var rt=class{};rt=i([f({imports:[z,I],declarations:[b,w,_,v,it]})],rt);export{rt as EditionIntroModule};
