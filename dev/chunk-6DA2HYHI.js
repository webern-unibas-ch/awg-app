import{a as x}from"./chunk-XGZMTVJ5.js";import{f as p}from"./chunk-OAITJWGG.js";import{a as G,m as W}from"./chunk-32YSZHDB.js";import{c as D,v as L}from"./chunk-5PHEX44N.js";import"./chunk-XSX4J6S3.js";import{G as n,L as i,Ma as A,Oa as k,Q as F,R as r,T as c,U as s,X as v,k as q,l as o,ob as b,t as O,z as N}from"./chunk-VS32STRN.js";var U=`<div class="awg-source-description-corrections">
...
`;var P="";var m,T=(m=class{constructor(){this.navigateToReportFragmentRequest=new i,this.openModalRequest=new i,this.selectSvgSheetRequest=new i,this.ref=this}navigateToReportFragment(t){t&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}selectSvgSheet(t){t?.sheetId&&this.selectSvgSheetRequest.emit(t)}},m.ctorParameters=()=>[],m.propDecorators={corrections:[{type:c}],navigateToReportFragmentRequest:[{type:s}],openModalRequest:[{type:s}],selectSvgSheetRequest:[{type:s}]},m);T=o([r({selector:"awg-source-description-corrections",template:U,changeDetection:n.OnPush,styles:[P]})],T);var j=`@if (sourceDescriptionListData) {
...
`;var B="";var u,w=(u=class{constructor(t){this.utils=t,this.navigateToReportFragmentRequest=new i,this.openModalRequest=new i,this.selectSvgSheetRequest=new i,this.FIRM_SIGNS=L,this.ref=this}getWritingInstruments(t){let e=t.secondary?.join(", ");return`${e?`${t.main}; ${e}`:t.main}.`}getWritingMaterialFirmSign(t){return t&&this.FIRM_SIGNS[t]?this.FIRM_SIGNS[t]:{route:"",full:"Not a known firm sign.",short:"unknown"}}getWritingMaterialItemLocation(t){if(!this.utils.isNotEmptyObject(t)||!this.utils.isNotEmptyArray(t.folios))return"";let e=t.folios.map(a=>a.endsWith("v")||a.endsWith("r")?`${a.slice(0,-1)}<sup>${a.slice(-1)}</sup>`:a),l=e.length>1?`${e.slice(0,-1).join(", ")} und ${e.slice(-1)}`:e[0],y=t.info?`${t.info} `:"",S=t.position?` ${t.position}`:"";return`${y}auf Bl. ${l}${S}`}getWritingMaterialFormat(t){let{orientation:e,height:l,width:y}=t,S=a=>this.utils.isNotEmptyObject(a)?a.uncertainty?`${a.uncertainty} ${a.value}`:a.value:"";return`Format: ${e} ${S(l)} \xD7 ${S(y)} mm`}getWritingMaterialSystems(t){return[`${t.number} ${t.number===1?"System":"Systeme"}`,t.info&&` (${t.info})`,t.addendum&&`, ${t.addendum}`].filter(Boolean).join("")}navigateToReportFragment(t){t&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}selectSvgSheet(t){t?.sheetId&&this.selectSvgSheetRequest.emit(t)}},u.ctorParameters=()=>[{type:p}],u.propDecorators={sourceDescriptionListData:[{type:c}],navigateToReportFragmentRequest:[{type:s}],openModalRequest:[{type:s}],selectSvgSheetRequest:[{type:s}]},u);w=o([r({selector:"awg-source-description",template:j,changeDetection:n.OnPush,styles:[B]})],w);var M=class{};M=o([v({imports:[b,x],declarations:[w,T],exports:[w]})],M);var H=`@if (sourceEvaluationListData) {
...
`;var g,_=(g=class{constructor(t){this.utils=t,this.navigateToReportFragmentRequest=new i,this.openModalRequest=new i,this.ref=this}navigateToReportFragment(t){t&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}},g.ctorParameters=()=>[{type:p}],g.propDecorators={sourceListData:[{type:c}],navigateToReportFragmentRequest:[{type:s}],openModalRequest:[{type:s}]},g);_=o([r({selector:"awg-source-list",template:Q,changeDetection:n.OnPush,styles:[Z]})],_);var K=`@if (textcriticsData) {
    <div ngbAccordion>
...
`;var V="";var f,I=(f=class{constructor(t){this.utils=t,this.navigateToReportFragmentRequest=new i,this.openModalRequest=new i,this.selectSvgSheetRequest=new i,this.ref=this}navigateToReportFragment(t){t&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}selectSvgSheet(t){t?.sheetId&&this.selectSvgSheetRequest.emit(t)}},f.ctorParameters=()=>[{type:p}],f.propDecorators={textcriticsData:[{type:c}],navigateToReportFragmentRequest:[{type:s}],openModalRequest:[{type:s}],selectSvgSheetRequest:[{type:s}]},f);I=o([r({selector:"awg-textcritics-list",template:K,changeDetection:n.OnPush,styles:[V]})],I);var Y=`<!-- content: edition report -->
<div>
    <!-- modal -->
