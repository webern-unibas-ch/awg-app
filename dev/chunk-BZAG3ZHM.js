import{a as b}from"./chunk-UZOGJBBI.js";import{a as c}from"./chunk-TQUHFH2O.js";import{m as w}from"./chunk-BIPCK66E.js";import{ca as y,ja as U,ka as G,pa as j}from"./chunk-WOENJHQD.js";import{e as F,i as $}from"./chunk-YYJMEEWT.js";import"./chunk-4XQV5OEK.js";import"./chunk-EDVXJ4E6.js";import"./chunk-RI65DLSK.js";import"./chunk-7JWDOSFQ.js";import{Ca as n,I as O,Nb as N,V as A,ea as a,n as L,na as t,o as i,sb as r,ub as s,vb as o,yb as d}from"./chunk-H4NSEBVT.js";var P=`<table class="awg-source-description-content-table half-para-margin" role="presentation">
...
`;var D=class{constructor(){this.selectSvgSheetRequest=new t,this.UTILS=a(c),this.ref=this}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={content:[{type:s}],selectSvgSheetRequest:[{type:o}]}}};D=i([r({selector:"awg-source-description-content-table",template:P,changeDetection:n.OnPush,standalone:!1,styles:[W]})],D);var B=`<div class="awg-source-description-contents">
...
`;var H=`.awg-source-description-contents{margin-bottom:1rem}.awg-source-description-contents-toggle{margin-left:1em;cursor:pointer}.awg-source-description-contents-toggle.text-muted{transition:color .2s}.awg-source-description-contents-toggle:hover,.awg-source-description-contents-toggle:focus{color:inherit!important}.awg-source-description-contents-toggle-text{text-decoration:underline}
`;var T=class{constructor(){this.selectSvgSheetRequest=new t,this.openAllContentDetails=!0,this.UTILS=a(c),this.ref=this}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleAllContentDetails(e){this.openAllContentDetails=e}static{this.ctorParameters=()=>[]}static{this.propDecorators={contents:[{type:s}],selectSvgSheetRequest:[{type:o}]}}};T=i([r({selector:"awg-source-description-contents",template:B,changeDetection:n.OnPush,standalone:!1,styles:[H]})],T);var z=`<div class="awg-source-description-corrections">
...
`;var Z=`p{display:flex;align-items:baseline}p .awg-source-description-details-label{flex-shrink:0;white-space:nowrap}p .awg-source-description-details-content{flex:1}
`;var x=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={details:[{type:s}],detailsClass:[{type:s}],detailsLabel:[{type:s}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]}}};x=i([r({selector:"awg-source-description-details",template:Q,changeDetection:n.OnPush,standalone:!1,styles:[Z]})],x);var V=`<p class="awg-source-description-writing-materials">
...
`;var Y=`p{display:flex;align-items:baseline}p .awg-source-description-writing-materials-label{flex-shrink:0;white-space:nowrap}p .awg-source-description-writing-materials-content{flex:1}
`;var _=class{constructor(){this.UTILS=a(c),this.TRADEMARKS=U,this.ref=this}getTrademark(e){return e&&this.TRADEMARKS[e]?this.TRADEMARKS[e]:{route:"",full:"Not a known trademark.",short:"unknown"}}getItemLocus(e){if(!this.UTILS.isNotEmptyObject(e))return"";let l=m=>m.endsWith("v")||m.endsWith("r")?`${m.slice(0,-1)}<sup>${m.slice(-1)}</sup>`:m,u=m=>m.length===1?m[0].includes("all")?"auf allen Bl\xE4ttern":`auf Bl. ${m[0]}`:m.length>1?`auf Bl. ${m.slice(0,-1).join(", ")} und ${m.slice(-1)}`:"",f=e.folios.map(l),S=u(f),R=e.preFolioInfo?`${e.preFolioInfo} `:"",g=S?" ":"",pe=e.position?`${g}${e.position}`:"";return`${R}${S}${pe}`}getDimensions(e){let{orientation:l,height:u,width:f,unit:S}=e,R=g=>this.UTILS.isNotEmptyObject(g)?g.uncertainty?`${g.uncertainty} ${g.value}`:g.value:"";return`Format: ${l} ${R(u)} \xD7 ${R(f)} ${S}`}getSystems(e){return[`${e.totalSystems} ${e.totalSystems===1?"System":"Systeme"}`,e.totalSystemsAddendum&&` (${e.totalSystemsAddendum})`,e.additionalInfo&&`, ${e.additionalInfo}`].filter(Boolean).join("")}static{this.ctorParameters=()=>[]}static{this.propDecorators={writingMaterials:[{type:s}]}}};_=i([r({selector:"awg-source-description-writing-materials",template:V,changeDetection:n.OnPush,standalone:!1,styles:[Y]})],_);var J=`@if (sourceDescriptionListData) {
...
`;var X="";var h=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.UTILS=a(c),this.ref=this}getWritingInstruments(e){let l=e.secondary?.join(", ");return`${l?`${e.main}; ${l}`:e.main}.`}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={sourceDescriptionListData:[{type:s}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]}}};h=i([r({selector:"awg-source-description",template:J,changeDetection:n.OnPush,standalone:!1,styles:[X]})],h);var I=class{};I=i([d({imports:[w,b],declarations:[h,T,D,C,x,_],exports:[h]})],I);var ee=`@if (sourceEvaluationListData) {
...
`;var te="";var E=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.UTILS=a(c),this.ref=this}get editionRouteConstants(){return y}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={editionComplex:[{type:s}],sourceEvaluationListData:[{type:s}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]}}};E=i([r({selector:"awg-source-evaluation",template:ee,changeDetection:n.OnPush,standalone:!1,styles:[te]})],E);var oe=`<div class="card">
    <div class="card-body">
...
`;var ne="";var k=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.UTILS=a(c),this.ref=this}isWorkEditionId(e){return e?e.includes("_WE"):!1}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={textcriticsData:[{type:s}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]}}};k=i([r({selector:"awg-textcritics-list",template:se,changeDetection:n.OnPush,standalone:!1,styles:[ne]})],k);var re=`<!-- content: edition report -->
<div>
    <!-- modal -->
    <awg-modal #modal />
...
`;var ae="";var v=class{constructor(){this.errorObject=null,this.titles={sourceList:"1. Quellen\xFCbersicht",sourceDescription:"2. Quellenbeschreibung",sourceEvaluation:"3. Quellenbewertung",tka:"4. Textkritische Anmerkungen"},this._editionDataService=a(G),this._editionStateService=a(j),this._router=a(F)}get editionRouteConstants(){return y}ngOnInit(){this.getEditionReportData()}getEditionReportData(){this.editionReportData$=this._editionStateService.getSelectedEditionComplex().pipe(A(e=>(this.editionComplex=e,this._editionDataService.getEditionReportData(this.editionComplex))),O(e=>(this.errorObject=e,L)))}onModalOpen(e){e&&this.modal.open(e)}onReportFragmentNavigate(e){let l=this.editionRouteConstants.EDITION_REPORT.route,u={fragment:e?.fragmentId??""};this._navigateWithComplexId(e?.complexId,l,u)}onSvgSheetSelect(e){let l=this.editionRouteConstants.EDITION_SHEETS.route,u={queryParams:{id:e?.sheetId??""}};this._navigateWithComplexId(e?.complexId,l,u)}_navigateWithComplexId(e,l,u){let f=e?`/edition/complex/${e}`:this.editionComplex.baseRoute;this._router.navigate([f,l],u)}static{this.propDecorators={modal:[{type:N,args:["modal",{static:!0}]}]}}};v=i([r({selector:"awg-edition-report",template:re,changeDetection:n.OnPush,standalone:!1,styles:[ae]})],v);var ke=[{path:"",component:v,data:{title:"AWG Online Edition \u2013 Report"}}],ce=[v],q=class{};q=i([d({imports:[$.forChild(ke)],exports:[$]})],q);var le=class{};le=i([d({imports:[w,b,I,q],declarations:[k,E,M,ce]})],le);export{le as EditionReportModule};
