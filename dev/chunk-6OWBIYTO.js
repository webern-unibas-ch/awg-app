import{a as L}from"./chunk-5XRCURLD.js";import{a as _e,e as we}from"./chunk-R6454KD7.js";import{A as q,D as p,Fb as ae,Gb as de,H as g,Hb as _,Ib as ce,Jb as he,K as J,Ka as ie,Kb as ge,La as se,Lb as ve,M as r,Na as H,Pb as pe,R as u,S as c,Sb as Se,Ta as oe,Tb as me,U as a,V as l,Va as ne,W as ee,X as v,_b as U,a as W,b as j,bc as ue,ca as te,cb as re,f as Z,h as C,i as Y,ib as le,ic as fe,j as n,o as X,pb as f,qc as S,s as Q,t as K,y as P,z as A}from"./chunk-KMH67G4H.js";var Ce=`<div class="awg-edition-svg-sheet-footer mt-4">
...
`;var ye="";var y=class{constructor(){this.navigateToReportFragmentRequest=new r,this.openModalRequest=new r,this.selectSvgSheetRequest=new r,this.faChevronRight=le,this.faChevronDown=re,this.showEvaluation=!1,this.UTILS=p(f),this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleEvaluation(){this.showEvaluation=!this.showEvaluation}static{this.ctorParameters=()=>[]}static{this.propDecorators={selectedTextcriticalCommentBlocks:[{type:a}],selectedTextcritics:[{type:a}],showTkA:[{type:a}],navigateToReportFragmentRequest:[{type:l}],openModalRequest:[{type:l}],selectSvgSheetRequest:[{type:l}]}}};y=n([c({selector:"awg-edition-svg-sheet-footer",template:Ce,changeDetection:g.OnPush,styles:[ye]})],y);var F=class{};F=n([v({imports:[S,L],declarations:[y],exports:[y]})],F);var be=`<h6 class="card-title">
    {{ navItemLabel }}:
...
`;var ke=`a#dropDownSheetNav.btn{border:none!important}a#dropDownSheetNav.active,a#dropDownSheetNav:active{color:#149b9e!important}a#dropDownSheetNav:hover{color:#333!important}a#dropDownSheetNav>span{display:inline-block;white-space:break-spaces;text-align:start}
`;var b=class{constructor(e){this.utils=e,this.selectSvgSheetRequest=new r}isSelectedSvgSheet(e,t){let i=e,s=this.selectedSvgSheet?.id;return t&&this.selectedSvgSheet?.content?.[0]?.partial&&(i+=t,s+=this.selectedSvgSheet.content[0].partial),i===s}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[{type:f}]}static{this.propDecorators={navItemLabel:[{type:a}],svgSheets:[{type:a}],selectedSvgSheet:[{type:a}],selectSvgSheetRequest:[{type:l}]}}};b=n([c({selector:"awg-edition-svg-sheet-nav-item",template:be,changeDetection:g.OnPush,styles:[ke]})],b);var xe=`@if (svgSheetsData) {
...
`;var Re="";var k=class{constructor(){this.selectSvgSheetRequest=new r}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={svgSheetsData:[{type:a}],selectedSvgSheet:[{type:a}],selectSvgSheetRequest:[{type:l}]}}};k=n([c({selector:"awg-edition-svg-sheet-nav",template:xe,changeDetection:g.OnPush,styles:[Re]})],k);var M=class{};M=n([v({imports:[S],declarations:[k,b],exports:[k,b]})],M);var Ee=`<div class="awg-edition-svg-sheet-viewer-nav">
...
`;var x=class{constructor(){this.browseSvgSheetRequest=new r}browseSvgSheet(e){e&&this.browseSvgSheetRequest.emit(e)}static{this.propDecorators={browseSvgSheetRequest:[{type:l}]}}};x=n([c({selector:"awg-edition-svg-sheet-viewer-nav",template:Ee,changeDetection:g.OnPush,styles:[Te]})],x);var Oe=`<div class="card awg-edition-svg-sheet-viewer-settings float-none my-2">
