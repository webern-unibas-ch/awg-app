import{a as U}from"./chunk-2G5ECTRL.js";import"./chunk-HNTD4QJZ.js";import{a as M}from"./chunk-GYSG6DRK.js";import"./chunk-57ATL23E.js";import"./chunk-3F66QUQP.js";import{i as k,n as B}from"./chunk-6347MYB4.js";import{J as N,K as D,L as q}from"./chunk-7T2EW5XL.js";import{e as O,i as _}from"./chunk-YXTFIJMG.js";import"./chunk-D5RS63QN.js";import"./chunk-CPI4SSX3.js";import"./chunk-65SSBV63.js";import{B as I,Ua as i,W as R,Wa as e,Xa as d,Y as x,Za as m,bb as y,da as c,gb as L,k as E,ka as g,kb as T,na as S,o,xa as r}from"./chunk-CE57Q5C6.js";var G=`@if (introBlockContent) {
...
`;var u=class{constructor(){this._editionGlyphService=c(N),this.navigateToIntroFragmentRequest=new g,this.navigateToReportFragmentRequest=new g,this.openModalRequest=new g,this.selectSvgSheetRequest=new g,this.ref=this}getGlyph(t){return this._editionGlyphService.getGlyph(t)}navigateToIntroFragment(t){t?.fragmentId&&this.navigateToIntroFragmentRequest.emit(t)}navigateToReportFragment(t){t?.fragmentId&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}selectSvgSheet(t){t?.sheetId&&this.selectSvgSheetRequest.emit(t)}static{this.propDecorators={introBlockContent:[{type:e}],notesLabel:[{type:e}],navigateToIntroFragmentRequest:[{type:d}],navigateToReportFragmentRequest:[{type:d}],openModalRequest:[{type:d}],selectSvgSheetRequest:[{type:d}]}}};u=o([i({selector:"awg-edition-intro-content",template:G,changeDetection:r.OnPush,standalone:!1,styles:[F]})],u);var P=`@if (introBlockContent) {
