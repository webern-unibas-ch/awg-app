import{g as D}from"./chunk-TJPNUKXO.js";import"./chunk-2ZRRQSH4.js";import{b as g,g as h}from"./chunk-NOYGDVKY.js";import{g as v}from"./chunk-AV3TUWRU.js";import{m as x,p as d}from"./chunk-5JF7PRSL.js";import"./chunk-DJQARGYF.js";import"./chunk-AGBWR6G4.js";import{Aa as o,F as C,W as E,ea as s,k as u,o as e,pb as t,rb as n,vb as a}from"./chunk-T5O55Q3N.js";var y=`<div class="row row-cols-1 row-cols-md-3 row-cols-xl-5 g-4">
...
`;var w="";var l=class{static{this.propDecorators={complexes:[{type:n}]}}};l=e([t({selector:"awg-edition-section-detail-complex-card",template:y,changeDetection:o.OnPush,standalone:!1,styles:[w]})],l);var I=`<awg-alert-info
        ...
        <div class="awg-edition-section-detail">
            ...
            @if (UTILS.isNotEmptyArray(selectedSection?.content?.complexTypes?.opus)) {
                <div class="awg-edition-section-detail-opus para p-3 shadow border rounded-3">
                    ...
                    <awg-edition-section-detail-complex-card [complexes]="selectedSection.content.complexTypes.opus" />
                </div>
            }
            @if (UTILS.isNotEmptyArray(selectedSection?.content?.complexTypes?.mnr)) {
                <div class="awg-edition-section-detail-mnr p-3 shadow border rounded-3">
                    ...
                    <awg-edition-section-detail-complex-card [complexes]="selectedSection.content.complexTypes.mnr" />
                </div>
            }
        </div>
    } @else {
...
`;var M="";var r=class{constructor(){this.UTILS=s(v),this._editionStateService=s(d)}ngOnInit(){this.setupSectionDetailOverview()}setupSectionDetailOverview(){this.selectedSeries$=this._editionStateService.getSelectedEditionSeries(),this.selectedSection$=this._editionStateService.getSelectedEditionSection()}};r=e([t({selector:"awg-edition-section-detail-overview",template:U,changeDetection:o.OnPush,standalone:!1,styles:[M]})],r);var T=`<router-outlet />
`;var G="";var c=class{constructor(){this._destroyed$=new u,this._editionStateService=s(d),this._route=s(g)}ngOnInit(){this.updateSectionFromRoute()}updateSectionFromRoute(){let k=this._route.snapshot.paramMap.get("id");this._editionStateService.getSelectedEditionSeries().pipe(E(this._destroyed$),C(f=>!!f)).subscribe(f=>{let A=f?.series?.route,j=x.getEditionSectionById(A,k);this._editionStateService.updateSelectedEditionSection(j)})}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}};c=e([t({selector:"awg-edition-section-detail",template:T,standalone:!1,styles:[G]})],c);var Y=[{path:"",component:c,children:[{path:"intro",loadChildren:()=>import("./chunk-TH5SFP4W.js").then(i=>i.EditionIntroModule)},{path:"",component:r}]}],$=[c,r],_=class{};_=e([a({imports:[h.forChild(Y)],exports:[h]})],_);var P=class{};P=e([a({imports:[D,_],declarations:[l,p,m,S,$]})],P);export{P as EditionSectionDetailModule};
