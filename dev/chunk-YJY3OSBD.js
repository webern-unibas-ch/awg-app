import{a as H}from"./chunk-Q6ZJQFP2.js";import"./chunk-LYPDAJVV.js";import{a as P}from"./chunk-GYSG6DRK.js";import{b as F}from"./chunk-ILHZIR7A.js";import"./chunk-3F66QUQP.js";import{a as G}from"./chunk-VN7P4TW3.js";import{i as R,n as M}from"./chunk-VKC2S7ZN.js";import{F as U,U as $}from"./chunk-FH23T4AB.js";import{b as B,e as q,i as E}from"./chunk-52VTQMTE.js";import"./chunk-CLQGIUYW.js";import"./chunk-F7JNA3LG.js";import"./chunk-BFYBHFBC.js";import{B as y,Ua as a,W as S,Wa as o,Xa as c,Y as L,Za as f,bb as O,da as s,gb as N,k as x,ka as u,kb as D,na as T,o as i,xa as d}from"./chunk-3W5OIA63.js";var j=`@if (introBlockContent) {
...
`;var W=`.awg-edition-intro-nav{position:sticky;top:0}.awg-edition-intro-nav .nav .nav-item{text-align:end}.awg-edition-intro-nav .nav .nav-item a.active{color:#000}.awg-edition-intro-nav .nav .nav-item .nav-link{padding-right:0}
`;var b=class{constructor(){this.selectedLanguage=N.required()}static{this.propDecorators={introBlockContent:[{type:o}],notesLabel:[{type:o}],selectedLanguage:[{type:o,args:[{isSignal:!0,alias:"selectedLanguage",required:!0}]},{type:c,args:["selectedLanguageChange"]}]}}};b=i([a({selector:"awg-edition-intro-nav",template:V,changeDetection:d.OnPush,standalone:!1,styles:[W]})],b);var z=`<div class="p-3 border rounded-3 text-center awg-edition-intro-partial-disclaimer">
...
`;var Y="";var v=class{static{this.propDecorators={editionComplex:[{type:o}],editionLabel:[{type:o}],editionRoute:[{type:o}],seriesRoute:[{type:o}],sectionRoute:[{type:o}],introRoute:[{type:o}]}}};v=i([a({selector:"awg-edition-intro-partial-disclaimer",template:z,standalone:!1,styles:[Y]})],v);var Z=`<div class="awg-edition-intro-placeholder">
...
`;var J="";var _=class{static{this.propDecorators={editionComplex:[{type:o}],editionLabel:[{type:o}]}}};_=i([a({selector:"awg-edition-intro-placeholder",template:Z,changeDetection:d.OnPush,standalone:!1,styles:[J]})],_);var K=`<!-- content: intro -->
<div>
    <!-- modal -->
    <awg-modal #modal />
...
`;var Q="";var h=class{constructor(){this._editionOutlineService=s(F),this._editionStateService=s($),this._editionViewService=s(H),this._router=s(q),this._destroyed$=new x,this.UTILS=P,this.selectedEditionComplex=this._editionStateService.selectedEditionComplex,this.viewData=this._editionViewService.introViewData,this.selectedLanguage=T(R.DE),this.notesSectionLabel=O(()=>this.selectedLanguage()===R.DE?"Anmerkungen":"Notes"),this._initScrollListener()}get editionRouteConstants(){return U}ngOnInit(){this.listenToRouteChanges()}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}listenToRouteChanges(){this._router.events.pipe(S(this._destroyed$)).subscribe(t=>{if(this._isNavigationEndToIntro(t)){let{seriesId:e,sectionId:n}=this._extractUrlSegments(t.urlAfterRedirects);e&&n?this._updateEditionState(e,n):console.error("Invalid URL segments:",t.urlAfterRedirects)}})}onIntroFragmentNavigate(t){let e={fragment:t?.fragmentId??""};this._router.navigate([],e)}onModalOpen(t){t&&this.modal.open(t)}onReportFragmentNavigate(t){let e=this.editionRouteConstants.EDITION_REPORT.route,n={fragment:t?.fragmentId??""};this._navigateWithComplexId(t?.complexId,e,n)}onSvgSheetSelect(t){let e=this.editionRouteConstants.EDITION_SHEETS.route,n={queryParams:{id:t?.sheetId??""}};this._navigateWithComplexId(t?.complexId,e,n)}_extractUrlSegments(t){if(!t)return{seriesId:void 0,sectionId:void 0};let e=t.split("/"),n=e.indexOf("series")+1,l=e.indexOf("section")+1,p=e[n],r=e[l],C=m=>m!==void 0&&/^[1-3]$/.test(m),k=m=>m!==void 0&&/^[1-5]+[ab]?$/.test(m);return{seriesId:C(p)?p:void 0,sectionId:k(r)?r:void 0}}_initScrollListener(){y(globalThis,"scroll").pipe(L(200),S(this._destroyed$)).subscribe({next:t=>this._onIntroScroll(t)})}_isNavigationEndToIntro(t){return t instanceof B&&t.urlAfterRedirects?.includes("intro")}_navigateWithComplexId(t,e,n){let l=t?`/edition/complex/${t}`:this.selectedEditionComplex()?.baseRoute??"/edition/series";this._router.navigate([l,e],n)}_onIntroScroll(t){if(t?.type==="scroll"){let e=globalThis.scrollY||document.documentElement.scrollTop,n=document.querySelectorAll(".awg-edition-intro-section"),l=document.querySelectorAll("a.awg-edition-intro-nav-link"),p=null;n.forEach(r=>{let C=r.offsetTop-10,k=r.offsetTop+r.offsetHeight;C<=e&&k>e&&(p=r.id)}),l.forEach(r=>{r.classList.toggle("active",r.hash.includes(p))})}}_updateEditionState(t,e){let n=this._editionOutlineService.getEditionSeriesById(t)??null,l=this._editionOutlineService.getEditionSectionById(t,e)??null;this._editionStateService.updateSelectedEditionSeries(n),this._editionStateService.updateSelectedEditionSection(l)}static{this.ctorParameters=()=>[]}static{this.propDecorators={modal:[{type:D,args:["modal",{static:!0}]}]}}};h=i([a({selector:"awg-edition-intro",template:K,changeDetection:d.OnPush,standalone:!1,styles:[Q]})],h);var gt=[{path:"",component:h,data:{title:"AWG Online Edition \u2013 Intro"}}],X=[h],I=class{};I=i([f({imports:[E.forChild(gt)],exports:[E]})],I);var tt=class{};tt=i([f({imports:[M,I],declarations:[w,b,v,_,X]})],tt);export{tt as EditionIntroModule};
