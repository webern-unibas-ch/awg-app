import{b as t,s as c}from"./chunk-OBTV6KD4.js";import{a as u}from"./chunk-TAW2325W.js";import"./chunk-WXC5S4UM.js";import{Ba as m,Ca as e,I as o,Ra as p,T as s,Z as d,tb as h}from"./chunk-VFHTK4A5.js";var b=`<!-- sideinfo: contact -->
<div class="card">
...
`;var f="";var a,i=(a=class{constructor(l,S){this.coreService=l,this.sanitizer=S,this.contactInfoHeader="Kontakt"}ngOnInit(){this.provideMetaData(),this.provideOSMUrls()}provideMetaData(){this.pageMetaData=this.coreService.getMetaDataSection(t.page),this.contactMetaData=this.coreService.getMetaDataSection(t.contact)}provideOSMUrls(){this.osmEmbedUrl=this.sanitizer.bypassSecurityTrustResourceUrl(u.UNSAFE_OSM_EMBED_URL),this.osmLinkUrl=u.OSM_LINK_URL}},a.ctorParameters=()=>[{type:c},{type:m}],a);i=e([s({selector:"awg-contact-info",template:b,changeDetection:o.OnPush,styles:[f]})],i);var w=`<!-- content: contact -->
...
`;var D=`.awg-contact-view{text-align:justify;text-justify:inter-word}
`;var n,r=(n=class{constructor(l){this.coreService=l,this.imprintTitle="Impressum",this.imprintId="awg-imprint",this.citationTitle="Zitation",this.citationId="awg-citation",this.documentationTitle="Dokumentation",this.documentationId="awg-documentation",this.dateFormat="d. MMMM yyyy"}ngOnInit(){this.provideMetaData(),this.today=Date.now()}provideMetaData(){this.pageMetaData=this.coreService.getMetaDataSection(t.page),this.contactMetaData=this.coreService.getMetaDataSection(t.contact)}},n.ctorParameters=()=>[{type:c}],n);r=e([s({selector:"awg-contact-view",template:w,changeDetection:o.Default,styles:[D]})],r);var P=[{path:"",component:r,data:{title:"AWG Online Edition \u2013 Contact"}},{path:"",outlet:"side",component:i}],v=[r,i],g=class{};g=e([d({imports:[p.forChild(P)],exports:[p]})],g);var M=class{};M=e([d({imports:[h,g],declarations:[v]})],M);export{M as ContactViewModule};
