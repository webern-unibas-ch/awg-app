import{B as q,D as U,M,S as G,T as A,W}from"./chunk-JKUPQWBX.js";import{d as T,e as N}from"./chunk-QBNLAATV.js";import{c as f,m as X}from"./chunk-W2UYZXHE.js";import"./chunk-RGAHEKRW.js";import{Aa as i,Db as a,ea as O,o as r,pb as o,qa as L,rb as s,ya as I,zb as m}from"./chunk-HOFVETHS.js";var V=`@if (statisticsData(); as statisticsData) {
...
`;var u=class{constructor(t={}){this.opus=t.opus??0,this.mnr=t.mnr??0,this.mnrX=t.mnrX??0}},b=class{constructor(){this.totalComplexes=0,this.activeComplexes=0,this.progressRate=0,this.complexBreakdown=new u,this.activeComplexBreakdown=new u}registerComplex(t,e){this.totalComplexes++,this.complexBreakdown[t]++,e&&(this.activeComplexes++,this.activeComplexBreakdown[t]++)}},v=class extends b{constructor(t,e){super(),this.section=t,this.disabled=e}},C=class extends b{constructor(t){super(),this.totalSections=0,this.activeSections=0,this.sectionBreakdown=[],this.series=t}},y=class extends b{constructor(){super(),this.totalSeries=0,this.activeSeries=0,this.totalSections=0,this.activeSections=0,this.seriesBreakdown=[]}};var x=class{getStatisticsFromOutline(t){let e=new y;t.forEach(n=>{e.totalSeries++;let l=new C(n.series.short);n.sections.forEach(g=>{e.totalSections++,l.totalSections++;let h=new v(g.section.short,g.disabled);g.disabled||(e.activeSections++,l.activeSections++),this._processComplexes(e,l,h,g.content.complexTypes),h.progressRate=this._calculateProgressRate(h.activeComplexes,h.totalComplexes),l.sectionBreakdown.push(h)}),(l.activeSections>0||l.activeComplexes>0)&&e.activeSeries++;let P=l.sectionBreakdown.map(g=>g.progressRate);l.progressRate=this._calculateCombinedProgressRate(P),e.seriesBreakdown.push(l)});let c=e.seriesBreakdown.map(n=>n.progressRate);return e.progressRate=this._calculateCombinedProgressRate(c),e}_calculateProgressRate(t,e){return e>0?Math.round(t/e*100):0}_calculateCombinedProgressRate(t){if(!t.length)return 0;let e=t.reduce((c,n)=>c+n,0);return Math.round(e/t.length)}_incrementComplexCounters(t,e,c){t.forEach(n=>n.registerComplex(e,c))}_isMnrX(t){let e=t?.complex?.complexId?.route;return typeof e=="string"&&e.startsWith("/mx")}_processComplexes(t,e,c,n){n&&(n.opus?.forEach(l=>{this._incrementComplexCounters([t,e,c],"opus",!l.disabled)}),n.mnr?.forEach(l=>{let P=this._isMnrX(l)?"mnrX":"mnr";this._incrementComplexCounters([t,e,c],P,!l.disabled)}))}};x=r([I({providedIn:"root"})],x);var j=`<div class="row mb-4">
    <div class="col-md-6">
