import{a as we,e as Ce}from"./chunk-OWEW2MD4.js";import{b as O}from"./chunk-ZPZUAYFD.js";import{a as _e}from"./chunk-2G5ECTRL.js";import"./chunk-HNTD4QJZ.js";import{a as f}from"./chunk-GYSG6DRK.js";import{d as me,e as ue,f as fe}from"./chunk-57ATL23E.js";import{g as P}from"./chunk-3F66QUQP.js";import{h as ce,n as S}from"./chunk-6347MYB4.js";import{K as $,L as he,P as ge,S as pe,T as ve,U as Se,b as ie}from"./chunk-7T2EW5XL.js";import{c as te,e as se,i as V}from"./chunk-YXTFIJMG.js";import"./chunk-D5RS63QN.js";import{g as oe,q as ne,r as re,u as ae,w as le,x as de}from"./chunk-CPI4SSX3.js";import"./chunk-65SSBV63.js";import{K as Z,Ua as d,W as Y,Wa as l,Xa as a,Ya as J,Za as p,a as U,b as H,da as v,g as j,k as N,ka as r,kb as u,mb as ee,na as X,o as n,oa as Q,va as K,xa as g}from"./chunk-CE57Q5C6.js";var ye=`<h6 class="card-title">
    {{ facetItemLabel }}:
...
`;var w=class{constructor(){this.selectSvgSheetRequest=new r,this.UTILS=f}isSelectedSvgSheet(e,t){let s=e,i=this.selectedSvgSheet?.id;return t&&this.selectedSvgSheet?.content?.[0]?.partial&&(s+=t,i+=this.selectedSvgSheet.content[0].partial),s===i}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={facetItemLabel:[{type:l}],svgSheets:[{type:l}],selectedSvgSheet:[{type:l}],selectSvgSheetRequest:[{type:a}]}}};w=n([d({selector:"awg-edition-svg-sheet-facet-item",template:ye,changeDetection:g.OnPush,standalone:!1,styles:[be]})],w);var xe=`@if (svgSheetsData) {
...
`;var ke="";var C=class{constructor(){this.isMinimized=!1,this.selectSvgSheetRequest=new r,this.toggleSheetFacetRequest=new r,this.faAnglesLeft=le,this.faListUl=de}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleSheetFacet(){this.toggleSheetFacetRequest.emit(!this.isMinimized)}static{this.propDecorators={isMinimized:[{type:l}],svgSheetsData:[{type:l}],selectedSvgSheet:[{type:l}],selectSvgSheetRequest:[{type:a}],toggleSheetFacetRequest:[{type:a}]}}};C=n([d({selector:"awg-edition-svg-sheet-facet",template:xe,changeDetection:g.OnPush,standalone:!1,styles:[ke]})],C);var I=class{};I=n([p({imports:[S],declarations:[C,w],exports:[C,w]})],I);var Re=`<div class="awg-edition-svg-sheet-footer mt-4">
...
`;var Ee="";var y=class{constructor(){this.navigateToReportFragmentRequest=new r,this.openModalRequest=new r,this.selectSvgSheetRequest=new r,this.UTILS=f,this.faChevronRight=oe,this.faChevronDown=ne,this.ref=this,this.showEvaluation=!1}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleEvaluation(){this.showEvaluation=!this.showEvaluation}static{this.propDecorators={selectedTextcriticalCommentary:[{type:l}],selectedTextcritics:[{type:l}],showTkA:[{type:l}],navigateToReportFragmentRequest:[{type:a}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]}}};y=n([d({selector:"awg-edition-svg-sheet-footer",template:Re,changeDetection:g.OnPush,standalone:!1,styles:[Ee]})],y);var F=class{};F=n([p({imports:[S,O],declarations:[y],exports:[y]})],F);var Te=`<div class="awg-edition-svg-sheet-viewer-nav">
...
`;var Ge="";var E=class{constructor(){this.openModalRequest=new r,this.selectSvgSheetRequest=new r,this.faSquare=ae,this.folioLegends=[{colorClass:"olivedrab",label:"aktuell ausgew\xE4hlt"},{colorClass:"orange",label:"ausw\xE4hlbar"},{colorClass:"grey",label:"(momentan noch) nicht ausw\xE4hlbar"}]}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={selectedConvolute:[{type:l}],selectedSvgSheet:[{type:l}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]}}};E=n([d({selector:"awg-edition-convolute",template:De,changeDetection:g.OnPush,standalone:!1,styles:[Ge]})],E);var ze=`<!-- embedded svg: Edition Folio Viewer -->
...
`;var M=class{constructor(){this._bgColor="#a3a3a3",this._disabledColor="grey",this._fgColor="orange",this._contentSegmentFillColor="#eeeeee",this._contentSegmentFontFamily="Source Sans Pro, source-sans-pro, sans-serif",this._contentSegmentFontSize="11px",this._contentSegmentOffsetCorrection=4,this._contentSegmentStrokeWidth=2,this._defaultNumberOfSystems=18,this._reversedRotationAngle=180,this._sheetFillColor="white",this._sheetStrokeWidth=1,this._systemsLineStrokeWidth=.7}getFolioSvgData(e,t){let s=new pe(e,t,this._contentSegmentOffsetCorrection);return new ve(s)}addViewBoxToSvgCanvas(e,t){e.attr("viewBox",t.viewBox).attr("width",t.svgWidth).attr("height",t.svgHeight).attr("version","1.1").attr("xmlns","https://www.w3.org/2000/svg").attr("xlink","https://www.w3.org/1999/xlink").attr("preserveAspectRatio","xMinYMin meet")}addFolioToSvgCanvas(e,t,s){this.ref=s;let i=this._appendCanvasSheetGroup(e,t.sheet.folioId);this._addFolioSheetToSvgCanvas(i,t),this._addFolioSystemsToSvgCanvas(i,t),this._addFolioContentSegmentsToSvgCanvas(i,t)}_addFolioSheetToSvgCanvas(e,t){let{sheet:s}=t,{folioId:i,sheetRectangle:o,trademarkRectangle:c}=s;this._appendSheetGroupSheetTitle(e,i),this._appendSheetGroupSheetRectangle(e,o),c&&this._appendSheetGroupTrademark(e,c,i,t.systems.systemsReversed)}_addFolioSystemsToSvgCanvas(e,t){t.systems.systemsLines.forEach((s,i)=>{let o=t.systems.systemsReversed?t.systems.systemsLines.length-i:i+1,c=t.systems.systemsLabelPositions[i],m=this._appendSvgElementWithAttrs(e,"g",{systemsGroupId:o,class:"systems-group"}),_=this._appendSvgElementWithAttrs(m,"g",{systemLineGroupId:o,class:"system-line-group"});this._appendSystemsGroupLabel(m,c,o),this._appendSystemsGroupLines(_,s)})}_addFolioContentSegmentsToSvgCanvas(e,t){t?.contentSegments?.forEach(s=>{if(!s)return;let i=this._appendContentSegmentGroup(e,s),o=this._appendContentSegmentLink(i);this._appendContentSegmentLinkPolygon(o,s.segmentVertices,t.systems.systemsLines.length),this._appendContentSegmentLinkLabel(o,s)})}_appendCanvasSheetGroup(e,t){return this._appendSvgElementWithAttrs(e,"g",{sheetGroupId:t,class:"sheet-group"})}_appendContentSegmentGroup(e,t){let s=this._appendContentSegmentGroupElement(e,t);return this._appendContentSegmentGroupTitle(s,t),s.on("click",()=>t.selectable?this.ref.selectSvgSheet({complexId:t.complexId,sheetId:t.sheetId}):this.ref.openModal(t.linkTo)),s}_appendContentSegmentGroupElement(e,t){return this._appendSvgElementWithAttrs(e,"g",{contentSegmentGroupId:t.segmentLabel,contentSegmentId:t.sheetId,class:"content-segment-group",stroke:t.selectable?this._fgColor:this._disabledColor,fill:t.selectable?this._fgColor:this._disabledColor})}_appendContentSegmentGroupTitle(e,t){return this._appendSvgElementWithAttrs(e,"title",{}).text(t.segmentLabel)}_appendContentSegmentLink(e){return this._appendSvgElementWithAttrs(e,"a",{class:"content-segment-link"})}_appendContentSegmentLinkLabel(e,t){let s=this._appendContentSegmentLinkLabelTextElement(e,t.centeredXPosition,t.centeredYPosition);return this._appendContentSegmentLinkLabelTspanElements(s,t),t.segmentReversed&&s.attr("transform",`rotate(${this._reversedRotationAngle}, ${t.centeredXPosition}, ${t.centeredYPosition})`),s}_appendContentSegmentLinkLabelTextElement(e,t,s){let i={class:"content-segment-label",x:t,y:s};return i["font-family"]=this._contentSegmentFontFamily,i["dominant-baseline"]="middle",i["text-anchor"]="middle",this._appendSvgElementWithAttrs(e,"text",i).style("font-size",this._contentSegmentFontSize)}_appendContentSegmentLinkLabelTspanElements(e,t){t.segmentLabelArray.forEach((s,i)=>{if(s!==""){let o={};i>0&&(o.x=t.centeredXPosition,o.y=t.centeredYPosition,o.dy="1.2em",o["text-anchor"]="middle"),this._appendSvgElementWithAttrs(e,"tspan",o).text(s)}})}_appendContentSegmentLinkPolygon(e,t,s=this._defaultNumberOfSystems){let i=this._contentSegmentStrokeWidth*(this._defaultNumberOfSystems/s),o={class:"content-segment-shape",points:t,fill:this._contentSegmentFillColor};return o["stroke-width"]=i,this._appendSvgElementWithAttrs(e,"polygon",o)}_appendSheetGroupSheetRectangle(e,t){let{x:s,y:i}=t.UPPER_LEFT_CORNER,{x:o,y:c}=t.LOWER_RIGHT_CORNER,m={x:s,y:i,width:o-s,height:c-i,fill:this._sheetFillColor,stroke:this._bgColor};return m["stroke-width"]=this._sheetStrokeWidth,this._appendSvgElementWithAttrs(e,"rect",m)}_appendSheetGroupSheetTitle(e,t){this._appendSvgElementWithAttrs(e,"title",{class:"sheet-group-title"}).text(`Bl. ${t}`)}_appendSheetGroupTrademark(e,t,s,i){let o=this._appendSheetGroupTrademarkGroup(e,s);this._appendSheetGroupTrademarkRectangle(o,t),this._appendSheetGroupTrademarkSymbol(o,t,i),this._appendSheetGroupTrademarkTitle(o)}_appendSheetGroupTrademarkGroup(e,t){return this._appendSvgElementWithAttrs(e,"g",{trademarkGroupId:t,class:"trademark-group"})}_appendSheetGroupTrademarkRectangle(e,t){let{x:s,y:i}=t.UPPER_LEFT_CORNER,{x:o,y:c}=t.LOWER_RIGHT_CORNER,m={class:"trademark-rectangle",x:s,y:i,width:o-s,height:c-i,fill:this._sheetFillColor,stroke:this._bgColor};return m["stroke-width"]=this._sheetStrokeWidth,this._appendSvgElementWithAttrs(e,"rect",m)}_appendSheetGroupTrademarkSymbol(e,t,s){let{x:i,y:o}=t.UPPER_LEFT_CORNER,{x:c,y:m}=t.LOWER_RIGHT_CORNER,_=(i+c)/2,Be=(o+m)/2,Ue="M 10 39 Q 12 36 14 39 T 18 39 Q 20 36 22 39 T 26 39 Q 28 36 30 39 T 34 39 M 10 43 T 34 43 M 14 31 L 15 30 L 17 30 L 15 26 L 17 23 L 22 23 L 18 31 L 14 31 M 20 31 L 21 30 L 23 30 L 21 26 L 22 23 L 27 23 L 24 31 L 20 31 M 14 17 L 18 15 L 21 14 L 22 15 L 21 17 L 18 17 L 14 19 M 13 15 L 14 17 L 14 19 L 13 19 L 13 19 L 12 19 L 13 18 L 12 18 L 13 17 L 12 17 L 13 15 M 17 23 L 20 20 L 21 17 L 22 15 L 25 15 L 27 23 M 26 24 L 30 20 L 30 17 L 29 18 L 28 18 L 28 17 L 30 15 L 31 17 L 31 21 L 26 25 M 25 15 L 27 14 L 26 13 L 27 12 L 26 11 L 27 10 L 26 9 L 27 8 L 26 7 L 25 8 L 24 7 L 23 8 L 22 7 L 21 8 L 20 7 L 19 8 L 18 9 L 19 9 L 21 10 L 18 11 L 20 12 L 18 13 L 21 14 L 22 15",W=`translate(${_-10}, ${Be-10}) scale(0.5)`;s&&(W+=` rotate(${this._reversedRotationAngle}, 20, 20)`);let B={class:"trademark-symbol",d:Ue,fill:this._disabledColor,stroke:this._disabledColor,transform:W};return B["stroke-width"]=this._contentSegmentStrokeWidth,this._appendSvgElementWithAttrs(e,"path",B)}_appendSheetGroupTrademarkTitle(e){this._appendSvgElementWithAttrs(e,"title",{class:"trademark-title"}).text("Firmenzeichen")}_appendSystemsGroupLabel(e,t,s){let i={class:"system-label",x:t.x,y:t.y,fill:this._bgColor};i["dominant-baseline"]="hanging",this._appendSvgElementWithAttrs(e,"text",i).text(s)}_appendSystemsGroupLines(e,t){t.forEach(s=>{let{x:i,y:o}=s.START_POINT,{x:c,y:m}=s.END_POINT,_={class:"system-line",x1:i,y1:o,x2:c,y2:m,stroke:this._bgColor};_["stroke-width"]=this._systemsLineStrokeWidth,this._appendSvgElementWithAttrs(e,"line",_)})}_appendSvgElementWithAttrs(e,t,s){let i=e.append(t);return Object.keys(s).forEach(o=>{i.attr(o,s[o])}),i}};M=n([K({providedIn:"root"})],M);var T=class{constructor(){this._folioService=v(M),this.openModalRequest=new r,this.selectSvgSheetRequest=new r,this.canvasArray=[],this.folioSvgDataArray=[],this.viewBoxArray=[],this.ref=this,this._folioSettings={factor:1.5,formatX:175,formatY:270,initialOffsetX:5,initialOffsetY:5,numberOfFolios:0}}ngOnChanges(e){e.selectedConvolute&&this.prepareFolioSvgOutput()}ngAfterViewChecked(){this.createSVGCanvas()}createSVGCanvas(){this.canvasArray=[],this.viewBoxArray.length===this.folioSvgDataArray.length&&(this.folioSvgDataArray.forEach((e,t)=>{let s=`#folio-${this.selectedSvgSheet.id}-${e.sheet.folioId}`,i=this._d3Select(s);i.empty()||(i.selectAll("*").remove(),this._folioService.addViewBoxToSvgCanvas(i,this.viewBoxArray[t]),this._folioService.addFolioToSvgCanvas(i,e,this.ref),this.canvasArray.push(i))}),this.toggleActiveClass())}isSelectedSvgSheet(e){let t=this.selectedSvgSheet?.content[0]?.partial||"";return e===`${this.selectedSvgSheet?.id}${t}`}openModal(e){e&&this.openModalRequest.emit(e)}prepareFolioSvgOutput(){this.folioSvgDataArray=[],this.viewBoxArray=[],this.selectedConvolute?.folios&&(this.folioSvgDataArray=this.selectedConvolute.folios.map(e=>{let t=H(U({},this._folioSettings),{formatX:+e.dimensions.width,formatY:+e.dimensions.height,numberOfFolios:this.selectedConvolute.folios.length}),s=this._calculateViewBoxDimension(t,"X"),i=this._calculateViewBoxDimension(t,"Y");return this.viewBoxArray.push(new Se(s,i)),this._folioService.getFolioSvgData(t,e)}))}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleActiveClass(){this.canvasArray&&this.canvasArray.forEach(e=>{e.selectAll(".content-segment-group").classed("active",(t,s,i)=>{let o=P(i[s]).attr("contentSegmentId");return this.isSelectedSvgSheet(o)})})}_calculateViewBoxDimension(e,t){let s=`format${t}`,i=`initialOffset${t}`;return(e[s]+2*e[i])*e.factor}_d3Select(e){return P(e)}static{this.propDecorators={selectedConvolute:[{type:l}],selectedSvgSheet:[{type:l}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]}}};T=n([d({selector:"awg-edition-folio-viewer",template:ze,changeDetection:g.OnPush,standalone:!1,styles:[Ne]})],T);var D=class{};D=n([p({imports:[S],declarations:[T],exports:[T]})],D);var G=class{};G=n([p({imports:[S,D],declarations:[E],exports:[E]})],G);var Ve=`<!-- content: edition detail -->
<div>
    <!-- modal -->
    <awg-modal #modal />
    @if (viewData(); as view) {
...
`;var $e="";var L=class{constructor(){this._editionSheetsService=v(me),this._route=v(te),this._router=v(se),this._queryParams=ie(this._route.queryParamMap,{initialValue:this._route.snapshot.queryParamMap}),this.isSheetFacetMinimized=!1,this.showTkA=!1,this.selectedEditionComplex=v(he).selectedEditionComplex,this.viewData=v(_e).sheetsViewData,this.isFirstPageLoad=X(!0),Q(()=>{let e=this._queryParams(),t=this.viewData().data.svgSheetsData;!this.selectedEditionComplex()||!t?.sheets||this._handleQueryParams(e,t)})}onBrowseSvgSheet(e){let t=this.viewData().data.svgSheetsData.sheets,s=this._editionSheetsService.getCurrentEditionType(this.selectedSvgSheet,t);if(!s)return;let i=t[s],o=this._editionSheetsService.getNextSheetId(e,this.selectedSvgSheet,i);this.onSvgSheetSelect({complexId:"",sheetId:o})}onLinkBoxSelect(e){if(!this.selectedSvgSheet||!this.selectedTextcritics?.linkBoxes)return;let t=this.selectedTextcritics.linkBoxes.find(s=>s.svgGroupId===e);if(t){let s=t.linkTo;this.onSvgSheetSelect(s)}}onOverlaySelect(e){this.selectedTextcriticalCommentary=this._editionSheetsService.filterTextcriticalCommentaryForOverlays(this.selectedTextcritics.commentary,e),this.showTkA=!f.isEmptyArray(this.selectedTextcriticalCommentary.comments)}onReportFragmentNavigate(e){let t=$.EDITION_REPORT.route,s={fragment:e?.fragmentId??""};this._navigateWithComplexId(e?.complexId,t,s)}onSvgSheetSelect(e){let t=$.EDITION_SHEETS.route,s={queryParams:{id:e?.sheetId??""},queryParamsHandling:"merge"};this._navigateWithComplexId(e?.complexId,t,s)}onToggleSheetFacet(e){this.isSheetFacetMinimized=e}_getDefaultSheetId(e){let t=e?.sheets,s=t?.textEditions?.[0]||t?.sketchEditions?.[0],i=s?.content?.[0]?.partial??"";return(s?.id||"")+i}_handleQueryParams(e,t){let s=e?.get("id");if(s&&t)this._selectSvgSheet(s);else{let i=this._getDefaultSheetId(t);i===""&&(this.selectedSvgSheet=void 0),this.onSvgSheetSelect({complexId:"",sheetId:i})}this.isFirstPageLoad()&&this.isFirstPageLoad.set(!1)}_navigateWithComplexId(e,t,s){let i=e?`/edition/complex/${e}`:this.selectedEditionComplex()?.baseRoute??"/edition/series";this._router.navigate([i,t],s)}_selectSvgSheet(e){if(!e)return;let t=this.viewData(),s=t.data.svgSheetsData.sheets,i=t.data.folioConvoluteData.convolutes,o=t.data.textcriticsData.textcritics;this.selectedSvgSheet=this._editionSheetsService.selectSvgSheetById(s,e),this.selectedConvolute=this._editionSheetsService.selectConvolute(i,s,this.selectedSvgSheet),this.selectedTextcritics=this._editionSheetsService.findTextcritics(o,this.selectedSvgSheet),this.onOverlaySelect([]),f.isEmptyObject(this.selectedTextcritics?.commentary)||(this.selectedTextcriticalCommentary=this.selectedTextcritics.commentary)}static{this.ctorParameters=()=>[]}static{this.propDecorators={modal:[{type:u,args:["modal",{static:!0}]}]}}};L=n([d({selector:"awg-edition-sheets",template:Ve,standalone:!1,styles:[$e]})],L);var gt=[{path:"",component:L,data:{title:"AWG Online Edition \u2013 Sheets"}}],Pe=[L],z=class{};z=n([p({imports:[V.forChild(gt)],exports:[V]})],z);var We=class{};We=n([p({imports:[S,q,G,z],declarations:[Pe]})],We);export{We as EditionSheetsModule};
