import{a as m}from"./chunk-PP6HJ337.js";import{Ab as D,Ba as x,D as i,Fb as d,Hb as s,J as C,M as o,O as v,R as _,db as N,ec as k,h as w,i as T,j as t,tb as n,v as a,ya as I,z as O}from"./chunk-RZNBUU2V.js";var y=`<!-- sideinfo: edition -->
<div class="card">
...
`;var W="";var f=class{constructor(){this.editionViewTitle="Editions\xFCbersicht",this.editionViewId="awg-edition-view",this._editionStateService=i(s)}get editionRouteConstants(){return n}ngOnInit(){this.setupEditionView()}setupEditionView(){this.selectedEditionSeries$=this._editionStateService.getSelectedEditionSeries().pipe(a(0)),this.selectedEditionSection$=this._editionStateService.getSelectedEditionSection().pipe(a(0)),this.selectedEditionComplex$=this._editionStateService.getSelectedEditionComplex().pipe(a(0)),this.isIntroView$=this._editionStateService.getIsIntroView().pipe(a(0)),this.isPrefaceView$=this._editionStateService.getIsPrefaceView().pipe(a(0)),this.isRowTableView$=this._editionStateService.getIsRowTableView().pipe(a(0))}};f=t([o({selector:"awg-edition-view",template:z,changeDetection:C.Eager,standalone:!1,styles:[W]})],f);var pe=[{path:"",outlet:"side",component:p},{path:"",component:f,children:[{path:"preface",loadChildren:()=>import("./chunk-3JEIN6X7.js").then(e=>e.EditionPrefaceModule)},{path:"row-tables",loadChildren:()=>import("./chunk-LP3LB6EF.js").then(e=>e.EditionRowTablesModule)},{path:"series",component:E},{path:"series/:id",component:h,children:[{path:"sections",component:g},{path:"section/:id",loadChildren:()=>import("./chunk-WID7VIL7.js").then(e=>e.EditionSectionDetailModule)},{path:"sections/:id",redirectTo:"section/:id",pathMatch:"full"},{path:"",redirectTo:"sections",pathMatch:"full"}]},{path:"composition",redirectTo:"complex",pathMatch:"prefix"},{path:"complex/:complexId",component:u,children:[{path:"",component:S,children:[{path:"intro",loadChildren:()=>import("./chunk-SA4XPTOF.js").then(e=>e.EditionIntroModule)},{path:"sheets",loadChildren:()=>import("./chunk-VDHPAPHN.js").then(e=>e.EditionSheetsModule)},{path:"report",loadChildren:()=>import("./chunk-KZTGMJO7.js").then(e=>e.EditionReportModule)},{path:"graph",loadChildren:()=>import("./chunk-CPEDKATZ.js").then(e=>e.EditionGraphModule)},{path:"",redirectTo:"sheets",pathMatch:"full"}]}]}]}],F=[f,u,S,p,g,E,h],b=class{};b=t([_({imports:[x.forChild(pe)],exports:[x]})],b);var J=`<div class="p-3 pt-4 text-center shadow border rounded-3 awg-jumbotron">
    <h3 id="{{ jumbotronId }}" [innerHTML]="jumbotronTitle"></h3>
</div>
`;var K="";var R=class{static{this.propDecorators={jumbotronId:[{type:v}],jumbotronTitle:[{type:v}]}}};R=t([o({selector:"awg-edition-jumbotron",template:J,changeDetection:C.OnPush,standalone:!1,styles:[K]})],R);var Q=class{};Q=t([_({imports:[k,b],declarations:[F,R]})],Q);export{Q as EditionViewModule};
