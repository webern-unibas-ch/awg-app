import{f as E}from"./chunk-UWVYQ7IF.js";import{a as v,m as C}from"./chunk-HF3BUGRU.js";import{c as x}from"./chunk-MTJY43OL.js";import"./chunk-EXYXHUYR.js";import{G as g,Ma as f,Oa as d,Q as h,R as u,X as a,k as m,l as n,ob as I,t as l,z as c}from"./chunk-KHOU7TSZ.js";var _=`<!-- content: intro -->
<div>
    <!-- modal -->
...
`;var i,r=(i=class{constructor(t,o,e,p){this.editionDataService=t,this.editionService=o,this.router=e,this.utils=p,this.errorObject=null,this.ref=this}get editionRouteConstants(){return x}ngOnInit(){this.getEditionIntroData()}getEditionIntroData(){this.editionIntroData$=this.editionService.getEditionComplex().pipe(c(t=>(this.editionComplex=t,this.editionDataService.getEditionIntroData(this.editionComplex))),l(t=>(this.errorObject=t,m)))}navigateToIntroFragment(t){let o=this.editionRouteConstants.EDITION_INTRO.route,e={fragment:t?.fragmentId??""};this._navigateWithComplexId(t?.complexId,o,e)}navigateToReportFragment(t){let o=this.editionRouteConstants.EDITION_REPORT.route,e={fragment:t?.fragmentId??""};this._navigateWithComplexId(t?.complexId,o,e)}openModal(t){t&&this.modal.open(t)}selectSvgSheet(t){let o=this.editionRouteConstants.EDITION_SHEETS.route,e={queryParams:{id:t?.sheetId??""}};this._navigateWithComplexId(t?.complexId,o,e)}_navigateWithComplexId(t,o,e){let p=t?`/edition/complex/${t}/`:this.editionComplex.baseRoute;this.router.navigate([p,o],e)}},i.ctorParameters=()=>[{type:v},{type:C},{type:f},{type:E}],i.propDecorators={modal:[{type:h,args:["modal",{static:!0}]}]},i);r=n([u({selector:"awg-intro",template:_,changeDetection:g.OnPush,styles:[R]})],r);var y=[{path:"",component:r,data:{title:"AWG Online Edition \u2013 Intro"}}],D=[r],s=class{};s=n([a({imports:[d.forChild(y)],exports:[d]})],s);var O=class{};O=n([a({imports:[I,s],declarations:[D]})],O);export{O as EditionIntroModule};
