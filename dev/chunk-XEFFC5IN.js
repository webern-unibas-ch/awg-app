import{j as W}from"./chunk-OD3IKSEP.js";import"./chunk-NRJBYYT3.js";import{b as F,e as G,i as N}from"./chunk-VLG7LXMJ.js";import{g as V}from"./chunk-R3T6RTQX.js";import{c as P,k as j,l as A,m as O,p as H}from"./chunk-AMPKBCZN.js";import"./chunk-O252IYCW.js";import"./chunk-DNAIPX3F.js";import{Aa as l,B as q,I as M,Ib as U,U as x,V as y,W as L,Y as $,a as E,b as R,ea as c,k as T,ma as g,o as i,pb as s,q as f,rb as n,sb as p,u as D,v as B,vb as b}from"./chunk-V7BW7F4C.js";var z=`@if (introBlockContent) {
...
`;var Q="";var v=class{static{this.propDecorators={editionComplex:[{type:n}],editionLabel:[{type:n}],editionRoute:[{type:n}],seriesRoute:[{type:n}],sectionRoute:[{type:n}],introRoute:[{type:n}]}}};v=i([s({selector:"awg-edition-intro-partial-disclaimer",template:K,standalone:!1,styles:[Q]})],v);var X=`<div class="awg-edition-intro-placeholder">
...
`;var tt="";var S=class{static{this.propDecorators={editionComplex:[{type:n}],editionLabel:[{type:n}]}}};S=i([s({selector:"awg-edition-intro-placeholder",template:X,changeDetection:l.OnPush,standalone:!1,styles:[tt]})],S);var et=`<!-- content: intro -->
<div>
    <!-- modal -->
    <awg-modal #modal />
