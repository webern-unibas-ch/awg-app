import{a as w}from"./chunk-QTPRRGQ3.js";import{D as h,Fb as S,H as r,La as $,M as t,Na as C,Nb as O,Pb as F,R as q,S as a,Tb as L,U as n,V as i,X as u,i as E,j as o,pb as m,qc as R,s as I,y as k}from"./chunk-ZX7OWNZS.js";var N=`<div class="awg-source-description-corrections">
...
`;var P="";var D=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.ref=this}get editionRouteConstants(){return S}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[{type:m}]}static{this.propDecorators={editionComplex:[{type:n}],sourceEvaluationListData:[{type:n}],navigateToReportFragmentRequest:[{type:i}],openModalRequest:[{type:i}],selectSvgSheetRequest:[{type:i}]}}};D=o([a({selector:"awg-source-evaluation",template:B,changeDetection:r.OnPush,styles:[P]})],D);var H=`<div class="card">
    <div class="card-body">
...
`;var Z="";var _=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.ref=this}isWorkEditionId(e){return e?e.includes("_WE"):!1}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[{type:m}]}static{this.propDecorators={textcriticsData:[{type:n}],navigateToReportFragmentRequest:[{type:i}],openModalRequest:[{type:i}],selectSvgSheetRequest:[{type:i}]}}};_=o([a({selector:"awg-textcritics-list",template:Q,changeDetection:r.OnPush,styles:[Z]})],_);var K=`<!-- content: edition report -->
<div>
    <!-- modal -->
