import{Ab as p,D as c,Ka as u,M as o,R as i,W as n,j as e,lb as d,nc as l}from"./chunk-XR4PMHGH.js";var m=`<!-- sideinfo: structure -->
<div class="card">
...
`;var g="";var t=class{constructor(){this.structureInfoHeader="Strukturmodell",this._coreService=c(p)}ngOnInit(){this.provideMetaData()}provideMetaData(){this.structureMetaData=this._coreService.getMetaDataSection(d.structure)}};t=e([i({selector:"awg-structure-info",template:m,changeDetection:o.OnPush,standalone:!1,styles:[g]})],t);var w=`<!-- content: structure -->
...
`;var f="";var r=class{constructor(){this.structureViewTitle="Datenstrukturmodell",this.structureViewId="awg-structure-view"}};r=e([i({selector:"awg-structure-view",template:w,changeDetection:o.Default,standalone:!1,styles:[f]})],r);var k=[{path:"",component:r,data:{title:"AWG Online Edition \u2013 Structure"}},{path:"",outlet:"side",component:t}],h=[r,t],s=class{};s=e([n({imports:[u.forChild(k)],exports:[u]})],s);var _=class{};_=e([n({imports:[l,s],declarations:[h]})],_);export{_ as StructureViewModule};
