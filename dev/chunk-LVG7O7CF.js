import{a as L}from"./chunk-D6EVQ2T7.js";import{a as we,e as Ce}from"./chunk-HU2EXHHV.js";import{$b as H,A as q,D as p,Gb as de,H as g,Hb as ce,Ib as _,Jb as he,K as J,Ka as ie,Kb as ge,La as se,Lb as ve,M as r,Mb as pe,Na as W,R as u,Rb as Se,S as c,Ta as oe,Tb as me,U as l,Ub as ue,V as a,Va as ne,W as ee,X as v,Ya as re,a as U,b as j,ca as te,cc as fe,db as ae,f as Z,h as C,i as X,j as n,jb as le,jc as _e,o as Y,qb as f,rc as S,s as Q,t as K,y as P,z as A}from"./chunk-XAENKJPP.js";var ye=`<div class="awg-edition-svg-sheet-footer mt-4">
...
`;var be="";var y=class{constructor(){this.navigateToReportFragmentRequest=new r,this.openModalRequest=new r,this.selectSvgSheetRequest=new r,this.faChevronRight=le,this.faChevronDown=ae,this.showEvaluation=!1,this.UTILS=p(f),this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleEvaluation(){this.showEvaluation=!this.showEvaluation}static{this.ctorParameters=()=>[]}static{this.propDecorators={selectedTextcriticalCommentBlocks:[{type:l}],selectedTextcritics:[{type:l}],showTkA:[{type:l}],navigateToReportFragmentRequest:[{type:a}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]}}};y=n([c({selector:"awg-edition-svg-sheet-footer",template:ye,changeDetection:g.OnPush,styles:[be]})],y);var F=class{};F=n([v({imports:[S,L],declarations:[y],exports:[y]})],F);var ke=`<h6 class="card-title">
    {{ navItemLabel }}:
...
`;var b=class{constructor(e){this.utils=e,this.selectSvgSheetRequest=new r,this.disclaimerWorkEditions="Werkeditionen sind aus rechtlichen Gr\xFCnden fr\xFChestens ab 2049 online verf\xFCgbar. Bis dahin konsultieren Sie bitte die entsprechende Printausgabe.",this.faCalendarXmark=re}isSelectedSvgSheet(e,t){let i=e,s=this.selectedSvgSheet?.id;return t&&this.selectedSvgSheet?.content?.[0]?.partial&&(i+=t,s+=this.selectedSvgSheet.content[0].partial),i===s}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[{type:f}]}static{this.propDecorators={navItemLabel:[{type:l}],svgSheets:[{type:l}],selectedSvgSheet:[{type:l}],selectSvgSheetRequest:[{type:a}]}}};b=n([c({selector:"awg-edition-svg-sheet-nav-item",template:ke,changeDetection:g.OnPush,styles:[xe]})],b);var Ee=`@if (svgSheetsData) {
...
`;var Re="";var k=class{constructor(){this.selectSvgSheetRequest=new r}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={svgSheetsData:[{type:l}],selectedSvgSheet:[{type:l}],selectSvgSheetRequest:[{type:a}]}}};k=n([c({selector:"awg-edition-svg-sheet-nav",template:Ee,changeDetection:g.OnPush,styles:[Re]})],k);var M=class{};M=n([v({imports:[S],declarations:[k,b],exports:[k,b]})],M);var Te=`<div class="awg-edition-svg-sheet-viewer-nav">
...
`;var Ge="";var O=class{constructor(){this.openModalRequest=new r,this.selectSvgSheetRequest=new r,this.faSquare=ne,this.folioLegends=[{color:"olivedrab",label:"aktuell ausgew\xE4hlt"},{color:"orange",label:"ausw\xE4hlbar"},{color:"grey",label:"(momentan noch) nicht ausw\xE4hlbar"}]}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={selectedConvolute:[{type:l}],selectedSvgSheet:[{type:l}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]}}};O=n([c({selector:"awg-edition-convolute",template:Me,changeDetection:g.OnPush,styles:[Ge]})],O);var Ne=`<!-- embedded svg: Edition Folio Viewer -->
