import{a as m}from"./chunk-JWQQJEPN.js";import{A as c,G as o,J as i,Ka as d,O as n,j as e,na as u,qb as p}from"./chunk-U6KVMW3K.js";var l=`<!-- sideinfo: structure -->
<div class="card">
...
`;var g="";var t=class{constructor(){this.structureInfoHeader="Strukturmodell",this._coreService=c(d)}ngOnInit(){this.provideMetaData()}provideMetaData(){this.structureMetaData=this._coreService.getMetaDataSection(m.structure)}};t=e([i({selector:"awg-structure-info",template:l,changeDetection:o.OnPush,standalone:!1,styles:[g]})],t);var w=`<!-- content: structure -->
...
`;var h="";var r=class{constructor(){this.structureViewTitle="Datenstrukturmodell",this.structureViewId="awg-structure-view"}};r=e([i({selector:"awg-structure-view",template:w,changeDetection:o.Eager,standalone:!1,styles:[h]})],r);var k=[{path:"",component:r,data:{title:"AWG Online Edition \u2013 Structure"}},{path:"",outlet:"side",component:t}],f=[r,t],s=class{};s=e([n({imports:[u.forChild(k)],exports:[u]})],s);var _=class{};_=e([n({imports:[p,s],declarations:[f]})],_);export{_ as StructureViewModule};
