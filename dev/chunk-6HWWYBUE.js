import{f as T}from"./chunk-NMY2ZX3B.js";import{w as y}from"./chunk-4SGEMXE3.js";import{G as m,L as i,R as p,T as r,U as a,X as S,a as b,b as R,l as o,ob as _}from"./chunk-L2YCISRN.js";var k=`@for (description of textcriticalDescriptions; track description) {
...
`;var v="";var n,d=(n=class{constructor(e){this.utils=e}},n.ctorParameters=()=>[{type:T}],n.propDecorators={id:[{type:r}],labelType:[{type:r}]},n);d=o([p({selector:"awg-edition-tka-label",template:w,changeDetection:m.OnPush,styles:[v]})],d);var x=`<table aria-label="Table for text-critical comments" class="table table-hover table-condensed awg-edition-tka-table">
    <thead>
        <tr>
