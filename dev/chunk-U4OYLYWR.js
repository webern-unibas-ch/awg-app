import{a as m,b as Ne}from"./chunk-MSTPLEVO.js";import{a as X}from"./chunk-PP6HJ337.js";import{C as Ke,D as Se,e as fe,g as J,h as ve,i as A,j as ye,k as y,l as ze,m as u,n as b,o as z,p as Oe,q as p,r as be,t as L,v as ke,w as qe,x as Xe,z as we}from"./chunk-Q4BTS5QO.js";import"./chunk-FQMMXNCW.js";import"./chunk-WBFAT3TC.js";import{A as ce,B as h,Ca as o,I as i,Ka as S,L as pe,La as de,N as l,Na as ue,Oa as D,Pa as _,Ra as De,T as s,Ta as Qe,V as n,W as c,Wa as Ae,Z as P,Za as Ye,a as Me,bb as We,gb as me,h as g,jb as Le,k as Ue,kb as Je,m as Pe,o as f,q as $e,qa as v,s as E,sb as ge,ta as he,u as Be,v as W,y as He}from"./chunk-LY2JR32L.js";var Ze=`<!-- resource detail header -->
...
`;var dt="";var G,se=(G=class{},G.propDecorators={resourceJsonConvertedData:[{type:n}]},G);se=o([s({selector:"awg-resource-detail-json-converted",template:ht,changeDetection:i.OnPush,styles:[dt]})],se);var ut=`<awg-json-viewer jsonViewerHeader="Raw JSON response from Salsah-API" [jsonViewerData]="resourceJsonRawData">
</awg-json-viewer>
`;var mt="";var F,ae=(F=class{},F.propDecorators={resourceJsonRawData:[{type:n}]},F);ae=o([s({selector:"awg-resource-detail-json-raw",template:ut,changeDetection:i.OnPush,styles:[mt]})],ae);var _e=class{};_e=o([P({imports:[ge],declarations:[K,Z,ee,te,re,oe,se,ae],exports:[K,Z,ee,te,re,oe,se,ae]})],_e);var gt=`@if (extendedSearchForm) {
