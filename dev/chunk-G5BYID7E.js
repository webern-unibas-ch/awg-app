import{a as b}from"./chunk-PXTMBCEM.js";import{f as y}from"./chunk-YUYFUGAS.js";import"./chunk-4J3S3ZBN.js";import{c as F,g as $}from"./chunk-UGCQOVP5.js";import{h as c}from"./chunk-J3RWQTZM.js";import{c as R,j as U,k as G,p as j}from"./chunk-XRI6PJCZ.js";import"./chunk-V3D5P7B2.js";import"./chunk-K5MLKCKT.js";import{Aa as n,I as O,Ib as N,V as A,ea as a,ma as t,n as L,o as i,pb as r,rb as s,sb as o,vb as d}from"./chunk-HJCNU5I5.js";var P=`<table class="awg-source-description-content-table half-para-margin" role="presentation">
...
`;var _=class{constructor(){this.UTILS=a(c),this.TRADEMARKS=U,this.ref=this}getTrademark(e){return e&&this.TRADEMARKS[e]?this.TRADEMARKS[e]:{route:"",full:"Not a known trademark.",short:"unknown"}}getItemLocus(e){if(!this.UTILS.isNotEmptyObject(e))return"";let l=m=>m.endsWith("v")||m.endsWith("r")?`${m.slice(0,-1)}<sup>${m.slice(-1)}</sup>`:m,u=m=>m.length===1?m[0].includes("all")?"auf allen Bl\xE4ttern":`auf Bl. ${m[0]}`:m.length>1?`auf Bl. ${m.slice(0,-1).join(", ")} und ${m.slice(-1)}`:"",f=e.folios.map(l),S=u(f),w=e.preFolioInfo?`${e.preFolioInfo} `:"",g=S?" ":"",pe=e.position?`${g}${e.position}`:"";return`${w}${S}${pe}`}getDimensions(e){let{orientation:l,height:u,width:f,unit:S}=e,w=g=>this.UTILS.isNotEmptyObject(g)?g.uncertainty?`${g.uncertainty} ${g.value}`:g.value:"";return`Format: ${l} ${w(u)} \xD7 ${w(f)} ${S}`}getSystems(e){return[`${e.totalSystems} ${e.totalSystems===1?"System":"Systeme"}`,e.totalSystemsAddendum&&` (${e.totalSystemsAddendum})`,e.additionalInfo&&`, ${e.additionalInfo}`].filter(Boolean).join("")}static{this.ctorParameters=()=>[]}static{this.propDecorators={writingMaterials:[{type:s}]}}};_=i([r({selector:"awg-source-description-writing-materials",template:V,changeDetection:n.OnPush,standalone:!1,styles:[Y]})],_);var J=`@if (sourceDescriptionListData) {
