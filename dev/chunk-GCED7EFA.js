import{a as ye,e as we}from"./chunk-4Q5EZP45.js";import{a as q}from"./chunk-GKTBLAPC.js";import{A as v,Aa as ae,C as r,Ca as le,F as ee,G as p,J as h,Ja as de,Ka as he,L as l,La as _,M as a,Ma as ce,N as te,Na as ge,O as S,Oa as pe,Pa as ve,R as u,T as se,Ta as Se,Wa as me,Xa as ue,a as j,b as Z,cb as H,f as Y,fb as fe,h as w,i as Q,j as n,jb as _e,ka as ie,kb as y,la as oe,na as W,o as X,ob as m,r as K,s as J,ta as ne,v as z,w as D,x as A,za as re}from"./chunk-J6GAQDBU.js";var Ce=`<div class="awg-edition-svg-sheet-footer mt-4">
...
`;var b=class{constructor(){this.selectSvgSheetRequest=new r,this.UTILS=v(y)}isSelectedSvgSheet(e,t){let s=e,i=this.selectedSvgSheet?.id;return t&&this.selectedSvgSheet?.content?.[0]?.partial&&(s+=t,i+=this.selectedSvgSheet.content[0].partial),s===i}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={navItemLabel:[{type:l}],svgSheets:[{type:l}],selectedSvgSheet:[{type:l}],selectSvgSheetRequest:[{type:a}]}}};b=n([h({selector:"awg-edition-svg-sheet-nav-item",template:ke,changeDetection:p.OnPush,standalone:!1,styles:[xe]})],b);var Re=`@if (svgSheetsData) {
...
`;var Fe="";var L=class{constructor(){this.openModalRequest=new r,this.selectSvgSheetRequest=new r,this.faSquare=le,this.folioLegends=[{color:"olivedrab",label:"aktuell ausgew\xE4hlt"},{color:"orange",label:"ausw\xE4hlbar"},{color:"grey",label:"(momentan noch) nicht ausw\xE4hlbar"}]}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={selectedConvolute:[{type:l}],selectedSvgSheet:[{type:l}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]}}};L=n([h({selector:"awg-edition-convolute",template:Me,changeDetection:p.OnPush,standalone:!1,styles:[Fe]})],L);var Ne=`<!-- embedded svg: Edition Folio Viewer -->
