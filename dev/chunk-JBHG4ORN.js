import{b as p,s as m}from"./chunk-D67VI4CF.js";import"./chunk-H7RGF2OO.js";import"./chunk-Q5BBFFUU.js";import{Da as e,F as c,J as o,Sa as a,U as i,_ as n,ub as d}from"./chunk-OIF6Z6X7.js";var l=`<!-- sideinfo: structure -->
<div class="card">
...
`;var g="";var t=class{constructor(){this.structureInfoHeader="Strukturmodell",this._coreService=c(m)}ngOnInit(){this.provideMetaData()}provideMetaData(){this.structureMetaData=this._coreService.getMetaDataSection(p.structure)}};t=e([i({selector:"awg-structure-info",template:l,changeDetection:o.OnPush,styles:[g]})],t);var w=`<!-- content: structure -->
...
`;var h="";var r=class{constructor(){this.structureViewTitle="Datenstrukturmodell",this.structureViewId="awg-structure-view"}};r=e([i({selector:"awg-structure-view",template:w,changeDetection:o.Default,styles:[h]})],r);var k=[{path:"",component:r,data:{title:"AWG Online Edition \u2013 Structure"}},{path:"",outlet:"side",component:t}],f=[r,t],s=class{};s=e([n({imports:[a.forChild(k)],exports:[a]})],s);var _=class{};_=e([n({imports:[d,s],declarations:[f]})],_);export{_ as StructureViewModule};
