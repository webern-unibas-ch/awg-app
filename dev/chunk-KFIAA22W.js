import{a as b}from"./chunk-OUGLOIUU.js";import{A as a,C as t,G as n,J as r,L as s,La as w,M as o,O as d,R as N,Sa as U,Ta as G,Xa as j,i as L,j as i,la as F,lb as c,na as $,pb as y,r as O,v as A}from"./chunk-7EBXDT3A.js";var P=`<table class="awg-source-description-content-table half-para-margin" role="presentation">
...
`;var Z="";var _=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={details:[{type:s}],detailsClass:[{type:s}],detailsLabel:[{type:s}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]}}};_=i([r({selector:"awg-source-description-details",template:Q,changeDetection:n.OnPush,standalone:!1,styles:[Z]})],_);var V=`<p class="awg-source-description-writing-materials">
