import{a as b}from"./chunk-KAS7ACXA.js";import{Cb as w,D as a,Ia as F,K as t,Ka as $,Lb as U,M as n,Mb as G,Q as N,Qb as j,R as r,T as s,U as o,W as d,i as L,j as i,mb as c,nc as y,s as O,y as A}from"./chunk-UQFSI72Y.js";var P=`<table class="awg-source-description-content-table half-para-margin" role="presentation">
...
`;var te="";var I=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.ref=this}get editionRouteConstants(){return w}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[{type:c}]}static{this.propDecorators={editionComplex:[{type:s}],sourceEvaluationListData:[{type:s}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]}}};I=i([r({selector:"awg-source-evaluation",template:ee,changeDetection:n.OnPush,standalone:!1,styles:[te]})],I);var oe=`<div class="card">
    <div class="card-body">
