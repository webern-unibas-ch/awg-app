import{a as Ce,e as be}from"./chunk-L5WGQ2K4.js";import{a as A}from"./chunk-Q5QGED7R.js";import{A as p,Aa as ae,C as r,Ca as le,Ea as de,F as ee,Fa as ce,G as g,J as c,L as l,La as he,M as a,Ma as ge,N as te,Na as _,O as v,Oa as pe,Pa as ve,Qa as Se,R as f,Ra as me,T as ie,Va as ue,Ya as fe,Za as _e,a as j,b as Z,eb as U,f as Y,h as w,hb as ye,i as Q,j as n,ka as se,la as oe,lb as we,mb as y,na as W,o as X,qb as m,r as K,s as J,ta as ne,v as P,w as D,x as F,za as re}from"./chunk-WHCF4VYZ.js";var ke=`<h6 class="card-title">
    {{ facetItemLabel }}:
...
`;var xe=`a#dropDownSheetFacet.btn{border:none!important}a#dropDownSheetFacet.active,a#dropDownSheetFacet:active{color:#149b9e!important}a#dropDownSheetFacet:hover{color:#333!important}a#dropDownSheetFacet>span{display:inline-block;white-space:break-spaces;text-align:start}
`;var C=class{constructor(){this.selectSvgSheetRequest=new r,this.UTILS=p(y)}isSelectedSvgSheet(e,t){let i=e,s=this.selectedSvgSheet?.id;return t&&this.selectedSvgSheet?.content?.[0]?.partial&&(i+=t,s+=this.selectedSvgSheet.content[0].partial),i===s}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={facetItemLabel:[{type:l}],svgSheets:[{type:l}],selectedSvgSheet:[{type:l}],selectSvgSheetRequest:[{type:a}]}}};C=n([c({selector:"awg-edition-svg-sheet-facet-item",template:ke,changeDetection:g.OnPush,standalone:!1,styles:[xe]})],C);var Re=`@if (svgSheetsData) {
...
`;var Ee="";var b=class{constructor(){this.isMinimized=!1,this.selectSvgSheetRequest=new r,this.toggleSheetFacetRequest=new r,this.faAnglesLeft=de,this.faListUl=ce}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleSheetFacet(){this.toggleSheetFacetRequest.emit(!this.isMinimized)}static{this.propDecorators={isMinimized:[{type:l}],svgSheetsData:[{type:l}],selectedSvgSheet:[{type:l}],selectSvgSheetRequest:[{type:a}],toggleSheetFacetRequest:[{type:a}]}}};b=n([c({selector:"awg-edition-svg-sheet-facet",template:Re,changeDetection:g.OnPush,standalone:!1,styles:[Ee]})],b);var q=class{};q=n([v({imports:[m],declarations:[b,C],exports:[b,C]})],q);var Te=`<div class="awg-edition-svg-sheet-footer mt-4">
...
`;var Le="";var k=class{constructor(){this.navigateToReportFragmentRequest=new r,this.openModalRequest=new r,this.selectSvgSheetRequest=new r,this.faChevronRight=ne,this.faChevronDown=re,this.showEvaluation=!1,this.UTILS=p(y),this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleEvaluation(){this.showEvaluation=!this.showEvaluation}static{this.ctorParameters=()=>[]}static{this.propDecorators={selectedTextcriticalCommentary:[{type:l}],selectedTextcritics:[{type:l}],showTkA:[{type:l}],navigateToReportFragmentRequest:[{type:a}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]}}};k=n([c({selector:"awg-edition-svg-sheet-footer",template:Te,changeDetection:g.OnPush,standalone:!1,styles:[Le]})],k);var M=class{};M=n([v({imports:[m,A],declarations:[k],exports:[k]})],M);var Oe=`<div class="awg-edition-svg-sheet-viewer-nav">
...
`;var x=class{constructor(){this.browseSvgSheetRequest=new r}browseSvgSheet(e){e&&this.browseSvgSheetRequest.emit(e)}static{this.propDecorators={browseSvgSheetRequest:[{type:a}]}}};x=n([c({selector:"awg-edition-svg-sheet-viewer-nav",template:Oe,changeDetection:g.OnPush,standalone:!1,styles:[Ie]})],x);var De=`<div class="card awg-edition-svg-sheet-viewer-settings float-none my-2">
...
`;var E=class{constructor(){this.browseSvgSheetRequest=new r,this.selectLinkBoxRequest=new r,this.selectOverlaysRequest=new r,this.faCompressArrowsAlt=ae,this.hasAvailableTkkOverlays=!1,this.sliderConfig=new Ce(1,.1,10,.01,1),this.suppliedClasses=new Map,this.svgSheetFilePath="",this._availableTkkOverlays=[],this._selectedTkkOverlays=[],this._isRendered=!1,this._destroyed$=new w,this._resize$=new w,this._cdr=p(ie),this._svgDrawingService=p(ye),this.ref=this}onResize(){!this.svgSheetSelection||!this.svgSheetRootGroupSelection||(this._getContainerDimensions(this.svgSheetContainerRef),this._resize$.next(!0))}ngOnChanges(e){e.selectedSvgSheet&&this._isRendered&&this.renderSheet()}ngAfterViewInit(){this._resize$.pipe(J(150),D(this._destroyed$)).subscribe(()=>{this.renderSheet()}),this.renderSheet(),this._isRendered=!0}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}browseSvgSheet(e){e&&this.browseSvgSheetRequest.emit(e)}onSuppliedClassesOpacityToggle(e){let{className:t,isCurrentlyVisible:i}=e;this._svgDrawingService.toggleSuppliedClassOpacity(this.svgSheetRootGroupSelection,t,i)}onTkkClassesHighlightToggle(e){this._svgDrawingService.getGroupsBySelector(this.svgSheetRootGroupSelection,"tkk").nodes().forEach(s=>{let o=this._getSvgGroupDataId(s),[d,S]=this._getOverlaysAndSelection(o,"tkk"),u=e?_.fill:_.transparent;this._svgDrawingService.updateTkkOverlayColor(d,S,u)})}onZoomChange(e){this.sliderConfig.value=e,this._rescaleZoom()}renderSheet(){this._clearSvg(),this._availableTkkOverlays=[],this._selectedTkkOverlays=[],this.svgSheetFilePath=this.selectedSvgSheet?.content?.[0].svg,this.svgSheetFilePath&&this._createSvg().then(()=>{this.resetZoom(),this._createSvgOverlays(),this._cdr.detectChanges()})}resetZoom(){!this.svgSheetSelection||!this.sliderConfig||(this.onZoomChange(this.sliderConfig.initial),this._resetZoomTranslation())}_clearSvg(){this.svgSheetRootGroupSelection?.selectAll("*").remove(),this.svgSheetSelection?.selectAll("*").remove()}_createSvg(){return Y(this,null,function*(){if(!this.svgSheetContainerRef){console.warn("No svg sheet container ref");return}this.svgSheetSelection=yield this._svgDrawingService.createSvg(this.svgSheetFilePath,this.svgSheetElementRef?.nativeElement,this.svgSheetRootGroupRef?.nativeElement),this.svgSheetRootGroupSelection=this.svgSheetSelection.select("#awg-edition-svg-sheet-root-group"),this._getContainerDimensions(this.svgSheetContainerRef),this._zoomHandler(this.svgSheetRootGroupSelection,this.svgSheetSelection)})}_createSvgOverlays(){this.svgSheetRootGroupSelection&&(this._createOverlays("link-box",this._createLinkBoxOverlay.bind(this)),this._createOverlays("tkk",this._createTkkOverlay.bind(this)),this.hasAvailableTkkOverlays=!!this._availableTkkOverlays&&this._availableTkkOverlays.length>0,this._getSuppliedClasses())}_createOverlays(e,t){let i=this._svgDrawingService.getGroupsBySelector(this.svgSheetRootGroupSelection,e);i&&(i.nodes().forEach(s=>{t(s,e)}),e==="tkk"&&this._createTkkOverlayHandlers(e))}_createLinkBoxOverlay(e){let t=e.id,i=this._svgDrawingService.getD3SelectionById(this.svgSheetRootGroupSelection,t),s=i.select("path");s.style("fill",this._svgDrawingService.linkBoxFillColor),i.on("mouseover",()=>{let o=this._svgDrawingService.linkBoxHoverFillColor;this._svgDrawingService.fillD3SelectionWithColor(s,o),i.style("cursor","pointer")}).on("mouseout",()=>{let o=this._svgDrawingService.linkBoxFillColor;this._svgDrawingService.fillD3SelectionWithColor(s,o)}).on("click",()=>{this._onLinkBoxSelect(t)})}_createTkkOverlay(e,t){let i=e.id,s=this._getSvgGroupDataId(e),o=e.getBBox();this._availableTkkOverlays.some(d=>d.id===i)||this._availableTkkOverlays.push(new pe(ge.tkk,i,s,!1)),this._svgDrawingService.createOverlayGroup(this.svgSheetRootGroupSelection,i,o,t)}_createTkkOverlayHandlers(e="tkk"){Array.from(new Set(this._availableTkkOverlays.map(i=>i.dataId))).forEach(i=>{let[s,o]=this._getOverlaysAndSelection(i,e);o.on("mouseover",()=>{this._svgDrawingService.updateTkkOverlayColor(s,o,_.hover),o.style("cursor","pointer")}).on("mouseout",()=>{this._svgDrawingService.updateTkkOverlayColor(s,o,_.fill)}).on("click",()=>{s.length>0&&s.forEach(d=>d.isSelected=!d.isSelected),this._svgDrawingService.updateTkkOverlayColor(s,o,_.hover),this._selectedTkkOverlays=this._getSelectedOverlays(this._availableTkkOverlays),this._onOverlaySelect(this._selectedTkkOverlays)})})}_getContainerDimensions(e){let t=this._svgDrawingService.getContainerDimensions(e);this._divWidth=this._divWidth?this._divWidth:t.width,this._divHeight=this._divHeight?this._divHeight:t.height}_getOverlaysById(e,t){return Array.isArray(e)?e.filter(i=>i.dataId===t):[]}_getOverlaysAndSelection(e,t){let i=this._getOverlaysById(this._availableTkkOverlays,e),s=this._svgDrawingService.getOverlayGroupRectSelection(this.svgSheetRootGroupSelection,e,t);return[i,s]}_getSelectedOverlays(e){return e.filter(t=>t.isSelected)}_getSuppliedClasses(){this.suppliedClasses=this._svgDrawingService.getSuppliedClasses(this.svgSheetRootGroupSelection)}_getSvgGroupDataId(e){return e.getAttribute("data-tkk-id")||e.id}_onLinkBoxSelect(e){e&&this.selectLinkBoxRequest.emit(e)}_onOverlaySelect(e){e&&this.selectOverlaysRequest.emit(e)}_rescaleZoom(){!this.svgSheetSelection||!this.sliderConfig.value||this._zoomBehaviour.scaleTo(this.svgSheetSelection,this.sliderConfig.value)}_resetZoomTranslation(){!this.svgSheetSelection||!this.svgSheetRootGroupSelection||this.svgSheetRootGroupSelection.attr("transform","translate(0,0)")}_roundToScaleStepDecimalPrecision(e){let t=this.sliderConfig.stepSize;return((o,d)=>+(Math.round(+(o+"e"+d))+"e-"+d))(e,(o=>Math.floor(o)===o?0:o.toString().split(".")[1].length)(t))}_zoomHandler(e,t){let i=s=>{let o=s.transform,d=this._roundToScaleStepDecimalPrecision(o.k);e.attr("transform",o),this.sliderInput?.nativeElement&&(this.sliderInput.nativeElement.value=d,this.sliderConfig.value=d),this.sliderInputLabel?.nativeElement&&(this.sliderInputLabel.nativeElement.innerText=d+"x")};this._zoomBehaviour=be().scaleExtent([this.sliderConfig.min,this.sliderConfig.max]).on("zoom",i),t.call(this._zoomBehaviour)}static{this.ctorParameters=()=>[]}static{this.propDecorators={svgSheetContainerRef:[{type:f,args:["svgSheetContainer"]}],svgSheetElementRef:[{type:f,args:["svgSheetElement"]}],svgSheetRootGroupRef:[{type:f,args:["svgSheetRootGroup"]}],sliderInput:[{type:f,args:["sliderInput"]}],sliderInputLabel:[{type:f,args:["sliderInputLabel"]}],selectedSvgSheet:[{type:l}],browseSvgSheetRequest:[{type:a}],selectLinkBoxRequest:[{type:a}],selectOverlaysRequest:[{type:a}],onResize:[{type:te,args:["window:resize"]}]}}};E=n([c({selector:"awg-edition-svg-sheet-viewer",template:Ae,changeDetection:g.OnPush,standalone:!1,styles:[qe]})],E);var G=class{};G=n([v({imports:[m,A],declarations:[E,x,R],exports:[E,x,R]})],G);var Me=`<div ngbAccordion #accoladeAcc [class.fullscreen]="isFullscreen">
...
`;var ze="";var L=class{constructor(){this.openModalRequest=new r,this.selectSvgSheetRequest=new r,this.faSquare=le,this.folioLegends=[{color:"olivedrab",label:"aktuell ausgew\xE4hlt"},{color:"orange",label:"ausw\xE4hlbar"},{color:"grey",label:"(momentan noch) nicht ausw\xE4hlbar"}]}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={selectedConvolute:[{type:l}],selectedSvgSheet:[{type:l}],openModalRequest:[{type:a}],selectSvgSheetRequest:[{type:a}]}}};L=n([c({selector:"awg-edition-convolute",template:Ne,changeDetection:g.OnPush,standalone:!1,styles:[ze]})],L);var $e=`<!-- embedded svg: Edition Folio Viewer -->
