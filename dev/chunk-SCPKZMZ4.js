import{D as p,K as o,M as n,Nb as d,R as l,T as t,U as r,W as g,a as b,b as u,j as a,mb as k,nc as y}from"./chunk-IYXGRRKH.js";var _=`@for (evaluation of evaluations; track $index) {
    <p class="awg-edition-tka-evaluation no-para-margin">
        <span [compile-html]="evaluation" [compile-html-ref]="ref"></span>
    </p>
}
`;var S="";var s=class{constructor(){this.navigateToReportFragmentRequest=new o,this.openModalRequest=new o,this.selectSvgSheetRequest=new o,this._editionGlyphService=p(d),this.ref=this}getGlyph(e){return this._editionGlyphService.getGlyph(e)}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={evaluations:[{type:t}],navigateToReportFragmentRequest:[{type:r}],openModalRequest:[{type:r}],selectSvgSheetRequest:[{type:r}]}}};s=a([l({selector:"awg-edition-tka-evaluations",template:_,changeDetection:n.OnPush,standalone:!1,styles:[S]})],s);var R=`@if (labelType === 'evaluation') {
