import{a as N,b as D}from"./chunk-O7ASY55U.js";import{a as F}from"./chunk-JE7RMLHP.js";import"./chunk-XDTEYFVV.js";import{a}from"./chunk-GYSG6DRK.js";import"./chunk-FXB3YGFA.js";import"./chunk-3F66QUQP.js";import{n as R}from"./chunk-KHHS2JBS.js";import{I as O,K as f,L as U}from"./chunk-D6YSIEZ4.js";import{e as A,i as $}from"./chunk-MOX5TMKG.js";import"./chunk-6JLQQCBE.js";import"./chunk-63PMSQ2Y.js";import"./chunk-UPEZC66X.js";import{Ua as r,Wa as i,Xa as o,Za as g,da as y,ka as t,kb as k,o as s,xa as n}from"./chunk-GVYLD4NV.js";var G=`<table class="awg-source-description-content-table half-para-margin" role="presentation">
...
`;var B=`.awg-source-description-content-table{margin-left:25px}
`;var b=class{constructor(){this.selectSvgSheetRequest=new t,this.UTILS=a,this.ref=this}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={content:[{type:i}],selectSvgSheetRequest:[{type:o}]}}};b=s([r({selector:"awg-source-description-content-table",template:G,changeDetection:n.OnPush,standalone:!1,styles:[B]})],b);var W=`<div class="awg-source-description-contents">
...
`;var _=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.UTILS=a,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={details:[{type:i}],detailsClass:[{type:i}],detailsLabel:[{type:i}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]}}};_=s([r({selector:"awg-source-description-details",template:z,changeDetection:n.OnPush,standalone:!1,styles:[K]})],_);var Q=`<p class="awg-source-description-writing-materials">
...
`;var J="";var v=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.UTILS=a,this.ref=this}getWritingInstruments(e){let c=e.secondary?.join(", ");return`${c?`${e.main}; ${c}`:e.main}.`}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.propDecorators={sourceDescriptionListData:[{type:i}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]}}};v=s([r({selector:"awg-source-description",template:Z,changeDetection:n.OnPush,standalone:!1,styles:[J]})],v);var I=class{};I=s([g({imports:[R,D],declarations:[v,T,b,C,_,x],exports:[v]})],I);var X=`@if (sourceEvaluationListData) {
...
`;var ne="";var h=class{constructor(){this._router=y(A),this.selectedEditionComplex=y(U).selectedEditionComplex,this.viewData=y(F).reportViewData,this.titles={sourceList:"1. Quellen\xFCbersicht",sourceDescription:"2. Quellenbeschreibung",sourceEvaluation:"3. Quellenbewertung",tka:"4. Textkritische Anmerkungen"}}onModalOpen(e){e&&this.modal.open(e)}onReportFragmentNavigate(e){let c=f.EDITION_REPORT.route,m={fragment:e?.fragmentId??""};this._navigateWithComplexId(e?.complexId,c,m)}onSvgSheetSelect(e){let c=f.EDITION_SHEETS.route,m={queryParams:{id:e?.sheetId??""}};this._navigateWithComplexId(e?.complexId,c,m)}_navigateWithComplexId(e,c,m){let d=e?`/edition/complex/${e}`:this.selectedEditionComplex()?.baseRoute??"/edition/series";this._router.navigate([d,c],m)}static{this.propDecorators={modal:[{type:k,args:["modal",{static:!0}]}]}}};h=s([r({selector:"awg-edition-report",template:ie,changeDetection:n.OnPush,standalone:!1,styles:[ne]})],h);var Ee=[{path:"",component:h,data:{title:"AWG Online Edition \u2013 Report"}}],re=[h],q=class{};q=s([g({imports:[$.forChild(Ee)],exports:[$]})],q);var ae=class{};ae=s([g({imports:[R,D,I,q],declarations:[M,E,L,re]})],ae);export{ae as EditionReportModule};
