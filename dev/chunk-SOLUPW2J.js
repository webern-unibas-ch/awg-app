import{a as b}from"./chunk-33SEHOXM.js";import{Cb as w,D as l,Ia as N,K as t,Ka as $,Lb as A,M as n,Mb as U,Q as F,Qb as G,R as a,T as s,U as o,W as g,i as q,j as i,mb as p,nc as y,s as L,y as O}from"./chunk-GEUMCV6T.js";var j=`<div class="awg-source-description-contents">
...
`;var D=class{constructor(){this.selectSvgSheetRequest=new t,this.UTILS=l(p),this.ref=this}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={contents:[{type:s}],selectSvgSheetRequest:[{type:o}]}}};D=i([a({selector:"awg-source-description-contents",template:j,changeDetection:n.OnPush,standalone:!1,styles:[P]})],D);var W=`<div class="awg-source-description-corrections">
...
`;var Q="";var x=class{constructor(){this.UTILS=l(p),this.TRADEMARKS=A,this.ref=this}getTrademark(e){return e&&this.TRADEMARKS[e]?this.TRADEMARKS[e]:{route:"",full:"Not a known trademark.",short:"unknown"}}getItemLocus(e){if(!this.UTILS.isNotEmptyObject(e))return"";let r=c=>c.endsWith("v")||c.endsWith("r")?`${c.slice(0,-1)}<sup>${c.slice(-1)}</sup>`:c,u=c=>c.length===1?c[0].includes("all")?"auf allen Bl\xE4ttern":`auf Bl. ${c[0]}`:c.length>1?`auf Bl. ${c.slice(0,-1).join(", ")} und ${c.slice(-1)}`:"",f=e.folios.map(r),S=u(f),R=e.preFolioInfo?`${e.preFolioInfo} `:"",d=S?" ":"",re=e.position?`${d}${e.position}`:"";return`${R}${S}${re}`}getDimensions(e){let{orientation:r,height:u,width:f,unit:S}=e,R=d=>this.UTILS.isNotEmptyObject(d)?d.uncertainty?`${d.uncertainty} ${d.value}`:d.value:"";return`Format: ${r} ${R(u)} \xD7 ${R(f)} ${S}`}getSystems(e){return[`${e.totalSystems} ${e.totalSystems===1?"System":"Systeme"}`,e.totalSystemsAddendum&&` (${e.totalSystemsAddendum})`,e.additionalInfo&&`, ${e.additionalInfo}`].filter(Boolean).join("")}static{this.ctorParameters=()=>[]}static{this.propDecorators={writingMaterials:[{type:s}]}}};x=i([a({selector:"awg-source-description-writing-materials",template:K,changeDetection:n.OnPush,standalone:!1,styles:[Q]})],x);var Z=`@if (sourceDescriptionListData) {
...
`;var I=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.ref=this}onSourceClick(e){e.hasDescription?this.navigateToReportFragment({complexId:"",fragmentId:e.linkTo}):this._openModal(e.linkTo)}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}_openModal(e){e&&this.openModalRequest.emit(e)}static{this.ctorParameters=()=>[{type:p}]}static{this.propDecorators={sourceListData:[{type:s}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}]}}};I=i([a({selector:"awg-source-list",template:X,changeDetection:n.OnPush,standalone:!1,styles:[ee]})],I);var te=`@if (textcriticsData) {
    <div ngbAccordion>
...
`;var oe="";var M=class{constructor(){this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.UTILS=l(p),this.ref=this}isWorkEditionId(e){return e?e.includes("_WE"):!1}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[]}static{this.propDecorators={textcriticsData:[{type:s}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]}}};M=i([a({selector:"awg-textcritics-list",template:te,changeDetection:n.OnPush,standalone:!1,styles:[oe]})],M);var ie=`<!-- content: edition report -->
<div>
    <!-- modal -->
...
`;var se="";var v=class{constructor(){this.errorObject=null,this.titles={sourceList:"1. Quellen\xFCbersicht",sourceDescription:"2. Quellenbeschreibung",sourceEvaluation:"3. Quellenbewertung",tka:"4. Textkritische Anmerkungen"},this._editionDataService=l(U),this._editionStateService=l(G),this._router=l(N)}get editionRouteConstants(){return w}ngOnInit(){this.getEditionReportData()}getEditionReportData(){this.editionReportData$=this._editionStateService.getSelectedEditionComplex().pipe(O(e=>(this.editionComplex=e,this._editionDataService.getEditionReportData(this.editionComplex))),L(e=>(this.errorObject=e,q)))}onModalOpen(e){e&&this.modal.open(e)}onReportFragmentNavigate(e){let r=this.editionRouteConstants.EDITION_REPORT.route,u={fragment:e?.fragmentId??""};this._navigateWithComplexId(e?.complexId,r,u)}onSvgSheetSelect(e){let r=this.editionRouteConstants.EDITION_SHEETS.route,u={queryParams:{id:e?.sheetId??""}};this._navigateWithComplexId(e?.complexId,r,u)}_navigateWithComplexId(e,r,u){let f=e?`/edition/complex/${e}/`:this.editionComplex.baseRoute;this._router.navigate([f,r],u)}static{this.propDecorators={modal:[{type:F,args:["modal",{static:!0}]}]}}};v=i([a({selector:"awg-edition-report",template:ie,changeDetection:n.OnPush,standalone:!1,styles:[se]})],v);var xe=[{path:"",component:v,data:{title:"AWG Online Edition \u2013 Report"}}],ne=[v],k=class{};k=i([g({imports:[$.forChild(xe)],exports:[$]})],k);var ae=class{};ae=i([g({imports:[y,b,C,k],declarations:[M,E,I,ne]})],ae);export{ae as EditionReportModule};
