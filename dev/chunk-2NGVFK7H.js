import{a as g,b as _e}from"./chunk-MSTPLEVO.js";import{a as N}from"./chunk-PP6HJ337.js";import{$b as be,Aa as R,Ba as z,D as s,Da as X,Ea as D,Fa as C,G as c,Ha as ue,J,Ja as Ee,K as n,La as K,Ma as De,O as a,Oa as me,Q as l,R as p,T as E,_a as Pe,_b as ve,a as Re,ac as Oe,cb as Ae,cc as oe,db as ge,fc as ke,gc as se,h as v,hb as Z,i as Ce,j as o,kb as k,kc as ae,l as de,la as _,lb as ee,mb as P,n as b,nb as te,ob as y,p as xe,pb as Le,qb as m,r as I,rb as w,sb as q,t as Te,tb as fe,u as O,ub as d,vb as re,w as Ie,y as W,yb as A,z as u}from"./chunk-SCROZJAO.js";var qe=`<!-- resource detail header -->
...
`;var Ne=`@charset "UTF-8";.resource-header{margin:1rem 0 0;border-bottom:1px solid #ddd}.resource-title .title{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.resource-title .title:hover{white-space:normal;width:inherit;height:auto}.resource-link{margin:2rem 0}.resource-header table.resource-header-table tr:first-of-type th,.resource-header table.resource-header-table tr:first-of-type td{border-top:none}
`;var j=class{constructor(){this.resourceRequest=new c}navigateToResource(e){e&&(e=e.toString(),this.resourceRequest.emit(e))}static{this.propDecorators={header:[{type:l}],resourceUrl:[{type:l}],resourceRequest:[{type:p}]}}};j=o([a({selector:"awg-resource-detail-header",template:qe,changeDetection:n.OnPush,standalone:!1,styles:[Ne]})],j);var je=`<!-- resourceDetailData content -->
...
`;var Ve="";var V=class{constructor(){this.gndRequest=new c,this.resourceRequest=new c}exposeGnd(e){e?.type&&this.gndRequest.emit(e)}navigateToResource(e){e&&(e=e.toString(),this.resourceRequest.emit(e))}static{this.propDecorators={resourceDetailData:[{type:l}],gndRequest:[{type:p}],resourceRequest:[{type:p}]}}};V=o([a({selector:"awg-resource-detail-html",template:je,changeDetection:n.OnPush,standalone:!1,styles:[Ve]})],V);var Fe=`<!--
/************************************************
*
*               CREDITS
*
...
`;var Ge="";var F=class{constructor(){this.gndRequest=new c,this.resourceRequest=new c}exposeGnd(e){e?.type&&this.gndRequest.emit(e)}navigateToResource(e){e&&(e=e.toString(),this.resourceRequest.emit(e))}static{this.propDecorators={content:[{type:l}],gndRequest:[{type:p}],resourceRequest:[{type:p}]}}};F=o([a({selector:"awg-resource-detail-html-content",template:Fe,changeDetection:n.OnPush,standalone:!1,styles:[Ge]})],F);var Me=`<!--
/************************************************
*
*               CREDITS
*
...
<!-- end DIV image-obj -->
`;var Ue=`.awg-image-slider{height:300px}.awg-image-slider .ngx-gallery{display:inline-block}:host::ng-deep ngx-gallery .ngx-gallery-image-wrapper{background-color:#e7e7e7}:host::ng-deep ngx-gallery .ngx-gallery-arrow{color:#676767}:host::ng-deep ngx-gallery .ngx-gallery-arrow .ngx-gallery-disabled{opacity:.3}:host::ng-deep ngx-gallery .ngx-gallery-thumbnail{opacity:.5}:host::ng-deep ngx-gallery .ngx-gallery-thumbnail:hover{opacity:1}
`;var G=class{constructor(){this.galleryOptions=[new Ee({width:"100%",imageSize:"contain",thumbnailSize:"contain",thumbnailMargin:5,thumbnailsMargin:0,previewCloseOnClick:!0,previewCloseOnEsc:!0,previewZoom:!0,previewRotate:!0,linkTarget:"_blank"})]}static{this.propDecorators={images:[{type:l}]}}};G=o([a({selector:"awg-resource-detail-html-content-imageobjects",template:Me,changeDetection:n.OnPush,standalone:!1,styles:[Ue]})],G);var $e=`<!--
/************************************************
*
*               CREDITS
*
...
`;var Qe=`@charset "UTF-8";.awg-props ul{padding-left:0;margin-top:.5rem;margin-bottom:.25rem}.awg-props li{list-style:none;padding:.25rem 0}.awg-props .awg-prop .awg-prop-label{margin-top:8px;margin-bottom:-4px;display:block;font-size:21px;font-weight:400}.awg-props .awg-prop .awg-prop-value{padding:3px 0;margin-left:1rem}
`;var U=class{constructor(){this.gndRequest=new c,this.resourceRequest=new c,this.metaBreakLine="Versionsdatum"}ngOnChanges(e){e.props&&this._checkForGND(e.props)}exposeGnd(e){e?.type&&this.gndRequest.emit(e)}navigateToResource(e){e&&(e=e.toString(),this.resourceRequest.emit(e))}ngOnDestroy(){this._removeGnd()}_checkForGND(e){let t=e.currentValue.filter(r=>r.pid==="856"&&r.values&&r.values.length>0);this._removeGnd(),t.length>0&&t.forEach(r=>{r.values.forEach(i=>{this._setGnd(i)})})}_setGnd(e){let t=new be(ve.SET,e);this.exposeGnd(t)}_removeGnd(){let e=new be(ve.REMOVE,null);this.exposeGnd(e)}static{this.propDecorators={props:[{type:l}],gndRequest:[{type:p}],resourceRequest:[{type:p}]}}};U=o([a({selector:"awg-resource-detail-html-content-props",template:Be,changeDetection:n.OnPush,standalone:!1,styles:[Qe]})],U);var Ye=`<awg-json-viewer
    jsonViewerHeader="Converted JSON response from Salsah-API"
    [jsonViewerData]="resourceJsonConvertedData">
</awg-json-viewer>
`;var We="";var $=class{static{this.propDecorators={resourceJsonConvertedData:[{type:l}]}}};$=o([a({selector:"awg-resource-detail-json-converted",template:Ye,changeDetection:n.OnPush,standalone:!1,styles:[We]})],$);var Je=`<awg-json-viewer jsonViewerHeader="Raw JSON response from Salsah-API" [jsonViewerData]="resourceJsonRawData">
</awg-json-viewer>
`;var ze="";var H=class{static{this.propDecorators={resourceJsonRawData:[{type:l}]}}};H=o([a({selector:"awg-resource-detail-json-raw",template:Je,changeDetection:n.OnPush,standalone:!1,styles:[ze]})],H);var ie=class{};ie=o([E({imports:[ae],declarations:[j,V,F,G,M,U,$,H],exports:[j,V,F,G,M,U,$,H]})],ie);var Xe=`@if (extendedSearchForm) {
...
`;var Ke="";var L=new m("EXISTS","exists","&exist;"),Vt=new m("MATCH","match","&isin;"),Ft=new m("MATCH_BOOLEAN","match boolean","&isin;&oplus;"),B=new m("EQ","equal","="),Ze=new m("!EQ","not equal","&ne;"),et=new m("LIKE","like","&sub;"),Gt=new m("!LIKE","not like","&nsub;"),tt=new m("GT","greater than","&gt;"),rt=new m("GT_EQ","greater equal than","&ge;"),ot=new m("LT","less than","&lt;"),st=new m("LT_EQ","less equal than","&le;"),ye={compopList:[{id:0,compopSet:[L]},{id:1,compopSet:[L,B]},{id:2,compopSet:[L,B,et]},{id:3,compopSet:[L,B,tt,rt,ot,st]},{id:4,compopSet:[L,B,Ze,tt,rt,ot,st]},{id:5,compopSet:[L,B,Ze,Vt,Ft,et,Gt]}]},ne=new Map().set("1",5).set("6-14",5).set("14",5).set("2",4).set("3",4).set("4",3).set("5",3).set("13",2).set("6-3",1).set("6-6",1).set("7",1).set("11",1).set("12",1).set("15",1);var Mt=new d("1","VALTYPE_TEXT","Text","textval","guielement_id=1,2","A value which is utf-8 text"),Ut=new d("2","VALTYPE_INTEGER","Integer value","ival","guielement_id=1,3,4,5;min=numeric;max=numeric","A value consisting of an integer value"),$t=new d("3","VALTYPE_FLOAT","Floating point number","fval","guielement_id=1,4;min=numeric;max=numeric","A value consisting of a floating point number"),Ht=new d("4","VALTYPE_DATE","Date","dateval","guielement_id=7","A Value consisting of a date"),Bt=new d("5","VALTYPE_PERIOD","Period","dateval","guielement_id=1;min=date;max=date;min=date;max=date","A period consists of 2 date values interpreted as start and end of the period"),Qt=new d("6","VALTYPE_RESPTR","Resource pointer","ival","guielement_id=3,6","Foreign key of a resource this value is pointing to"),Yt=new d("7","VALTYPE_SELECTION","Selection","ival","guielement_id=3,12","A selection out of a set of values"),Wt=new d("8","VALTYPE_TIME","Time","timeval","guielement_id=15,16","A time in the form of hh:mm:ss.sss"),Jt=new d("9","VALTYPE_INTERVAL","Interval","timeval","guielement_id=0","An interval between ot two times (start-time, end-time)"),zt=new d("10","VALTYPE_GEOMETRY","Geometry","textval","guielement_id=8","Figure geometry as JSON string"),Xt=new d("11","VALTYPE_COLOR","Color","textval","guielement_id=9,1","A color value in internet-notation (#rrggbb)"),Kt=new d("12","VALTYPE_HLIST","Hierarchical list","ival","guielement_id=10","Hierarchical list"),Zt=new d("13","VALTYPE_ICONCLASS","Iconclass","textval","guielement_id=1","Iconclass as defined by http://iconclass.org"),er=new d("14","VALTYPE_RICHTEXT","Richtext","richtext","guielement_id=14","This denotes a rich text value which in fact is a resource_reference to a rich text resource. The rich text resource should never be visible to the user directly..."),tr=new d("15","VALTYPE_GEONAME","Geoname","geoname","guielement_id=17","Reference to geonames.org"),we={typeList:[Mt,Ut,$t,Ht,Bt,Qt,Yt,Wt,Jt,zt,Xt,Kt,Zt,er,tr]};var Se=class extends Z{constructor(){super(),this.projectId="6",this.resTypeId="126",this.bibShortTitlePropertyId="614",this.resourcesRoute="resources/",this.searchRoute="search/",this.serviceName="BibliographyService"}getBibliographyList(){let e=this.searchRoute,t=new _().set("searchtype","extended").set("property_id",this.bibShortTitlePropertyId).set("compop","EXISTS").set("filter_by_project",this.projectId).set("filter_by_restype",this.resTypeId);return this.getApiResponse(y,e,t)}getBibliographyItemDetail(e){let t=this.resourcesRoute+e,r=new _;return this.getApiResponse(P,t,r)}static{this.ctorParameters=()=>[]}};Se=o([J({providedIn:"root"})],Se);var S=class extends Z{constructor(){super(),this.projectId="6",this.vocabularyId="4",this.defaultLanguage="de",this.resourceSuffix="_-_local",this.routes={propertylists:"propertylists/",resources:"resources/",resourcetypes:"resourcetypes/",search:"search/"},this._conversionService=s(re),this.serviceName="DataApiService"}getPropertyListsByResourceType(e){return e?this._getResourceDataResponseFromApi(k,e).pipe(O(new k),b(r=>r)):de(new k)}getResourceData(e){if(!e)return;let t=this._getResourceDataResponseFromApi(P,e),r=this._getResourceDataResponseFromApi(ee,e);return xe([t,r]).pipe(O([new P,new ee]),b(i=>this._prepareResourceData(i,e)))}getResourceTypes(){return this._getResourceDataResponseFromApi(te,"").pipe(O(new te),b(t=>t))}getSearchData(e){if(!e?.query||typeof e?.query=="object"&&!e?.query?.filterByRestype)return de(new y);let t=new w(e.query,e.nRows||"-1",e.startAt||"0",e.viewType||g.TABLE);return this._getResourceDataResponseFromApi(y,"",t).pipe(O(new y),b(i=>this._conversionService.convertFullTextSearchResults(i)))}_createSearchQueryParamsForApi(e){let t=new _().set("filter_by_project",this.projectId).set("lang",this.defaultLanguage).set("show_nrows",e.nRows).set("start_at",e.startAt);return typeof e.query=="string"?t=t.append("searchtype","fulltext"):typeof e.query=="object"&&(t=t.append("searchtype","extended"),t=t.append("filter_by_restype",e.query.filterByRestype),e.query.propertyId&&e.query.propertyId.length>0&&e.query.compop&&e.query.compop.length>0&&(e.query.propertyId.forEach(r=>{t=t.append("property_id",r)}),e.query.compop.forEach(r=>{t=t.append("compop",r)}),e.query.searchval&&e.query.searchval.length>0&&e.query.searchval.forEach(r=>{t=t.append("searchval",r)}))),t}_prepareResourceData(e,t){let r=this._conversionService.convertResourceData(e,t);return new Le(e[0],r)}_getResourceDataResponseFromApi(e,t,r){let i,f;switch(e){case k:i=this.routes.propertylists,f=new _().set("restype",t);break;case ee:i=this.routes.resources+t+this.resourceSuffix,f=new _().set("reqtype","context");break;case P:i=this.routes.resources+t+this.resourceSuffix,f=new _;break;case te:i=this.routes.resourcetypes,f=new _().set("vocabulary",this.vocabularyId).set("lang",this.defaultLanguage);break;case y:i=this.routes.search,typeof r.query=="string"&&(i=i+r.query),f=this._createSearchQueryParamsForApi(r);break;default:break}return this.getApiResponse(e,i,f)}static{this.ctorParameters=()=>[]}};S=o([J({providedIn:"root"})],S);var le=class{constructor(){this.searchRequest=new c,this.faPlus=Pe,this.faRefresh=Ae,this.faSearch=K,this.faTrash=De,this.extendedSearchParams=new q,this.selectedCompopSets=[[]],this.defaultFormString="---",this.extendedSearchFormStrings={label:"Search Input",placeholder:"Volltextsuche in der Webern-Datenbank \u2026",errorMessage:"Es wird ein Suchbegriff mit mindestens 3 Zeichen ben\xF6tigt!"},this._destroyed$=new v,this._dataApiService=s(S),this._formBuilder=s(z)}get restypeControl(){return this.extendedSearchForm.get("restypeControl")}get propertiesControls(){return this.extendedSearchForm.get("propertiesControls")}ngOnInit(){this.createExtendedSearchForm(),this.getResourcetypes()}createExtendedSearchForm(){this.extendedSearchForm=this._formBuilder.group({restypeControl:["",R.required],propertiesControls:this._formBuilder.array([])}),this.addPropertiesControl()}addPropertiesControl(){let e=this._formBuilder.group({propertyIdControl:[{value:"",disabled:!0},[R.required]],compopControl:[{value:"",disabled:!0},[R.required]],searchvalControl:[{value:"",disabled:!0},[this._validateSearchval()]]});this._isResourecetypeMissing()||e.controls.propertyIdControl.enable(),this.propertiesControls.push(e)}removePropertiesControl(e){e>-1&&this.propertiesControls.removeAt(e)}getCompopControlAtIndex(e){return this.listenToUserCompopChange(e),this._getFormArrayControlAtIndex("compopControl",e)}getCompopSetByValueType(e,t){if(!we.typeList.find(_t=>_t.id===e))return[];let i=e==="6"?`${e}-${t}`:e,f=ne.has(i)?ne.get(i):0;return ye.compopList[f].compopSet}getPropertyIdControlAtIndex(e){return this.listenToUserPropertyChange(e),this._getFormArrayControlAtIndex("propertyIdControl",e)}getPropertyListEntryById(e){return this.propertyListsResponse.properties.find(t=>t.id===e)}getPropertyLists(e){this._dataApiService.getPropertyListsByResourceType(e).pipe(u(this._destroyed$)).subscribe({next:t=>{this.propertyListsResponse=t},error:t=>{console.error(t)}})}getResourcetypes(){this._dataApiService.getResourceTypes().pipe(u(this._destroyed$)).subscribe({next:e=>{this.restypesResponse=e,this.listenToUserResourcetypeChange()},error:e=>{console.error(e)}})}getSearchvalControlAtIndex(e){return this._getFormArrayControlAtIndex("searchvalControl",e)}isAddButtonDisabled(e){return this._isPropertyIdOrCompopMissing(e)||this._isNotLastProperty(e)||!this._isCompopExists(e)&&this._isSearchvalMissingOrTooShort(e)}listenToUserResourcetypeChange(){this.restypeControl.valueChanges.pipe(u(this._destroyed$)).subscribe({next:e=>{this.selectedResourcetype=this.restypesResponse.resourcetypes.find(t=>t.id===e),this._clearPropertiesControls(),this.selectedResourcetype&&this.getPropertyLists(this.selectedResourcetype.id)}})}listenToUserPropertyChange(e){this._getFormArrayControlAtIndex("propertyIdControl",e)?.valueChanges.pipe(u(this._destroyed$)).subscribe({next:t=>{let r=this.getPropertyListEntryById(t);if(!r)return;let i=r.guielement_id,f=r.valuetype_id;this._getFormArrayControlAtIndex("compopControl",e).enable(),this._getFormArrayControlAtIndex("compopControl",e).setValue(""),this._getFormArrayControlAtIndex("searchvalControl",e).disable(),this._getFormArrayControlAtIndex("searchvalControl",e).setValue(""),this.selectedCompopSets[e]=this.getCompopSetByValueType(f,i)}})}listenToUserCompopChange(e){this._getFormArrayControlAtIndex("compopControl",e)?.valueChanges.pipe(u(this._destroyed$)).subscribe({next:t=>{t&&t!=="EXISTS"?this.getSearchvalControlAtIndex(e).enable():t&&t==="EXISTS"&&(this.getSearchvalControlAtIndex(e).disable(),this.getSearchvalControlAtIndex(e).setValue(""))}})}onReset(){alert("Gesamte Suchmaske zur\xFCcksetzen?"),this._resetForm()}onSearch(){this.extendedSearchForm.valid&&(this.extendedSearchParams={filterByRestype:this.extendedSearchForm.value.restypeControl,propertyId:[],compop:[],searchval:[]},this.extendedSearchForm.value.propertiesControls?.forEach(e=>{this.extendedSearchParams.propertyId.push(e.propertyIdControl),this.extendedSearchParams.compop.push(e.compopControl),this.extendedSearchParams.searchval.push(e.searchvalControl)}),this.searchRequest.emit(this.extendedSearchParams))}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}_clearPropertiesControls(){this.propertiesControls.clear(),this.addPropertiesControl()}_getFormArrayControlAtIndex(e,t){let r=this.propertiesControls.controls.at(t);return r?r.get(e):null}_isCompopExists(e){return this._getFormArrayControlAtIndex("compopControl",e).value==="EXISTS"}_isCompopMissing(e){return this._isFormControlValueMissing("compopControl",e)}_isFormControlValueMissing(e,t){let r=this._getFormArrayControlAtIndex(e,t)?.value;return!r||r===this.defaultFormString}_isNotLastProperty(e){return this.propertiesControls.controls.length-1>e}_isPropertyIdMissing(e){return this._isFormControlValueMissing("propertyIdControl",e)}_isPropertyIdOrCompopMissing(e){return this._isPropertyIdMissing(e)||this._isCompopMissing(e)}_isResourecetypeMissing(){let e=this.restypeControl.value;return!e||e===this.defaultFormString}_isSearchvalMissing(e){return this._isFormControlValueMissing("searchvalControl",e)}_isSearchvalMissingOrTooShort(e){return this._isSearchvalMissing(e)||this._isSearchvalTooShort(e)}_isSearchvalTooShort(e){return this.getSearchvalControlAtIndex(e).value.length<3}_resetForm(){return this.extendedSearchForm.reset()}_validateSearchval(){return e=>{let t=e.value;return e.parent.get("compopControl").value==="EXISTS"?null:!t||t.length<3?{minlength:!0}:null}}static{this.propDecorators={searchRequest:[{type:p}]}}};le=o([a({selector:"awg-extended-search-form",template:Xe,standalone:!1,styles:[Ke]})],le);var at=`<form [formGroup]="fulltextSearchForm" class="p-3 border">
...
`;var lt=`.awg-search-results .awg-search-result-table tbody tr{cursor:pointer}.awg-search-results .awg-search-result-table tbody tr:hover{background-color:#e7e7e7}.awg-search-results .awg-search-result-table tbody tr.active td{background-color:#d7d7d7}
`;var pe=class{constructor(){this.pageChangeRequest=new c,this.rowNumberChangeRequest=new c,this.viewChangeRequest=new c,this.errorMessage=void 0,this.rowNumbers=[5,10,25,50,100,200],this.faGripHorizontal=ge,this.faTable=me,this.selectedViewType=g.TABLE,this.viewHandles=[new _e("Table view",g.TABLE,me),new _e("Grid view",g.GRID,ge)],this._destroyed$=new v,this._conversionService=s(re),this._dataStreamerService=s(A),this._router=s(C),this._sideInfoService=s(se)}ngOnInit(){this.getSearchResponseWithQueryData(),this.searchParams.viewType&&(this.searchParams.viewType===g.TABLE||this.searchParams.viewType===g.GRID)&&this.setViewType(this.searchParams.viewType)}setViewType(e){this.selectedViewType=e}isActiveResource(e){return this._selectedResourceId===e}isGridView(){return this.searchParams.viewType===g.GRID}isNoResults(){return+this.searchResponseWithQuery.data.nhits==0}navigateToResource(e){this._selectedResourceId=e,this._router.navigate(["/data/resource",this._selectedResourceId])}onPageChange(e){let t=+this.searchParams.nRows,r=e*t-t;this.pageChangeRequest.emit(String(r))}onRowNumberChange(e){this.rowNumberChangeRequest.emit(String(e))}onViewChange(e){e&&this.viewChangeRequest.emit(e)}setPagination(){let e=+this.searchParams.nRows,t=+this.searchParams.startAt;this.pageSize=e,this.page=Math.floor(t/e)+1}getSearchResponseWithQueryData(){this._dataStreamerService.getSearchResponseWithQuery().pipe(u(this._destroyed$)).subscribe({next:t=>{this.updateSearchParams(t),this.setPagination()},error:t=>{this.errorMessage=t,console.error("SearchResultList# searchResultData subscription error: ",this.errorMessage)}})}updateSearchParams(e){if(!e)return;this.searchResponseWithQuery=Re({},e),this.searchResultText=this._conversionService.prepareFullTextSearchResultText(e,this.searchUrl);let t=new ke(this.searchResponseWithQuery.query,this.searchResultText);this._sideInfoService.updateSearchInfoData(t)}ngOnDestroy(){this._sideInfoService.clearSearchInfoData(),this._destroyed$.next(!0),this._destroyed$.complete()}static{this.propDecorators={searchUrl:[{type:l}],searchParams:[{type:l}],pageChangeRequest:[{type:p}],rowNumberChangeRequest:[{type:p}],viewChangeRequest:[{type:p}]}}};pe=o([a({selector:"awg-search-result-list",template:nt,changeDetection:n.Default,standalone:!1,styles:[lt]})],pe);var ct=`<!-- resource detail box -->
...
`;var pt=`@charset "UTF-8";@media screen and (min-width:768px){.awg-resource-detail-long-tab{width:auto!important}.awg-resource-detail-short-tab>a{white-space:nowrap}}::ng-deep .tab-content .tab-pane.active{margin:2rem 0}
`;var x=class{constructor(){this.errorMessage=void 0,this.resourceDetailTabTitles={html:"Detail",raw:"JSON (raw)",converted:"JSON (converted)"},this._destroyed$=new v,this._dataApiService=s(S),this._dataStreamerService=s(A),this._gndService=s(Oe),this._loadingService=s(oe),this._route=s(D),this._router=s(C)}get httpGetUrl(){return this._dataApiService.httpGetUrl}get isLoading$(){return this._loadingService.getLoadingStatus()}ngOnInit(){this.navigateToSideOutlet(),this.getResourceData()}getResourceData(){this._router.events.pipe(I(e=>e instanceof X),b(()=>this._route),W(e=>{let r=this._route.snapshot.paramMap.get("id");for(;e.firstChild;)e=e.firstChild;return this.selectedResourceDetailTabId=e.snapshot.url[0].path,this.updateResourceId(r),this._dataApiService.getResourceData(r)}),u(this._destroyed$)).subscribe({next:e=>{this.resourceData=e},error:e=>this.errorMessage=e})}onResourceDetailTabChange(e){let t=e.nextId;this._router.navigate([t],{relativeTo:this._route})}updateResourceId(e){this.resourceId=e,this._dataStreamerService.updateResourceId(e)}navigateToResource(e){let t=e??this.oldId??this.resourceId;this.oldId=this.resourceId,this._router.navigate(["/data/resource",+t])}exposeGnd(e){e&&this._gndService.exposeGnd(e)}navigateToSideOutlet(){this._router.navigate([{outlets:{side:"resourceInfo"}}],{preserveFragment:!0,queryParamsHandling:"preserve"})}ngOnDestroy(){this._router.navigate([{outlets:{side:null}}]),this._destroyed$.next(!0),this._destroyed$.complete()}};x=o([a({selector:"awg-resource-detail",template:ct,changeDetection:n.Default,standalone:!1,styles:[pt]})],x);var ht=`@if (searchRouterLinkButtons) {
...
<!-- search results -->
`;var mt="";var T=class{constructor(){this.errorMessage=void 0,this.searchTabs={fulltext:{id:"fulltext",title:"Volltext-Suche"},extended:{id:"extended",title:"Erweiterte Suche"}},this.viewChanged=!1,this._destroyed$=new v,this._dataApiService=s(S),this._dataStreamerService=s(A),this._loadingService=s(oe),this._route=s(D),this._router=s(C)}get httpGetUrl(){return this._dataApiService.httpGetUrl}get isLoading$(){return this._loadingService.getLoadingStatus()}ngOnInit(){this.resetSearchParams(),this.getSearchData()}getSearchData(){this._router.events.pipe(I(e=>e instanceof X),b(()=>this._route),b(e=>{let t=e;for(;t.firstChild;)t=t.firstChild;return this._isValidTabIdInRoute(t)&&(this.selectedSearchTabId=t.snapshot.url[0].path),e}),W(e=>{let t=e.snapshot.queryParamMap;if(t!==this.currentQueryParams){if(this.currentQueryParams=t,t.keys.length<4)this.updateSearchParamsFromRoute(t,!0);else if(this.updateSearchParamsFromRoute(t,!1),!this.viewChanged){if(this.searchParams.query&&typeof this.searchParams.query=="string")return this._dataApiService.getSearchData(this.searchParams);if(typeof this.searchParams.query=="object"&&this.searchParams.query.filterByRestype)return this._dataApiService.getSearchData(this.searchParams)}}return Ce}),u(this._destroyed$)).subscribe({next:e=>{this.searchResponseWithQuery=new fe(e,this.searchParams.query),this._dataStreamerService.updateSearchResponseWithQuery(this.searchResponseWithQuery)},error:e=>{this.errorMessage=e,console.error("SearchPanel# getSearchData subscription error: ",this.errorMessage)}})}onPageChange(e){e!==this.searchParams.startAt&&(this.viewChanged=!1,this.searchParams=new w(this.searchParams.query,this.searchParams.nRows,e,this.searchParams.viewType),this._routeToSelf(this.searchParams))}onRowNumberChange(e){e!==this.searchParams.nRows&&(this.viewChanged=!1,this.searchParams=new w(this.searchParams.query,e,"0",this.searchParams.viewType),this._routeToSelf(this.searchParams))}onSearch(e){e!==this.searchParams.query&&(this.viewChanged=!1,this.searchParams=new w(e,this.searchParams.nRows,this.searchParams.startAt,this.searchParams.viewType),this._routeToSelf(this.searchParams))}onSearchTabChange(e){let t=e.nextId;this.resetSearchParams(t),this.resetSearchResponse(),this.errorMessage=void 0,this._routeToSelf(this.searchParams,t)}onViewChange(e){e!==this.searchParams.viewType&&(this.viewChanged=!0,this.searchParams=new w(this.searchParams.query,this.searchParams.nRows,this.searchParams.startAt,e),this._routeToSelf(this.searchParams))}resetSearchParams(e){let t;!e||e===this.searchTabs.fulltext.id?t="":e===this.searchTabs.extended.id&&(t=new q,t.filterByRestype="",t.propertyId=[],t.compop=[],t.searchval=[]),this.searchParams=new w(t,"25","0",g.TABLE)}resetSearchResponse(){this.searchResponseWithQuery=new fe(new y,""),this._dataStreamerService.updateSearchResponseWithQuery(this.searchResponseWithQuery)}updateSearchParamsFromRoute(e,t){if(!e)return;let r;!this.selectedSearchTabId||this.selectedSearchTabId===this.searchTabs.fulltext.id||typeof this.searchParams.query=="string"?r=e.get("query")||this.searchParams.query:(this.selectedSearchTabId===this.searchTabs.extended.id||typeof this.searchParams.query=="object")&&(r=new q,r.filterByRestype=e.get("filterByRestype")||this.searchParams.query.filterByRestype,r.propertyId=e.getAll("propertyId")||this.searchParams.query.propertyId,r.compop=e.getAll("compop")||this.searchParams.query.compop,r.searchval=e.getAll("searchval")||this.searchParams.query.searchval),this.searchParams=new w(r,e.get("nrows")||this.searchParams.nRows,e.get("startAt")||this.searchParams.startAt,g[e.get("view")]||this.searchParams.viewType),t&&this._routeToSelf(this.searchParams)}getSearchQueryType(e){return typeof e=="string"||typeof e=="object"?e:null}getSearchQueryAsString(e){return typeof this.getSearchQueryType(e)=="string"?e:""}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}_routeToSelf(e,t){let r=t?[t]:[],i=this._createRouterQueryParams(e);this._router.navigate(r,{relativeTo:this._route,queryParams:i})}_createRouterQueryParams(e){let t={},r=this.getSearchQueryType(e.query);return typeof r=="string"?t.query=e.query:typeof r=="object"&&(t.filterByRestype=r.filterByRestype||"",r.propertyId&&(t.propertyId=r.propertyId||[],t.compop=r.compop||[],t.searchval=r.searchval||[])),t.nrows=e.nRows,t.startAt=e.startAt,t.view=e.viewType,t}_isValidTabIdInRoute(e){return e.snapshot.url&&e.snapshot.url.length>0&&Object.values(this.searchTabs).filter(t=>t.id===e.snapshot.url[0].path).length>0}};T=o([a({selector:"awg-search-panel",template:ut,standalone:!1,styles:[mt]})],T);var gt=`<!-- content: search -->
...
`;var ft="";var Y=class{constructor(){this.searchTitle="Suche",this.searchId="search",this._router=s(C)}ngOnInit(){this.navigateToSideOutlet()}navigateToSideOutlet(){this._router.navigate([{outlets:{side:"searchInfo"}}],{preserveFragment:!0,queryParamsHandling:"preserve"})}ngOnDestroy(){this._router.navigate([{outlets:{side:null}}])}};Y=o([a({selector:"awg-data",template:gt,standalone:!1,styles:[ft]})],Y);var mr=[{path:"",component:Y,children:[{path:"",pathMatch:"full",redirectTo:"search"},{path:"search",component:Q,children:[{path:"",component:T,children:[{path:"",pathMatch:"full",redirectTo:"fulltext"},{path:"fulltext",data:{title:"AWG Online Edition \u2013 Fulltext Search"},component:T},{path:"extended",data:{title:"AWG Online Edition \u2013 Extended Search"},component:T},{path:"detail/:id",redirectTo:"resource/:id"}]}]}]},{path:"resource/:id",component:x,data:{title:"AWG Online Edition \u2013 Resource Detail"},children:[{path:"",pathMatch:"full",redirectTo:"html"},{path:"html",data:{title:"AWG Online Edition \u2013 Resource Detail HTML"},component:x},{path:"converted-json",data:{title:"AWG Online Edition \u2013 Resource Detail JSON Converted"},component:x},{path:"raw-json",data:{title:"AWG Online Edition \u2013 Resource Detail JSON Raw"},component:x}]}],vt=[Y,Q,T,x],he=class{};he=o([E({imports:[ue.forChild(mr)],exports:[ue]})],he);var bt=class{};bt=o([E({imports:[ae,ie,he],declarations:[vt,le,ce,pe]})],bt);export{bt as DataViewModule};
