import{a as o,b as s}from"./chunk-C7YHGDI2.js";import{b as w}from"./chunk-LENB6HJW.js";import{A as I}from"./chunk-PULNRRC6.js";import{a as D,b as r}from"./chunk-U36Z7ZNT.js";import{Kb as b,Ua as a,Wa as n,Zb as f,_b as m,da as u,fb as i,na as h,o as e,xa as t}from"./chunk-CXEHZIZM.js";var _=`<!-- sideinfo: contact -->
<div class="card">
...
`;var v="";var d=class{constructor(){this.pageMetaData=i.required(),this.contactMetaData=i.required()}static{this.propDecorators={pageMetaData:[{type:n,args:[{isSignal:!0,alias:"pageMetaData",required:!0,transform:void 0}]}],contactMetaData:[{type:n,args:[{isSignal:!0,alias:"contactMetaData",required:!0,transform:void 0}]}]}}};d=e([a({selector:"awg-contact-address",template:A,changeDetection:t.OnPush,imports:[r],styles:[v]})],d);var M=`<iframe
...
`;var E="";var c=class{constructor(){this.embedUrl=i.required(),this.linkUrl=i.required(),this.LINK_LABEL="Gr\xF6\xDFere Karte anzeigen",this.IFRAME_SETTINGS={width:"100%",height:"350"}}static{this.propDecorators={embedUrl:[{type:n,args:[{isSignal:!0,alias:"embedUrl",required:!0,transform:void 0}]}],linkUrl:[{type:n,args:[{isSignal:!0,alias:"linkUrl",required:!0,transform:void 0}]}]}}};c=e([a({selector:"awg-contact-map",template:M,changeDetection:t.OnPush,imports:[r],styles:[E]})],c);var p=class{constructor(){this._sanitizer=u(f),this.CONTACT_SIDE_INFO_HEADER="Kontakt",this.contactMetaData=o[s.contact],this.pageMetaData=o[s.page],this.mapEmbedUrl=this._sanitizer.bypassSecurityTrustResourceUrl(m.CONTACT_MAP_UNSAFE_EMBED_URL),this.mapLinkUrl=m.CONTACT_MAP_LINK_URL}};p=e([a({selector:"awg-contact-side-info",template:_,changeDetection:t.OnPush,imports:[d,c],styles:[C]})],p);var N=`<!-- content: contact -->
<div class="awg-contact-view p-5 border rounded-3">
    ...
    <div class="awg-citation-description mb-5">
        ...
        <p class="awg-citation-text">
            ...
            <span class="awg-citation-version">{{ pageMetaData.awgAppVersion }}</span> vom
            <span class="awg-citation-version-release">{{
                pageMetaData.awgAppVersionReleaseDate | date: 'longDate'
            }}</span
    ...
    <div class="awg-documentation-description mb-5">
        <p class="awg-documentation-text">
            ...
            Repository unter:
            <a [href]="pageMetaData.awgAppGithubUrl">
                {{ pageMetaData.awgAppGithubUrl }}
            </a>
        </p>
        ...
        <p class="awg-documentation-text">
            ...
            <a id="awg-compodoc" [href]="pageMetaData.compodocUrl"> Compodoc documentation </a> <br />
            <span class="smallcaps">DeepWiki:</span><br />
            Interaktive (KI-basierte) Dokumentation der Angular App:
            <a id="awg-deepwiki" [href]="pageMetaData.deepWikiUrl"> DeepWiki documentation </a> <br />
        </p>
    </div>
    ...
    <div class="awg-imprint-description">
        ...
        <p>
            ...
            @for (developer of contactMetaData.developers; track developer.name) {
    ...
    <div id="awg-disclaimer">
        ...
        <p>
            ...
            gleichen Bedingungen 4.0 International" (<a
        ...
        <p>
            ...
            <a [href]="pageMetaData.awgAppGithubUrl">GitHub</a> unter einer
...
`;var S=`.awg-contact-view{text-align:justify;text-justify:inter-word}
`;var l=class{constructor(){this.CITATION_ID="awg-citation",this.CITATION_TITLE="Zitation",this.IMPRINT_ID="awg-imprint",this.IMPRINT_TITLE="Impressum",this.DOCUMENTATION_ID="awg-documentation",this.DOCUMENTATION_TITLE="Dokumentation",this.contactMetaData=o[s.contact],this.pageMetaData=o[s.page],this.today=h(Date.now()).asReadonly()}};l=e([a({selector:"awg-contact-view",template:N,changeDetection:t.OnPush,imports:[b,r,D,w,I],styles:[S]})],l);var Oe=[{path:"",component:l,data:{title:"AWG Online Edition \u2013 Contact"}},{path:"",outlet:"side",component:p}];export{Oe as CONTACT_VIEW_ROUTES};
