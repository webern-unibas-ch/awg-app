import{a as q}from"./chunk-CI4IBZIZ.js";import{a as ye,e as we}from"./chunk-XVOBC5KX.js";import{$a as ae,A,Cb as de,D as S,Db as he,Eb as y,Fb as ce,Gb as ge,Ha as ie,Hb as pe,I as ee,Ia as oe,Ib as ve,K as r,Ka as W,M as p,Mb as Se,Pb as me,Q as u,Qa as ne,Qb as ue,R as h,Sa as re,T as l,U as a,V as te,W as v,Xb as H,_b as fe,a as j,b as Z,ba as se,f as Y,fb as le,fc as _e,h as w,i as Q,j as n,mb as _,nc as m,o as X,s as K,t as J,y as z,z as D}from"./chunk-AU4M2UGL.js";var Ce=`<div class="awg-edition-svg-sheet-footer mt-4">
...
`;var b=class{constructor(e){this.utils=e,this.selectSvgSheetRequest=new r}isSelectedSvgSheet(e,t){let s=e,i=this.selectedSvgSheet?.id;return t&&this.selectedSvgSheet?.content?.[0]?.partial&&(s+=t,i+=this.selectedSvgSheet.content[0].partial),s===i}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}static{this.ctorParameters=()=>[{type:_}]}static{this.propDecorators={navItemLabel:[{type:l}],svgSheets:[{type:l}],selectedSvgSheet:[{type:l}],selectSvgSheetRequest:[{type:a}]}}};b=n([h({selector:"awg-edition-svg-sheet-nav-item",template:ke,changeDetection:p.OnPush,standalone:!1,styles:[xe]})],b);var Re=`@if (svgSheetsData) {
