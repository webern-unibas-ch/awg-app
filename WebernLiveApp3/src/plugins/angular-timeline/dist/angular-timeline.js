...
/*
        Angular directive that generates a responsive, data-driven
                    vertical timeline to tell a story,
                show history or describe a sequence of events.

            by Robert Pocklington (rpocklin), Melbourne, VIC, AU
                https://github.com/rpocklin/angular-timeline
                            (2015-2016)

                This plugin is released unter the MIT License.
        See https://github.com/rpocklin/angular-timeline/blob/master/LICENSE
                        for further details.
*/
...
/**
 * @ngdoc directive
 * @name angular-timeline.directive:timeline.header
 * @restrict AE
 *
 * @description
 * Represents a heading, displayed on the top of the timeline line.
 */
angular.module('angular-timeline').directive('timelineHeader', function() {
  return {
    require: '^timeline',
    restrict: 'AE',
    transclude: true,
    template: '<li class="timeline-header" ng-transclude></li>'
  };
});
...
/**
 * @ngdoc directive
 * @name angular-timeline.directive:timeline.body
 * @restrict AE
 *
 * @description
 * Represents a body element for the content of the timeline line.
 */
angular.module('angular-timeline').directive('timelineBody', function() {
  return {
    require: '^timeline',
    restrict: 'AE',
    transclude: true,
    template: '<ul class="timeline-body" ng-transclude></li>'
  };
});
 ...
 */
angular.module('angular-timeline').directive('timelinePanelHeading', function() {
  return {
    require: '^timelinePanel',
    restrict: 'AE',
    transclude: true,
    template: '<div class="timeline-panel-heading" ng-transclude></div>'
  };
});
 ...
 *
 * @description
 * A body element for a `timeline-panel`.
 */
angular.module('angular-timeline').directive('timelinePanelBody', function() {
  return {
    require: '^timelinePanel',
    restrict: 'AE',
    transclude: true,
    template: '<div class="timeline-panel-body" ng-transclude></div>'
  };
});
 ...
 */
angular.module('angular-timeline').directive('timelinePanelFooter', function() {
  return {
    require: '^timelinePanel',
    restrict: 'AE',
    transclude: true,
    template: '<div class="timeline-panel-footer" ng-transclude></div>'
  };
});
 ...
 *
 * @description
 * A panel inside the `timeline-event` which shows detailed information about the event.
 */
