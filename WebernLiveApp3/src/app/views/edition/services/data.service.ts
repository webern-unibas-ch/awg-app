...
import { Sheet, Source, SvgOverlay, Textcritics } from '../models';
...
export class DataService {
     ...
     */
    private getOverlayData(): Observable<SvgOverlay[]> {
     ...
     * http request
     */
    private getJsonData(url: string): Observable<Sheet[] | Source[] | SvgOverlay[] | Textcritics[]> {
        return this.http.get(url)
            .map((res: Response) => res.json() as Sheet[] | Source[] | SvgOverlay[] | Textcritics[])
